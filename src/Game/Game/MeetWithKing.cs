...
namespace OpenCiv1
{
	public class MeetWithKing
	{
		...
		L03c2:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) * (this.oGameData.DifficultyLevel + 1)) / 32,
				0, 20);
		...
		L0544:
			...
			this.oCPU.AX.Word = (ushort)this.oGameData.Static.Nations[this.oGameData.Players[playerID].NationalityID].Mood;
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2a), 
		...
		L0891:
			...
			this.oParent.Array_30b8[1] = this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x30))].Nation;
		...
		L08e0:
			this.oParent.Var_3936 = (short)this.oCPU.AX.Word;
			this.oCPU.WriteUInt16(this.oCPU.DS.Word, 0xd76c, 0xc);
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)), 0x0);
		...
		L124d:
			...
			this.oCPU.CMP_UInt16(this.oCPU.AX.Word, (ushort)this.oGameData.ActivePlayers);
		...
		L144a:
			...
			this.oParent.Array_30b8[3] = this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))].Nation;
		...
		L1771:
			...
			this.oParent.Segment_1000.F0_1000_0a32_PlayTune(this.oGameData.Static.Nations[this.oGameData.Players[playerID].NationalityID].ShortTune, 3);
		...
		L1ea5:
			...
			this.oParent.Segment_2dc4.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x804e), "Meet with King");
		...
		L2244:
			...
			this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_19d4_Rectangle, 90, 0, this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0xb1e6));
			...
			this.oParent.ImageTools.F0_2fa1_01a2_LoadBitmapOrPalette(-1, 0, 0,
				this.oCPU.ReadString(this.oCPU.DS.Word, (ushort)(this.oCPU.BP.Word - 0xe)), out this.oParent.Var_bdee);
		...
		L22cf:
			...
			this.oParent.Var_bdee[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1e)) + 6] =
		...
		public void F6_0000_233c()
		{
			...
			this.oParent.Segment_2dc4.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x7efe), "");
