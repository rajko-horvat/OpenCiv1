...
namespace OpenCiv1
{
	public class MeetWithKing
	{
		...
		public MeetWithKing(OpenCiv1Game parent)
		{
			this.oParent = parent;
		...
		public void F6_0000_0000(short playerID, int xPos, int yPos, ushort param4)
		{
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[playerID].ContactPlayerCountdown;
			...
			if (this.oGameData.Players[playerID].NationalityID == 14)
			{
				...
				this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x19b4), "Empress");

				// Instruction address 0x0000:0x004f, size: 5
				this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x19b6), "Empress");
			}

			this.oCPU.CMPUInt16(param4, 0x0);
		...
		L0091:
			this.oCPU.CMPUInt16((ushort)this.oGameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].CityCount, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.LE) goto L010c;

			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[playerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Attack;
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;

			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Defense;
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[oParent.GameData.HumanPlayerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Defense;
		...
		L0101:
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.DI.UInt16);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.SI.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)), this.oCPU.AX.UInt16));
			goto L01d7;
		...
		L010c:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Attack == 0)
				goto L0131;
			...
			if (this.oGameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Attack == 0)
				goto L0131;
		...
		L0131:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].CityCount == 0)
				goto L0182;
			...
			this.oCPU.CMPUInt16((ushort)this.oGameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].CityCount, 0x1);
			if (this.oCPU.Flags.LE) goto L0170;

			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Defense;

			this.oCPU.CX.UInt16 = (ushort)this.oGameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Defense;
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), this.oCPU.CX.UInt16));
			goto L01d7;
		...
		L0170:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Defense;
			goto L01d4;
		...
		L0182:
			...
			if (this.oGameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].CityCount == 0)
				goto L01ac;
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oGameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Attack -
				this.oGameData.Players[this.oGameData.HumanPlayerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Defense);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
		...
		L01d7:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))));

		L01da:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26)), 0xf);
		...
		L01f5:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oGameData.Players[playerID].MilitaryPower);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].MilitaryPower);
			if (this.oCPU.Flags.LE) goto L02a0;

		L0267:
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].ActiveUnits[25];
		...
		L02fb:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[playerID].ActiveUnits[25];
		...
		L0321:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oGameData.HumanPlayerID);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.CX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].ActiveUnits[25];
		...
		L0384:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x24), this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x34)), 0xfffe);
		...
		L0397:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.SHLUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x1));
			goto L03c2;
		...
		L03c2:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)) * (this.oGameData.DifficultyLevel + 1)) / 32,
				0, 20);

			this.oCPU.CX.UInt16 = 0x32;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.AX.UInt16);
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].Coins;
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.SI.UInt16);
			...
			this.oCPU.CMPUInt16(this.oCPU.SI.UInt16, this.oCPU.CX.UInt16);
		...
		L0417:
			...
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.CMPUInt16((ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].Coins, this.oCPU.AX.UInt16);
		...
		L04df:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20)), this.oCPU.AX.UInt16);
			...
			if ((this.oGameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 3) == 1)
			{
				this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].MilitaryPower;
				this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, 0x2);
				this.oCPU.CMPUInt16((ushort)this.oGameData.Players[playerID].MilitaryPower, this.oCPU.AX.UInt16);
				if (this.oCPU.Flags.L)
				{
					this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a),
						this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a))));
				}

				if (this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].MilitaryPower >
				...
				if ((this.oGameData.Players[this.oGameData.HumanPlayerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 0x2) != 0)
				{
		...
		L0544:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20)), 0x8);
			if (this.oCPU.Flags.L) goto L04df;

			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Static.Nations[this.oGameData.Players[playerID].NationalityID].Mood;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a), 
				this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a)), this.oCPU.AX.UInt16));

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].MilitaryPower <
				 this.oGameData.Players[playerID].MilitaryPower)
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a), 
					this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a))));
			}
			...
			this.oCPU.CX.UInt16 = (ushort)((this.oGameData.Players[playerID].Diplomacy[this.oGameData.HumanPlayerID] & 2) == 0 ? 1 : 0);
			this.oCPU.CMPUInt16(this.oCPU.CX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a)));
		...
		L05b3:
			...
			this.oCPU.CX.UInt16 = (ushort)this.oGameData.Players[playerID].MilitaryPower;
		...
		L0666:
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2c)));
		...
		L0709:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20)), 0x48);
		...
		L072f:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x32)), 0x6);
		...
		L0738:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.GE) goto L0743;
			goto L0822;

		L0743:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), 0xffff);
		...
		L0762:
			...
			this.oParent.Array_30b8[3] = this.oGameData.Static.Technologies[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa))].Name;
			...
			this.oParent.Var_aa_Rectangle.FontID = this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x67ec);
		...
		L0822:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)), 0x2);
		...
		L0869:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x30)), 0xffff);
		...
		L0891:
			...
			this.oParent.Array_30b8[1] = this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x30))].Nation;
		...
		L08e0:
			this.oParent.Var_3936 = (short)this.oCPU.AX.UInt16;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd76c, 0xc);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x24)), 0x0);
			if (this.oCPU.Flags.E) goto L08fb;

			// Instruction address 0x0000:0x08f3, size: 5
			this.oParent.CommonTools.F0_1000_0a32_PlayTune(0x21, 0);
		...
		L092d:
			...
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x30))].Diplomacy[this.oGameData.HumanPlayerID] |= 8;
		...
		L095b:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0x2);
		...
		L0a44:
			...
			this.oParent.Array_30b8[3] = this.oGameData.Static.Technologies[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name;
		...
		L0ad9:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x32);
		...
		L0d2a:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)), 0x4);
		...
		L0d3c:
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(this.oGameData.HumanPlayerID,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), playerID);
		...
		L0e5a:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 10));
			...
			this.oGameData.Players[this.oGameData.HumanPlayerID].Coins += (short)this.oCPU.AX.UInt16;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, this.oCPU.SI.UInt16, this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, this.oCPU.SI.UInt16), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = (ushort)oParent.GameData.TurnCount;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x34), this.oCPU.AX.UInt16);
		...
		L1097:
			if (this.oGameData.Players[playerID].NationalityID == 14)
			{
				...
				this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x19b4), this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x33aa));

				// Instruction address 0x0000:0x10bb, size: 5
				this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x19b6), this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x33a8));
			}
		...
		L1209:
			...
			this.oParent.Array_30b8[3] = this.oGameData.Players[playerID].Nation;
			...
			this.oCPU.AX.UInt16 = (ushort)oParent.GameData.TurnCount;
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x34)));
		...
		L124d:
			...
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.ActivePlayers);
		...
		L1332:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x0);
		...
		L13a5:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26)), 0x1);
		...
		L13ca:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].Nation);
		...
		L144a:
			...
			this.oParent.Array_30b8[3] = this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].Nation;
			...
			if ((this.oGameData.Players[playerID].Diplomacy[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 1) != 0)
				goto L1487;
		...
		L1487:
			...
			if ((this.oGameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 2) != 0)
				goto L14c1;
		...
		L14c1:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				((this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].MilitaryPower / 2) *
		...
		L1562:
			...
			this.oParent.MSCAPI.strcat(0xba06, 
				this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].Nation);
		...
		L15fa:
			...
			this.oCPU.CX.LowUInt8 = 0x4;
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, this.oCPU.DI.UInt16);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			...
			this.oParent.Array_30b8[1] = this.oGameData.Players[playerID].Nation;
		...
		L1668:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x3934, 0xffff);
			this.oParent.Var_3936 = -1;
		...
		public ushort F6_0000_16cd(short playerID, int xPos, int yPos)
		{
			...
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd804), 0x0);
			if (this.oCPU.Flags.E) goto L16de;

		L16d8:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3934);
			goto L1871;

		L16de:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd804, 0x1);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3934), 0x0);
		...
		L1771:
			...
			this.oParent.CommonTools.F0_1000_0a32_PlayTune(this.oGameData.Static.Nations[this.oGameData.Players[playerID].NationalityID].ShortTune, 3);
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3934), 0xfffe);
		...
		L17d1:			
			...
			this.oParent.CommonTools.F0_1000_0a32_PlayTune(this.oGameData.Static.Nations[this.oGameData.Players[playerID].NationalityID].LongTune, 3);

			this.oCPU.BX.UInt16 = (ushort)this.oGameData.Players[playerID].NationalityID;
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0xa);
			if (this.oCPU.Flags.E)
			{
		...
		public void F6_0000_1a3f(short playerID)
		{
			...
			this.oParent.Array_30b8[3] = this.oGameData.Players[playerID].Nationality;

			// Instruction address 0x0000:0x1a65, size: 5
			this.oParent.Array_30b8[0] = this.oGameData.Players[this.oGameData.HumanPlayerID].Nationality;
		...
		L1ace:
			...
			if (this.oGameData.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].TypeID != -1)
			{
				// Instruction address 0x0000:0x1af1, size: 5
				this.oParent.Segment_2dc4.F0_2dc4_0102_FindNearestCity(
					this.oGameData.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Position.X,
					this.oGameData.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Position.Y);
				...
				if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].PlayerID == this.oGameData.HumanPlayerID && 
		...
		public void F6_0000_1b33()
		{
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd76c), 0x0);
			if (this.oCPU.Flags.E) goto L1b50;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f4), 0x0);
			if (this.oCPU.Flags.NE) goto L1b50;
			goto L1cc0;

		L1b50:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f4);
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x3ab8)), 0x0);
			if (this.oCPU.Flags.E) goto L1b9a;
			if (this.oCPU.Flags.LE) goto L1b64;

		L1b5d:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f4, this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f4)));
			goto L1c64;
		...
		L1b64:
			...
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0xfffd);
		...
		L1b9a:
			...
			if (this.oParent.Var_3936 == 0) goto L1bb2;

			if (this.oParent.Var_3936 == 1) goto L1c08;

			if (this.oParent.Var_3936 == 2) goto L1c16;

			goto L1bce;

		L1bb2:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6b8e), 0x0);
		...
		L1bbf:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f4), 0x6);
		...
		L1bfe:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f4), 0xe);
		...
		L1c64:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f6), 0x0);
			if (this.oCPU.Flags.NE) goto L1caa;

			// Instruction address 0x0000:0x1c6f, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(12));
			...
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x3ab8)), 0x0);
			if (this.oCPU.Flags.NE) goto L1caa;
			this.oCPU.BX.UInt16 = this.oCPU.ORUInt16(this.oCPU.BX.UInt16, this.oCPU.BX.UInt16);
		...
		L1ce9:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.AX.UInt16);
			this.oCPU.TESTUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0xd76c), 0x3);
			if (this.oCPU.Flags.NE) goto L1cf8;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x8);

		L1cf8:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd76c, this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd76c)));
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f6, 0x4);

		L1d02:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f6), 0x0);
			if (this.oCPU.Flags.E) goto L1d0d;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f6, this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f6)));
		...
		public void F6_0000_1d2b(short playerID)
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);
			this.oCPU.AX.UInt16 = (ushort)playerID;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f2, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f0, 0x0);
			
			// Instruction address 0x0000:0x1e4b, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x10), "govt0a.pic");

			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[playerID].GovernmentType;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.SARUInt16(this.oCPU.AX.UInt16, 0x1);
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, (int)TechnologyEnum.Invention);
		...
		L1e85:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67ee), 0x0);
		...
		L1ea5:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0x4);
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x10), "king00.pic");

			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f8);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.CX.UInt16 = 0xa;
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xb), this.oCPU.ADDUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xb)), this.oCPU.DX.LowUInt8));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f8);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), this.oCPU.ADDUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), this.oCPU.AX.LowUInt8));
			...
			this.oParent.Segment_2dc4.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x804e), "Meet with King");
		...
		L1fb3:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xb);
			if (this.oCPU.Flags.NE) goto L1fc3;

		L1fbf:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 0x2));
		...
		L1fc3:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.SI.UInt16 = this.oCPU.INCUInt16(this.oCPU.SI.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.CX.UInt16 = 0x5;
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xe);
		...
		L20cb:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 0x3);
		...
		public void F6_0000_21ac(short playerID)
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.SP.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SP.UInt16, 0x1e);
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f0), 0x0);
			if (this.oCPU.Flags.E) goto L21bd;
			goto L2337;

		L21bd:
			// Instruction address 0x0000:0x21ca, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0xe), "back0a.pic");
		...
		L2214:
			...
			this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_19d4_Rectangle,
				...
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16,
					(ushort)((((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e)) +
					playerID) & 3) * 6) + 0x804e)));

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e))));

		L2244:
			this.oCPU.AX.UInt16 = (ushort)((this.oGameData.Players[playerID].Ranking + 1) >> 1);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e)));
			if (this.oCPU.Flags.G) goto L2214;
			
			// Instruction address 0x0000:0x2267, size: 5
			this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_19d4_Rectangle, 90, 0, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb1e6));

			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f4, 0x0);

			// Instruction address 0x0000:0x227d, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x7), "pal");

			// Instruction address 0x0000:0x228d, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x1c), "king00.pal");

			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f8);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.CX.UInt16 = 0xa;
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x17), this.oCPU.ADDUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x17)), this.oCPU.DX.LowUInt8));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f8);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18), this.oCPU.ADDUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)), this.oCPU.AX.LowUInt8));
			...
			this.oParent.ImageTools.F0_2fa1_01a2_LoadBitmapOrPalette(-1, 0, 0,
				this.oCPU.ReadString(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), out this.oParent.Var_bdee);
		...
		L22cf:
			...
			this.oParent.Var_bdee[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e)) + 6] =
				this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0xc1dc));

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e)), 0x1b0);
		...
		public void F6_0000_233c()
		{
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67ea), 0x0);
		...
		L2374:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), this.oCPU.AX.UInt16);
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f2)].GovernmentType;
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.SARUInt16(this.oCPU.AX.UInt16, 0x1);
		...
		L23a4:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), 0x3));

		L23af:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0xffff);
		...
		L23c3:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67fa), 0x0);
		...
		L23d5:
			...
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f2));
			this.oCPU.AX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.AX.UInt16, 0x3);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), this.oCPU.AX.UInt16);
			...
			this.oCPU.CX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.CX.UInt16, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), this.oCPU.CX.UInt16));
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0xf0));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x64);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = 0x19;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)));
			this.oCPU.CX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0xf2));
			this.oCPU.CX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.CX.UInt16, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), this.oCPU.CX.UInt16));
		...
		L246d:
			this.oCPU.AX.UInt16 = (ushort)((this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f2)].Ranking + 1) >> 1);
		...
		L2485:
			...
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0xb4);
			...
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x40);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x4a));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), this.oCPU.AX.UInt16));
		...
		public ushort F6_0000_251d(ushort stringPtr, ushort xPos, ushort yPos)
		{
			...
			this.oCPU.CMPUInt16(xPos, 0x14);
			if (this.oCPU.Flags.NE) goto L2559;
			xPos = 0x24;

		L2559:
			// Instruction address 0x0000:0x2567, size: 5
			this.oParent.MenuBoxDialog.F0_2d05_0031_ShowMenuBox(stringPtr, (short)xPos, (short)yPos, 1);
