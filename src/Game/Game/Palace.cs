...
namespace OpenCiv1
{
	public class Palace
	{
		...
		public void F17_0000_0000()
		{
			...
			this.oCPU.SP.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SP.UInt16, 0x110);
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x100), 0xba06);
			...
			this.oParent.MenuBoxDialog.F0_2d05_0031_ShowMenuBox((ushort)(this.oCPU.BP.UInt16 - 0x100), 20, 16, 1);
			...
			this.oParent.MenuBoxDialog.F0_2d05_0031_ShowMenuBox(0x4af0, 40, 16, 1);
		...
		L0148:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)) + 2] >= 4)
				goto L01bc;

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)) + 1] > 0 ||
				this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)) + 3] > 0)
				goto L016a;

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)) + 2] < 0)
				goto L01bc;

		L016a:
			this.oCPU.AX.UInt16 = 0x30;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x24);
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)), 10));
		...
		L01bc:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)), 0x8);
		...
		L01cd:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[10 + this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)) + 1] >= 3)
				goto L0217;
			...
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 
				this.oCPU.ADDUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0xba06), this.oCPU.AX.LowUInt8));
		...
		L0217:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)), 0x3);
			if (this.oCPU.Flags.L) goto L01cd;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x102)), 0x0);
		...
		L0231:
			...
			if (this.oParent.Var_db3a != 0) goto L0246;
		...
		L0246:
			...
			this.oCPU.CMPUInt16(this.oParent.Var_db3e, 0x9a);
		...
		L0268:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 2] >= 4)
				goto L0231;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)), 0x9);
			if (this.oCPU.Flags.L) goto L0289;

			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e));
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 2] >= 3)
				goto L0231;
		...
		L0292:
			...
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, 0x9);
			goto L0264;
		...
		L02a0:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e), this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x38);
			if (this.oCPU.Flags.GE) goto L02b5;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)), 0x30));
			goto L02ba;

		L02b5:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)), 0x58));

		L02ba:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)), 0x1);
			if (this.oCPU.Flags.GE) goto L02c4;
			goto L0231;

		L02c4:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)), 0xb);
		...
		L02ce:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 3] > 0)
				goto L0307;

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 2] != -1)
				goto L0307;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e))));

		L02e6:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)), 0x4);
		...
		L02ef:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 1] > 0 ||
				this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 2] != -1)
				goto L030e;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e), this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e))));
		...
		L0363:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)), 0x8);
		...
		L0393:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA("Select new section.", 160, 3, 15);
		...
		L0426:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104)), 0x10));
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 1] == -1)
				goto L0472;
		...
		L0478:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 3] == -1)
				goto L0499;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)), 0x7);
		...
		L0502:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104)), this.oCPU.AX.UInt16));
		...
		L0591:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x50);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104), this.oCPU.AX.UInt16);
		...
		L05af:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104)), this.oCPU.AX.UInt16));
			this.oCPU.PUSHUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.DI.UInt16 + 0xb23e)));
			this.oCPU.AX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x4b33));

		L05f3:
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.AX.UInt16 = this.oCPU.INCUInt16(this.oCPU.AX.UInt16);
			this.oCPU.PUSHUInt16(this.oCPU.AX.UInt16);
			this.oCPU.PUSHUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x104)));

		L05fa:
			// Instruction address 0x0000:0x05fe, size: 5
			this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
				(short)this.oCPU.POPUInt16(), (short)this.oCPU.POPUInt16(), this.oCPU.POPUInt16());
			goto L053e;
		...
		L0609:
			...
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.PUSHUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xb23c)));
			this.oCPU.AX.UInt16 = 0xf;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x110)));
		...
		L0670:
			...
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.PUSHUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xb23e)));
			this.oCPU.AX.UInt16 = 0xf;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x110)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0x5;
			...
			this.oCPU.AX.UInt16 = this.oCPU.INCUInt16(this.oCPU.AX.UInt16);
			this.oCPU.PUSHUInt16(this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x108)), 0x2);
		...
		L06a4:
			...
			this.oCPU.PUSHUInt16(this.oCPU.CX.UInt16);
			goto L05fa;

		L06ae:
			// Instruction address 0x0000:0x06b6, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6828), "Palace 1");
		...
		L06c8:
			...
			if (this.oParent.Var_db3a != 0) goto L06dd;
		...
		L0747:
			...
			this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e)) + 2] =
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x110));

			this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10e))] =
		...
		public void F17_0000_07ec(ushort flag)
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.SP.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SP.UInt16, 0x2e);
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);
		...
		L081d:
			...
			this.oCPU.SI.UInt16 = (ushort)((short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 2]);
			...
			if (this.oCPU.Flags.NE)
			{
				...
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14),
					this.oCPU.ORUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), this.oCPU.AX.UInt16));
			}

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x9);
		...
		L0843:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 2] != -1)
			{
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x8);
		...
		L089a:
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[12] > 0)
			{
				// Instruction address 0x0000:0x08b6, size: 5
				this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x10), "cbacks0.pic");

				this.oCPU.AX.LowUInt8 = (byte)((sbyte)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[12]);
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[4] == -1)
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c),
					this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)), 0x18));
			}
		
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[4] == 1)
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c), 
		...
		L0906:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22),
				this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22))));
		...
		L0923:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x3);
		...
		L0945:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22))] != 1)
				goto L0957;
		...
		L096d:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x4b32);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)), this.oCPU.AX.UInt16));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x3);
		...
		L0988:
			if (this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) + 1 == this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)))
			{
				...
				if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22))] ==
					this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))])
				{
					F17_0000_0e2f(
						this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)),
			...
			if (this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)) - 1 == this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)))
			{
				...
				if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22))] ==
					this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18))])
				{
					F17_0000_0e2f(
						this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)),
			...
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x4b2e);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)), this.oCPU.AX.UInt16));
		...
		L0a3e:
			...
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c),
					this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c))));
			}
		...
		L0a77:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x5);
		...
		L0a99:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 1] <=
				this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 2])
				goto L0ac9;
			...
			F17_0000_0e2f(
				...
				(ushort)((short)(this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 1] -
					this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 2] +
		...
		L0ac9:
			...
			F17_0000_0e2f(
				...
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)),
				(short)(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)) -
					((this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22))] == 1) ? 3 : 2)),
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20)),
				1);
		...
		L0afe:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)), 0x30));
		...
		L0b05:
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e),
				(short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 2]);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26), 0x2);

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x4);
			if (this.oCPU.Flags.GE) goto L0b40;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26), 0x1);

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 1] == -1)
				goto L0b3b;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x1);
		...
		L0b40:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)) + 3] == -1)
				goto L0b5d;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x22)), 0x7);
		...
		L0b87:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))] == 1)
			{
				if (this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) != 3)
				{
					F17_0000_0e2f(
						(ushort)((short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) + 2]),
						this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)),
						(short)((this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) * 48) - 36),
						(ushort)((short)(this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) + 3] -
							this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) + 2] +
			...
			this.oParent.Segment_2dc4.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6828), "Palace 2");

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[11] == 0  &&
				this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[13] == 0)
				goto L0c94;

			// Instruction address 0x0000:0x0bee, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x10), "cbrush0.pic");

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[11] != 0)
			{
				this.oCPU.AX.LowUInt8 = (byte)((sbyte)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[11]);
				this.oCPU.AX.LowUInt8 = this.oCPU.SHLUInt8(this.oCPU.AX.LowUInt8, 0x1);
				this.oCPU.AX.LowUInt8 = this.oCPU.ADDUInt8(this.oCPU.AX.LowUInt8, 0x2e);
				this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), this.oCPU.AX.LowUInt8);

				// Instruction address 0x0000:0x0c0b, size: 5
				this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a),
					(short)this.oParent.ImageTools.F0_2fa1_044c_LoadIcon((ushort)(this.oCPU.BP.UInt16 - 0x10)));

				// Instruction address 0x0000:0x0c2e, size: 5
				this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
					0,
					((this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[11] <= 1) ? 105 : 94),
					this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a)));
			}

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[13] != 0)
			{
				this.oCPU.AX.LowUInt8 = (byte)((sbyte)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[13]);
				this.oCPU.AX.LowUInt8 = this.oCPU.SHLUInt8(this.oCPU.AX.LowUInt8, 0x1);
				this.oCPU.AX.LowUInt8 = this.oCPU.ADDUInt8(this.oCPU.AX.LowUInt8, 0x2f);
				this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), this.oCPU.AX.LowUInt8);

				// Instruction address 0x0000:0x0c4b, size: 5
				this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2c),
					(short)this.oParent.ImageTools.F0_2fa1_044c_LoadIcon((ushort)(this.oCPU.BP.UInt16 - 0x10)));

				// Instruction address 0x0000:0x0c6f, size: 5
				this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
					184, ((this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[13] <= 1) ? 105 : 94),
		...
		L0c94:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeba), 0x7);
		...
		public void F17_0000_0cfe(ushort param1, ushort flag)
		{
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4),
				(short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[param1 + 2]);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x2);

			this.oCPU.CMPUInt16(param1, 0x4);
			if (this.oCPU.Flags.GE) goto L0d33;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x1);

			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[param1 + 1] == -1)
				goto L0d2e;
		...
		L0d33:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[param1 + 3] == -1)
				goto L0d50;

			this.oCPU.CMPUInt16(param1, 0x7);
		...
		L0d6e:
			...
			this.oCPU.CMPUInt16(param1, 0x3);
		...
		L0d9f:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[param1 + 1] >
				this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[param1 + 2] ||
				param1 == 5)
				goto L0dbb;
		...
		public void F17_0000_0e2f(ushort param1, ushort param2, short xPos, ushort param4, ushort flag)
		{
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2),
				(short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[param2 + 2]);

			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4),
				(short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[param2]);
			...
			this.oCPU.AX.UInt16 = 0xf;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, param1);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + this.oCPU.DI.UInt16 + 0x4b36));
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, param4);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, param1);
		...
		L0ed0:
			...
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14));
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + this.oCPU.SI.UInt16 + 0xb25e)), 0xff);
			if (this.oCPU.Flags.E) goto L0ef6;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6828), 0xffff);
		...
		L0ef9:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 0x2);
		...
		L0f67:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0x2);
		...
		L0fe2:
			...
			if (this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) + 2] ==
		...
		L0ffc:
			...
			this.oCPU.SI.UInt16 = 
				(ushort)((short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))]);
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;

			this.oCPU.AX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.AX.UInt16, 0x1);
			...
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;
			this.oCPU.AX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.AX.UInt16, 0x2);
			...
			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12));
			this.oCPU.SI.UInt16 = this.oCPU.DECUInt16(this.oCPU.SI.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;
			this.oCPU.AX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.AX.UInt16, 0x1);
			this.oCPU.CX.UInt16 = 0xa0;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
		...
		L104b:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a))));

		L104e:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a)), 0x5);
			...
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.TESTUInt16(this.oCPU.AX.UInt16, param1);
			if (this.oCPU.Flags.E) goto L104b;

			// Instruction address 0x0000:0x1069, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x10), "castle0.pic");
