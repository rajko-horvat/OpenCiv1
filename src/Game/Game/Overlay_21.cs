...
namespace OpenCiv1
{
	public class Overlay_21
	{
		...
		L0016:
			...
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].PlayerID !=
				this.oGameData.HumanPlayerID) goto L0043;
			this.oCPU.TESTUInt16(this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].ImprovementFlags0, 0x1);
		...
		L004d:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), 0xfffe);
		...
		L0078:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 0, 320, 100, 15);
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 8, 3, 304, 20, 15);
		...
		L014d:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x10);
		...
		L01e9:
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x12c);
		...
		L022c:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0xc8);
		...
		L02e3:
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0xc), "*NEWSA");

			// Instruction address 0x0000:0x03a5, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(14));

			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x7), this.oCPU.ADDUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x7)), this.oCPU.AX.LowUInt8));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

			// Instruction address 0x0000:0x03bd, size: 5
			this.oParent.LanguageTools.F0_2f4d_01ad_GetTextBySectionAndKey("KING", (ushort)(this.oCPU.BP.UInt16 - 0xc));
