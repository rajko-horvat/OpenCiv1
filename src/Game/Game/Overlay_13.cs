...
namespace OpenCiv1
{
	public class Overlay_13
	{
		...
		L029f:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(0xba06, 256, this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)), 7);
		...
		L03a1:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(0xba06, 192, this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)), 7);
