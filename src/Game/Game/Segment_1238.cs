...
namespace OpenCiv1
{
	public class Segment_1238
	{
		...
		public void F0_1238_0092()
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.SP.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SP.UInt16, 0x1a);
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].Coins;
		...
		L00c2:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xde20, this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xde20)));
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].DiscoveredTechnologyCount;

			if (this.oGameData.MaximumTechnologyCount < (short)this.oCPU.SI.UInt16)
			{
				this.oGameData.MaximumTechnologyCount = (short)this.oCPU.SI.UInt16;
			}
		...
		L0183:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdf60), 0x0);
		...
		L0195:
			if (this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Coins > 0x7530)
			{
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Coins = 0x7530;
			}
			...
			if (this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].CityCount != 0 ||
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].SettlerCount != 0)
				goto L021a;
		...
		L026a:
			...
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Score = 0;
			this.oCPU.AX.UInt16 = 0x1;
			this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.TESTUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.ActivePlayers);
		...
		L02c9:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(128));
			...
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].StatusFlag == 0xff ||
				this.oGameData.Players[this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].PlayerID].CityCount <= 1)
				goto L02c6;

			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].ActualSize >= 5) goto L02bb;
			goto L02c6;
		...
		L0306:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].Coins;
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a)));
			this.oCPU.CX.UInt16 = 0xa;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].Coins);
		...
		L039e:
			...
			this.oCPU.TESTUInt8((byte)(this.oGameData.SpaceshipFlags & 0xff), 0xfe);
		...
		L03c4:
			...
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].ResearchProgress <<= 1;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x8);
		...
		L03f9:
			this.oCPU.CMPUInt16((ushort)this.oGameData.HumanPlayerID, 0xffff);
			if (this.oCPU.Flags.NE) goto L0416;
			goto L055e;
			
		L0416:
			this.oCPU.TESTUInt8((byte)(this.oGameData.GameSettingFlags & 0xff), 0x2);
		...
		L04d5:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x4);
			if (this.oCPU.Flags.L) goto L04d5;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 0x1);
			goto L050a;

		L04ef:
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Ranking;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x14), 
				this.oCPU.ORUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x14)), this.oCPU.AX.UInt16));
		...
		L050a:
			...
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Ranking;
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;
			this.oCPU.TESTUInt8(this.oCPU.AX.LowUInt8, 0x1);
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.DI.UInt16 - 0x14), 
				this.oCPU.ORUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.DI.UInt16 - 0x14)), this.oCPU.AX.UInt16));
			goto L0507;
		...
		L055e:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(40));

			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.TurnCount);
		...
		L0587:
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.WonderCityID[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))];
			this.oCPU.CMPUInt16(this.oCPU.SI.UInt16, 0xffff);
			if (this.oCPU.Flags.E) goto L05b0;

			this.oCPU.CMPUInt16(this.oCPU.SI.UInt16, 0x80);
			if (this.oCPU.Flags.E) goto L05b0;

			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.SI.UInt16);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Players[this.oGameData.Cities[this.oCPU.SI.UInt16].PlayerID].Score += 25;

		L05b0:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x15);
			if (this.oCPU.Flags.LE) goto L0587;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3484), 0xfffd);
		...
		L05c8:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oGameData.PollutedSquareCount);
			this.oGameData.Players[this.oGameData.HumanPlayerID].Score -= (short)this.oCPU.AX.UInt16;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3484), 0xfffe);
		...
		L05f0:
			...
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].StatusFlag == 0xff ||
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].PlayerID != this.oGameData.HumanPlayerID)
				goto L0616;
		...
		L0616:
			...
			this.oCPU.TESTUInt8((byte)(this.oGameData.GameSettingFlags & 0xff), 0x80);
			if (this.oCPU.Flags.E) goto L066e;
			this.oCPU.TESTUInt16((ushort)this.oGameData.SpaceshipFlags, 0x100);
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.SI.UInt16);
		...
		L067d:
			...
			if (this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].SpaceshipETAYear == this.oGameData.Year)
			{
				this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
		...
		L069f:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)((short)this.oGameData.DifficultyLevel));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x820);
			this.oCPU.AX.UInt16 = this.oCPU.NEGUInt16(this.oCPU.AX.UInt16);
			if ((short)this.oCPU.AX.UInt16 != this.oGameData.Year) goto L0718;
		...
		L0718:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x1cf6), 0xffff);
			...
			this.oCPU.AX.UInt16 = 0x14;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)((short)this.oGameData.DifficultyLevel));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x834);
			this.oCPU.AX.UInt16 = this.oCPU.NEGUInt16(this.oCPU.AX.UInt16);
			if ((short)this.oCPU.AX.UInt16 == this.oGameData.Year) goto L073b;
			goto L089a;
		...
		L077e:
			...
			this.oParent.MSCAPI.strcpy(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x1cf6)].Nationality);
		...
		L07c7:
			...
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x834);
			this.oCPU.AX.UInt16 = this.oCPU.NEGUInt16(this.oCPU.AX.UInt16);
			if ((short)this.oCPU.AX.UInt16 != this.oGameData.Year) goto L0836;
		...
		L084e:
			...
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0x4cd9, this.oCPU.ORUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0x4cd9), 0x1));
			...
			this.oCPU.AX.UInt16 = this.oCPU.NEGUInt16(this.oCPU.AX.UInt16);
			this.oParent.Var_dc48 = (short)this.oCPU.AX.UInt16;
		...
		public void F0_1238_0980()
		{
			...
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oGameData.DifficultyLevel));
			this.oCPU.CX.UInt16 = 0x1e;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			if (this.oCPU.AX.UInt16 <= this.oGameData.TurnCount) goto L099d;
			goto L0d9b;

		L099d:
			this.oCPU.AX.LowUInt8 = (byte)(oParent.GameData.TurnCount & 0xff);
			this.oCPU.AX.LowUInt8 = this.oCPU.INCUInt8(this.oCPU.AX.LowUInt8);
			this.oCPU.TESTUInt8(this.oCPU.AX.LowUInt8, 0x7);
			if (this.oCPU.Flags.E) goto L09a9;
			goto L0aa6;

		L09a9:
			this.oCPU.TESTUInt16((ushort)this.oGameData.TechnologyFirstDiscoveredBy[58], 0x7);
			if (this.oCPU.Flags.E) goto L09b8;
			goto L0aa6;

		L09b8:
			// Instruction address 0x1238:0x09bc, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(80));
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(44));

			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, 0x3);
			...
			if (this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].TerrainType != TerrainTypeEnum.Water) goto L09b8;
			...
			if (this.oGameData.Map.Groups[this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Layer3_GroupID].Size < 16) goto L09b8;
			...
			this.oParent.Segment_1866.F0_1866_0cf5(
				0,
				(short)((this.oCPU.AX.UInt16 < 3) ? 0x11 : 0x12),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)));
		...
		L0a57:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), this.oCPU.AX.UInt16);
		...
		L0a64:
			...
			this.oGameData.Players[0].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c))].Status |= 1;
		...
		L0a8b:
			...
			this.oCPU.TESTUInt16((ushort)this.oGameData.TechnologyFirstDiscoveredBy[56], 0x7);
		...
		L0aa6:
			...
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)));
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.CMPUInt8(this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].StatusFlag, 0xff);
			if (this.oCPU.Flags.NE) goto L0ac7;
			goto L0d9b;

		L0ac7:
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].PlayerID != this.oGameData.HumanPlayerID)
				goto L0d9b;

			// Instruction address 0x1238:0x0ad8, size: 5
			this.oParent.Segment_2459.F0_2459_0687(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)));

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16), this.oCPU.AX.UInt16);

			// Instruction address 0x1238:0x0ae7, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(100));

			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)));
		...
		L0afc:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(13));

			this.oCPU.CX.UInt16 = (ushort)((short)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].Position.X);
			this.oCPU.CX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.CX.UInt16, this.oCPU.AX.UInt16);
			this.oCPU.CX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.CX.UInt16, 0x6);
			...
			this.oCPU.CX.UInt16 = (ushort)((short)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].Position.Y);
			this.oCPU.CX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.CX.UInt16, this.oCPU.AX.UInt16);
			this.oCPU.CX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.CX.UInt16, 0x6);
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oGameData.Map.GetDistance(
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)),
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].Position.X,
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].Position.Y));
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)), 0x63);
			...
			this.oParent.Segment_1866.F0_1866_1750_UpdateVisibility(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)));
		...
		L0b92:
			...
			if (this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].TerrainType != TerrainTypeEnum.Water) goto L0ba8;
		...
		L0bbc:
			...
			if (this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Layer3_GroupID ==
				this.oGameData.Map[this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].Position].Layer3_GroupID) goto L0bef;
			goto L0afc;
		...
		L0bf8:
			...
			if (this.oGameData.Map[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].IsVisibleTo(this.oGameData.HumanPlayerID)) goto L0c33;
		...
		L0c33:
			...
			this.oParent.MapManagement.F0_2aea_0008(this.oGameData.HumanPlayerID,
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].Position.X - 8,
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))].Position.Y - 6);
		...
		L0c84:
			...
			this.oParent.Segment_2459.F0_2459_08c6_GetCityName(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)));
		...
		L0cc5:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				this.oParent.MSCAPI.RNG.Next(
					this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, 
		...
		L0d00:
			this.oCPU.TESTUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)), 0x4);
		...
		L0d0e:
			...
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)), this.oCPU.AX.UInt16);
		...
		L0d1e:
			...
			this.oGameData.Players[0].Units[(short)this.oCPU.AX.UInt16].AppendVisibility(
				this.oGameData.Map[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
					this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].VisibilityList);
		...
		L0d72:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18))));

		L0d75:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)), this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.G) goto L0d9b;
			this.oCPU.TESTUInt16((ushort)this.oGameData.TechnologyFirstDiscoveredBy[35], 0x7);
		...
		L0db3:
			...
			this.oCPU.AX.UInt16 = this.oCPU.XORUInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.DX.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].TotalCitySize;
			...
			this.oCPU.AX.UInt16 += (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].DiscoveredTechnologyCount;
		...
		L0de0:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oGameData.Static.Units[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Price);
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].ActiveUnits[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))]);
			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2));
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x16), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x16)), this.oCPU.AX.UInt16));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x1c);
		...
		L0e3e:
			...
			this.oCPU.SI.UInt16 = this.oCPU.ADDUInt16(this.oCPU.SI.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
			
			this.oGameData.ScoreGraphData[this.oCPU.SI.UInt16] = this.oCPU.BX.LowUInt8;
		...
		L0ea3:
			...
			if ((this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))] & 3) == 1)
			{
				this.oCPU.AX.UInt16 = 0x1;
				this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
				this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18),
					this.oCPU.ORUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)), this.oCPU.AX.UInt16));
			}
			...
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.SI.UInt16 = this.oCPU.ADDUInt16(this.oCPU.SI.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
			this.oGameData.PeaceGraphData[this.oCPU.SI.UInt16] = this.oCPU.BX.LowUInt8;
		...
		L0f36:
			...
			if (this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a)) < this.oGameData.Players.Length)
			{
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a))].Ranking = (short)this.oCPU.AX.UInt16;
			}
		...
		L0f9b:
			...
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Diplomacy[this.oGameData.HumanPlayerID] |= 1;
		...
		L0fb0:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), (ushort)this.oGameData.HumanPlayerID);
			if (this.oCPU.Flags.E)
				goto L0fad;

			if (this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].CityCount <= 1)
				goto L0fad;

			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.CX.LowUInt8 = 0x4;
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16((ushort)this.oGameData.HumanPlayerID, 0x1);
			this.oCPU.SI.UInt16 = this.oCPU.ADDUInt16(this.oCPU.SI.UInt16, this.oCPU.AX.UInt16);

			if ((this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Diplomacy[this.oGameData.HumanPlayerID] & 2) == 0)
				goto L0f9b;

			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Diplomacy[this.oGameData.HumanPlayerID] |= 0x100;
			goto L0fad;
		...
		L119e:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].ResearchProgress;
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, 2);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);
		...
		L1288:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x1c28), 0x0);
		...
		L1394:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0x64);
			if (this.oCPU.Flags.GE) goto L1413;
			this.oCPU.AX.UInt16 = 0xa;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x1c24));
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
		...
		L13e5:
			...
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, 10);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
		...
		L1413:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x1c24);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x9);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);
			...
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, 0x64);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
		...
		L1466:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3484), 0xffff);
		...
		public void F0_1238_14a3(short playerID, short palaceLevel, short xPos, short yPos)
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.SP.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SP.UInt16, 0x36);
			this.oCPU.PUSHUInt16(this.oCPU.DI.UInt16);
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);
		...
		L151c:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oGameData.RandomSeed);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);
		...
		L1554:
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x32),
				(short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)) + 2]);

			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x20),
				(short)this.oGameData.Players[this.oGameData.HumanPlayerID].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))]);
		...
		L1576:
			...
			this.oCPU.DIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			...
			this.oCPU.AX.UInt16 = this.oCPU.INCUInt16(this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.DX.UInt16, 0x4);
			if (this.oCPU.Flags.GE) goto L15bd;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 - 0x30)), this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.L) goto L15b8;
			this.oCPU.DI.UInt16 = 0x7;
			this.oCPU.DI.UInt16 = this.oCPU.SUBUInt16(this.oCPU.DI.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.DI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.DI.UInt16, 0x1);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.DI.UInt16 - 0x32)), 0xffff);
		...
		L15bd:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x34)), this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.L) goto L15de;
			this.oCPU.SI.UInt16 = 0x9;
			this.oCPU.SI.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SI.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)));
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x32)), 0xffff);
		...
		L15e3:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.G) goto L15f1;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x3);
		...
		L15f6:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), 0x0);
		...
		L1635:
			...
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.SI.UInt16 = this.oCPU.ADDUInt16(this.oCPU.SI.UInt16, this.oCPU.BP.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 - 0x32)), 0x0);
		...
		L1645:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 - 0x34)), 0xffff);
			if (this.oCPU.Flags.E) goto L1661;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0x1);
		...
		L1666:
			...
			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8));
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x30)), 0xffff);
		...
		L16f9:
			...
			this.oCPU.CX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.CX.UInt16, (ushort)((short)this.oGameData.DifficultyLevel));
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
		...
		public void F0_1238_1767()
		{
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.PollutedSquareCount;
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, 0x1);
			this.oCPU.CX.UInt16 = (ushort)this.oGameData.GlobalWarmingCount;
			this.oCPU.CX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.CX.UInt16, 0x2);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.PollutionEffectLevel);
			this.oCPU.AX.UInt16 = (ushort)Math.Sign((short)this.oCPU.AX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.PollutionEffectLevel);
			
			// Instruction address 0x1238:0x1797, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange((short)this.oCPU.AX.UInt16, 0, 99);

			oParent.GameData.PollutionEffectLevel = (short)this.oCPU.AX.UInt16;
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0xc);
		...
		L182b:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0xe);
		...
		L1861:			
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].StatusFlag == 0xff ||
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].PlayerID != this.oGameData.HumanPlayerID)
				goto L1854;

			this.oCPU.AX.LowUInt8 = (byte)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].CurrentProductionID;
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.CX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8));
			this.oCPU.CX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.CX.UInt16, 0x18);
			this.oCPU.CX.UInt16 = this.oCPU.NEGUInt16(this.oCPU.CX.UInt16);
		...
		L18ab:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(21));
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.HumanPlayerID,
				(int)this.oGameData.Static.ImprovementDefinitions(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))).RequiresTechnology);
		...
		L1945:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].PlayerID;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), this.oCPU.AX.UInt16);
			...
			if ((this.oGameData.Players[this.oCPU.AX.UInt16].Diplomacy[0] & 0x4) != 0)
				goto L189d;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0x11);
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), (int)TechnologyEnum.Rocketry);
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
		...
		L1981:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.HumanPlayerID, (int)TechnologyEnum.Rocketry);
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L19ba;

			this.oCPU.CMPUInt16((ushort)this.oGameData.WonderCityID[17], 0xffff);
			if (this.oCPU.Flags.NE) goto L19ba;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), 0x11);
		...
		L19ba:
			...
			if (this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].MilitaryPower <=
		...
		L1a00:
			if (this.oGameData.WonderCityID[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))] == -1)
				goto L1a11;
			goto L189d;

		L1a11:			
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].ActualSize <= 
				(this.oGameData.Static.Wonders[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Price / 10))
				goto L189d;

			// Instruction address 0x1238:0x1a44, size: 5
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)),
				(int)this.oGameData.Static.Wonders[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].RequiresTechnology);
		...
		L1a53:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2));
			this.oGameData.WonderCityID[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))] = (short)this.oCPU.AX.UInt16;
			
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].ShieldsCount = 0;
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Nationality);

			// Instruction address 0x1238:0x1ab4, size: 5
			this.oParent.MSCAPI.strcat(0xba06, ")\nbuilds ");

			// Instruction address 0x1238:0x1ac6, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Static.Wonders[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Name);
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Coins / 3, 
				0,
				(10 * this.oGameData.Static.Wonders[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Price) -
					this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].ShieldsCount);

			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Coins -= (short)this.oCPU.AX.UInt16;
			...
			this.oParent.CommonTools.F0_1000_0a32_PlayTune(
				this.oGameData.Static.Nations[this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].NationalityID].ShortTune, 0);

			this.oCPU.BX.UInt16 = (ushort)this.oGameData.HumanPlayerID;
			this.oCPU.CX.LowUInt8 = 0x4;
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, this.oCPU.CX.LowUInt8);

			if ((this.oGameData.Players[this.oGameData.HumanPlayerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] & 0x40) == 0)
			{
				this.oParent.Var_2f9e = 2;
			}
			else
		...
		public void F0_1238_1beb()
		{
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x10), "back0a.pal");

			this.oCPU.SI.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].GovernmentType;
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.SARUInt16(this.oCPU.AX.UInt16, 0x1);
			...
			this.oCPU.CMPUInt16(this.oCPU.SI.UInt16, 0x3);
		...
		L1c32:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.HumanPlayerID, (int)TechnologyEnum.Invention);
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
			{
