...
namespace OpenCiv1
{
	public class Overlay_23
	{
		...
		public void F23_0000_025b()
		{
			...
			if (!this.oGameData.Map[this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Position.X,
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Position.Y].IsVisibleTo(this.oGameData.HumanPlayerID)) goto L02cd;
		...
		L0393:
			...
			this.oCPU.AX.Low = this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12))].NameID;
			this.oCPU.AX.High = 0;
		...
		L03bc:
			...
			for (int i = 0; i < 13; i++)
			{
				this.oCPU.Memory.WriteUInt8(this.oCPU.SS.Word, (ushort)(usStringOffset + i), this.oGameData.CityNames[uiCityNameID][i]);
			}
