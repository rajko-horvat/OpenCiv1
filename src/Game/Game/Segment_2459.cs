...
namespace OpenCiv1
{
	public class Segment_2459
	{
		...
		public void F0_2459_0000(short playerID, short cityID, ushort flag)
		{
			...
			{
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].ContactPlayerCountdown = -2;
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), this.oCPU.AX.UInt16);
		...
		L005c:
			...
			if (this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].CityCount <= 4 ||
				this.oGameData.Players[this.oGameData.HumanPlayerID].Ranking >=
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Ranking) goto L00c5;
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2),
				(short)this.oGameData.FindNearestDomesticCity(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))));
			...
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].CurrentProductionID = -1;

			this.oCPU.AX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12));
			this.oGameData.Cities[cityID].PlayerID = (sbyte)this.oCPU.AX.LowUInt8;
		...
		L00de:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				...
				0,
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Coins);
			...
			this.oCPU.AX.UInt16 = (ushort)((short)(0x22 * this.oGameData.Players[playerID].Units[unitIDTemp].TypeID));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;

			if (this.oGameData.Static.Units[this.oGameData.Players[playerID].Units[unitIDTemp].TypeID].AttackStrength > 2)
				goto L016c;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x28bc), 0x0);
			if (this.oCPU.Flags.NE) goto L016c;
		...
		L01dc:
			...
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Coins -= (short)this.oCPU.AX.UInt16;
		...
		L024b:
			...
			this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Layer2_PlayerOwnership = playerID;
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x14);
		...
		L02ae:
			...
			this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].UpdateVisibleImprovements(this.oGameData.HumanPlayerID);

			if (this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) == this.oGameData.HumanPlayerID)
			{
			...
			this.oParent.MapManagement.F0_2aea_03ba(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
		...
		L03e6:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[cityID].VisibleSize = (sbyte)this.oCPU.CX.LowUInt8;
			goto L04bc;
		...
		L03f7:
			...
			if ((this.oGameData.Players[this.oGameData.HumanPlayerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))] & 0x40) == 0)
				goto L04bc;
		...
		L041a:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Nationality);
		...
		L04df:
			...
			if (this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].TypeID == -1 ||
				this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].HomeCityID != cityID)
				goto L0531;
			...
			if ((this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].Position.X !=
				this.oGameData.Cities[cityID].Position.X) ||
				(this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].Position.Y !=
				this.oGameData.Cities[cityID].Position.Y) ||
				(this.oGameData.Cities[cityID].ActualSize == 0))
			{
				// Instruction address 0x2459:0x0529, size: 5
				this.oParent.Segment_1866.F0_1866_0f10(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)),
		...
		L0531:
			...
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].UnitsInProduction[this.oGameData.Cities[cityID].CurrentProductionID]--;
		...
		L05a6:
			...
			this.oGameData.Cities[cityID].CurrentProductionID = (sbyte)this.oCPU.AX.LowUInt8;
		...
		L05da:
			this.oParent.StartGameMenu.F5_0000_0e6c_PlayerCheckEndGame(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), playerID);
		...
		public void F0_2459_05ee(short playerID)
		{
			...
			if ((this.oGameData.SpaceshipFlags & this.oCPU.AX.UInt16) != 0)
			{
		...
		public ushort F0_2459_0687(short cityID)
		{
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].Coins);
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.CX.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].TotalCitySize;
		...
		L06ca:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].Coins;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.BX.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].TotalCitySize;
		...
		public void F0_2459_06f2(short playerID1, short playerID2)
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.SP.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SP.UInt16, 0x9a);
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);
		...
		L072d:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID1,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x98)));
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oGameData.Static.Technologies[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x98))].Name);
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x96)));
		...
		L07b9:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x98), this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x98))));
		...
		L07fe:
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(playerID1,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x94)),
				playerID2);
		...
		L08a1:
			...
			this.oParent.Segment_25fb.F0_25fb_3459(playerID1, -1);
		...
		public void F0_2459_08c6_GetCityName(int cityID)
		{
			...
			if (cityID != -1)
			{
				...
				for (int i = 0; i < 0xd; i++)
				{
					this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(usStringOffset + i), (byte)this.oGameData.CityNames[ubCityNameID][i]);
				}
			}
			else
			{
		...
		public ushort F0_2459_0948(short playerID, short unitID, short cityID)
		{
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.AX.UInt16);
			this.oCPU.AX.LowUInt8 = (byte)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].BaseTrade;
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.LowUInt8 = (byte)this.oGameData.Cities[cityID].BaseTrade;
			this.oCPU.CBW(this.oCPU.AX);
			...
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.AX.UInt16);
			this.oCPU.AX.UInt16 = (ushort)((short)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Position.X);
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12),
				(short)this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)),
					this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].Layer3_GroupID);

			// Instruction address 0x2459:0x09db, size: 5
			if (this.oGameData.Map[this.oGameData.Cities[cityID].Position].Layer3_GroupID != this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)))
				goto L09f4;
		...
		L0a12:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.Cities[cityID].PlayerID, (int)TechnologyEnum.Railroad);
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.E)
				goto L0a3c;
			...
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), this.oCPU.AX.UInt16));

		L0a3c:
			// Instruction address 0x2459:0x0a4e, size: 5
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.Cities[cityID].PlayerID, (int)TechnologyEnum.Flight);
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.E)
				goto L0a66;
		...
		L0a66:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2));
			this.oGameData.Players[playerID].Coins += (short)this.oCPU.AX.UInt16;
			this.oGameData.Players[playerID].ResearchProgress += (short)this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.HumanPlayerID;
			this.oCPU.CMPUInt16((ushort)playerID, this.oCPU.AX.UInt16);
		...
		L0a81:
			...
			this.oCPU.BX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.BX.UInt16, 0x7);
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			// Instruction address 0x2459:0x0a91, size: 5
			this.oParent.MSCAPI.strcpy(0xba06, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x1972)));
		...
		L0b23:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.SHLUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), 0x1));
		...
		L0b5a:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0xff);
		...
		L0b68:
			...
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.LowUInt8 = (byte)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].BaseTrade;
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), this.oCPU.AX.UInt16);
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].PlayerID;
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, (ushort)playerID);
			if (this.oCPU.Flags.E) goto L0b85;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), this.oCPU.SHLUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0x1));
		...
		L0b9c:
			...
			this.oCPU.AX.LowUInt8 = (byte)this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].TradeCityIDs[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa))];
		...
		L0bc3:
			...
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].TradeCityIDs[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))] = (sbyte)this.oCPU.AX.LowUInt8;
			goto L0bbe;
