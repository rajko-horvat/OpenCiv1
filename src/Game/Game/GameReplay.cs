...
namespace OpenCiv1
{
	public class GameReplay
	{
		...
		public void F9_0000_0000()
		{
			...
			this.oCPU.SP.UInt16 = this.oCPU.SUBUInt16(this.oCPU.SP.UInt16, 0x24);
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);

			TerrainTypeEnum local_22;

		L0007:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680e), 0x0);
		...
		L002d:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680a), 0x0);
			if (this.oCPU.Flags.G) goto L0037;
			goto L089e;

		L0037:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680a), 0x3);
		...
		L00b3:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].NationalityID;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x20), this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0x8);
		...
		L00d2:
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].NationalityID = (short)this.oCPU.AX.UInt16;
		...
		L00e8:
			...
			this.oCPU.TESTUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.PlayerIdentityFlags);
		...
		L010c:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680a), 0x4);
		...
		L0160:
			...
			local_22 = this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].TerrainType;
		...
		L0184:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x31);
		...
		L0196:
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.ReplayDataLength;
		...
		L01a1:
			this.oCPU.AX.LowUInt8 = this.oGameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))];
			this.oCPU.AX.HighUInt8 = 0;
			this.oCPU.AX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.AX.UInt16, 0xf);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x24), this.oCPU.AX.UInt16);
			this.oCPU.AX.LowUInt8 = this.oGameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))];
			this.oCPU.AX.HighUInt8 = 0;
			this.oCPU.CX.LowUInt8 = 0x4;
			this.oCPU.AX.UInt16 = this.oCPU.SHRUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
		...
		L025d:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6810), 0xff);
			if (this.oCPU.Flags.NE) goto L02a6;
			goto L0336;

		L02a6:
			// Instruction address 0x0000:0x02b4, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x6810)].Nation);

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x1);
		...
		L0300:
			...
			for (int i = 0; i < 0xd; i++)
			{
				this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(usStringOffset + i), (byte)this.oGameData.CityNames[uiCityNameID][i]);
			}
		...
		L0388:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680a), 0x1);
		...
		L03ae:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa))].Nation);
		...
		L03eb:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Nation);
		...
		L0414:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa))].Nation);
		...
		L0453:
			...
			this.oParent.MSCAPI.strcat(0xba06, 
				this.oGameData.Static.Technologies[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);
		...
		L04a8:
			...
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Static.Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);
		...
		L04fb:
			...
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oParent.Array_1966[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))]);
		...
		L054f:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x7);
		...
		L05ad:
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.MSCAPI.strcat(0xba06,
				this.oGameData.Static.Wonders[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);
		...
		L05b9:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), 10));
		...
		L0671:
			this.oCPU.TESTUInt8(this.oGameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))], 0xf0);
			if (this.oCPU.Flags.E) goto L06e8;

			// Instruction address 0x0000:0x069c, size: 5
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)((short)(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) << 1) + 1), 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oGameData.Players[this.oGameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))] >> 4].Nation);

			// Instruction address 0x0000:0x06e0, size: 5
			this.oParent.MSCAPI.strcat(0xba06, " ");

		L06e8:
			this.oCPU.TESTUInt8(this.oGameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))], 0xf);
			if (this.oCPU.Flags.E) goto L075d;

			// Instruction address 0x0000:0x0714, size: 5
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)((short)(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) << 1) + 2), 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oGameData.Players[this.oGameData.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))] & 0xf].Nation);
		...
		L0779:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x6810)].Nationality);
		...
		L07f3:
			this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6810)].NationalityID ^= 8;
		...
		L0826:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680a), 0x2);
		...
		L0830:
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x1b);
		...
		L086e:
			...
			this.oParent.MSCAPI.close((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680c));
		...
		L08b3:
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.HumanPlayerID;
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6810), this.oCPU.AX.UInt16);
		...
		L08c8:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(0xba06, 4, 1, 0);
			...
			this.oParent.MSCAPI.write((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680c), 0xba06, this.oCPU.AX.UInt16);

		L0935:
			// Instruction address 0x0000:0x093d, size: 5
			this.oCPU.WriteString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06),
				this.oParent.LanguageTools.F0_2f4d_04f7_TrimStringToWidth(this.oCPU.ReadString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06)), 312));
		...
		L09ed:
			...
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.ES.UInt16 = 0x3725; // segment
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x0)), 0xffff);
		...
		L0a33:
			...
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.ES.UInt16 = 0x3725; // segment
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x100)), param2);
			if (this.oCPU.Flags.NE) goto L0a30;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x200)), param3);
			if (this.oCPU.Flags.NE) goto L0a30;
		...
		L0b49:
			...
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.ES.UInt16 = 0x3725; // segment
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x0)), 0x1);
			if (this.oCPU.Flags.NE) goto L0b5f;

			// Instruction address 0x0000:0x0b84, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, xPos * 4, (yPos * 4) + 4, 4, 4, 7);
			goto L0b8c;

		L0b5f:
			// Instruction address 0x0000:0x0b84, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, xPos * 4, (yPos * 4) + 4, 4, 4, 15);
			goto L0b8c;

		L0b64:
			// Instruction address 0x0000:0x0b84, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, xPos * 4, (yPos * 4) + 4, 4, 4, 8);
		...
		L0b8f:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6812), 0x6);
			...
			if (this.oGameData.Map[xPos, yPos].Layer3_GroupID ==
				this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x100)),
				this.oCPU.ReadInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x200))].Layer3_GroupID) goto L0bf5;
			goto L0b64;

		L0bf5:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6812), 0x0);
		...
		L0c4b:
			...
			if (this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].TerrainType != TerrainTypeEnum.Water) goto L0c3f;
		...
		L0c7d:
			this.oCPU.AX.LowUInt8 = (byte)this.oGameData.CityNames[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))][this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))];
			...
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
			this.oCPU.AX.UInt16 = this.oCPU.INCUInt16(this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x50);
			if (this.oCPU.Flags.GE) goto L0cbc;

			if (this.oGameData.CityNames[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))][this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))] != '\0')
				goto L0c7d;
		...
		L0cbf:
			...
			if (this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].TerrainType == TerrainTypeEnum.Water) goto L0cbc;
		...
		L0ce2:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), 0x100);
			if (this.oCPU.Flags.GE) goto L0cbc;
			this.oCPU.AX.LowUInt8 = (byte)((sbyte)this.oGameData.CityNameFlags[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].X);
			...
			this.oCPU.AX.LowUInt8 = (byte)((sbyte)this.oGameData.CityNameFlags[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Y);
			this.oCPU.CBW(this.oCPU.AX);
			...
			if (this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Improvements.ContainsAnyFlag(TerrainImprovementEnum.City)) goto L0d1f;
			goto L0c6f;
		...
		L0d24:
			...
			this.oParent.MSCAPI.write((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x680c), 0xba06, 0x52);
		...
		public void F9_0000_0d5d(short playerID)
		{
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x10),
				this.oGameData.Static.Nations[this.oGameData.Players[playerID].NationalityID].Nation);

			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x0);
			...
			this.oParent.MSCAPI.strcat((ushort)(this.oCPU.BP.UInt16 - 0x10), "s");

		L0dc4:
			// Instruction address 0x0000:0x0dd1, size: 5
			this.oGameData.Players[playerID].Nation = this.oCPU.ReadString(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10));
		...
		L0dfe:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0xe);
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 18, 150, 284, 32, 34);
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 152, 20);

			// Instruction address 0x0000:0x0ecb, size: 5
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 151, 23);
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 168, 20);

			// Instruction address 0x0000:0x0f2d, size: 5
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 167, 23);
		...
		public void F9_0000_0f79(short playerID, ushort param2)
		{
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x24), "slam2.pic");
		...
		L10db:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)), 0xe);
		...
		L1161:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x28), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x28)), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x12));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x28), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x28)), this.oCPU.AX.UInt16));
			this.oCPU.ES.UInt16 = 0x36fa; // segment
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2c), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2c)), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.ES.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x4a));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2c), this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2c)), this.oCPU.AX.UInt16));
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x9), "pal");
		...
		L122d:
			...
			this.oParent.Var_bdee[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)) + 6] =
				this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0xc1dc));

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2e)), 0x1b0);
			if (this.oCPU.Flags.L) goto L122d;

			// Instruction address 0x0000:0x124c, size: 5
			this.oParent.CommonTools.F0_1000_04aa_TransformPalette(8, this.oParent.Var_bdee);
			...
			this.oCPU.TESTUInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26)), 0x1);
		...
		L127d:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26), this.oCPU.AX.UInt16);
			this.oCPU.AX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0xb1d4);
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xb1d4, this.oCPU.INCUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0xb1d4)));
			this.oCPU.CMPUInt8(this.oCPU.AX.LowUInt8, 0x7);
			if (this.oCPU.Flags.L) goto L128f;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26)), 0x7));
		...
		L135f:
			...
			this.oCPU.DoEvents();
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0xf0);
			...
			this.oParent.Segment_2dc4.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), "");
