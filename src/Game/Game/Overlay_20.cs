...
namespace OpenCiv1
{
	public class Overlay_20
	{
		...
		L0033:
			...
			this.oCPU.CMPUInt8(this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].StatusFlag, 0xff);
			if (this.oCPU.Flags.NE) goto L0026;
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[playerID].NationalityID;
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x7);
			if (this.oCPU.Flags.L) goto L0057;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))));

		L0057:
			this.oCPU.CX.LowUInt8 = 0x4;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.SHLUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), this.oCPU.CX.LowUInt8));
		...
		L0062:
			...
			if (this.oGameData.CityNameFlags[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].X == -1)
				goto L00ab;
			...
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, 0x10);
			...
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)));
			if (this.oCPU.Flags.NE) goto L008e;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 0xe0);

		L008e:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x100);
		...
		L00ab:
			...
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID = this.oCPU.AX.LowUInt8;

			this.oGameData.CityNameFlags[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))] = new GPoint(xPos, yPos);
			...
			this.oParent.Overlay_23.F23_0000_0000(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
		...
		L00fe:
			byte ubCityNameID = this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID;
		...
		L0118:
			ubCityNameID = this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 0xb);

			while (this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)) > 0 &&
				this.oGameData.CityNames[ubCityNameID][this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] == ' ')
			{
				acCityName = this.oGameData.CityNames[ubCityNameID].ToCharArray();
				acCityName[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] = '\0';
				this.oGameData.CityNames[ubCityNameID] = new string(acCityName);
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc),
					this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))));
			}

			// Instruction address 0x0000:0x016f, size: 5
			this.oParent.Segment_1866.F0_1866_250e_AddReplayData(1, (byte)playerID,
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID,
				(byte)xPos, (byte)yPos);

			// Instruction address 0x0000:0x0181, size: 5
			this.oGameData.Map[xPos, yPos].Improvements -= [TerrainImprovementEnum.Mine, TerrainImprovementEnum.CityWalls];

			// Instruction address 0x0000:0x0193, size: 5
			this.oGameData.Map[xPos, yPos].Improvements += [TerrainImprovementEnum.City, TerrainImprovementEnum.Roads];

			// Instruction address 0x0000:0x01a1, size: 5
			if (this.oGameData.Map[xPos, yPos].Multi1 < -1)
			{
				// Instruction address 0x0000:0x01c1, size: 5
				this.oGameData.Map[xPos, yPos].Improvements += TerrainImprovementEnum.Irrigation;
			}
		
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].StatusFlag = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Position.X = xPos;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Position.Y = yPos;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].ActualSize = (sbyte)citySize;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].VisibleSize = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].WorkerFlags = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].BaseTrade = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].FoodCount = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].ShieldsCount = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].ImprovementFlags = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = 1;
			...
			{
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = 4;
			}
		
			// Instruction address 0x0000:0x0235, size: 5
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, (int)TechnologyEnum.Conscription);
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
			{
				this.oCPU.AX.UInt16 = 0x1c;
				this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
				this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = 5;
			}
		
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Unknown[0] = -1;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Unknown[1] = -1;
		...
		L026a:
			...
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].PlayerID != playerID) goto L0289;
		...
		L0289:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].ImprovementFlags = 1;
		...
		L02ad:
			...
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].BaseTrade = 0;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].PlayerID = playerID;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 0x0);
		...
		L02c6:
			...
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].TradeCityIDs[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] = -1;
			...
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].SpecialWorkerFlags = 0;
		...
		L02f2:
			...
			GPoint direction = TerrainMap.MoveOffsets[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))];
			...
			if (this.oGameData.Map.Groups[this.oGameData.Map[xPos + direction.X, yPos + direction.Y].Layer3_GroupID].Size > 256) goto L033c;
		...
		L033c:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].StatusFlag |= 2;
		...
		L0355:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].StatusFlag |= 8;
		...
		L038d:
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10),
				(short)this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
					this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Layer2_PlayerOwnership);
			...
			this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Layer2_PlayerOwnership = 8;

		L03bf:
			if (playerID == this.oGameData.HumanPlayerID) goto L040e;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x18);
			if (this.oCPU.Flags.G) goto L040e;

			// Instruction address 0x0000:0x03d3, size: 5
			if (!this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Improvements.ContainsAnyFlag(TerrainImprovementEnum.City)) goto L040e;
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].VisibleSize = 1;
		...
		L0411:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x2d);
			if (this.oCPU.Flags.GE) goto L0456;
			
			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc));
			this.oCPU.SI.UInt16 = this.oCPU.SHLUInt16(this.oCPU.SI.UInt16, 0x1);

			direction = TerrainMap.MoveOffsets[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))];
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x14);
		...
		L0442:
			...
			this.oGameData.Map[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Layer2_PlayerOwnership = playerID;
		...
		L0499:
			...
			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = (sbyte)this.oCPU.AX.LowUInt8;
			...
			this.oGameData.Map[this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Position.X,
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Position.Y].SetVisiblity(this.oGameData.HumanPlayerID, true);

			this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].VisibleSize = 1;

			// Instruction address 0x0000:0x04f5, size: 5
			this.oGameData.Map[this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Position].UpdateVisibleImprovements(playerID);
		...
		L0552:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(10));

			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x9);
		...
		L05da:
			...
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TESTUInt16(this.oGameData.Cities[cityID].ImprovementFlags0, 0xfffe);
			if (this.oCPU.Flags.NE) goto L05ed;
			goto L0bc6;

		L05ed:
			// Instruction address 0x0000:0x05f1, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(24));
			...
			this.oCPU.BX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.BX.UInt16, this.oCPU.AX.UInt16);
			this.oCPU.CX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.CX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.CX.UInt16 = this.oCPU.ORUInt16(this.oCPU.CX.UInt16, this.oCPU.BX.UInt16);
			if (this.oCPU.Flags.E) goto L05ed;
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			...
			this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10));
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.AX.UInt16 = this.oCPU.NOTUInt16(this.oCPU.AX.UInt16);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oGameData.Cities[cityID].ImprovementFlags0 &= this.oCPU.AX.UInt16;
			this.oGameData.Cities[cityID].ImprovementFlags1 &= this.oCPU.DX.UInt16;
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oGameData.Static.ImprovementDefinitions(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)) + 1).Name);
		...
		L0698:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.Cities[cityID].PlayerID, (int)TechnologyEnum.Medicine);
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
		...
		L06b9:
			this.oCPU.TESTUInt16(this.oGameData.Cities[cityID].ImprovementFlags0, 0x100);
			if (this.oCPU.Flags.E) goto L06c4;
			goto L0bc6;

		L06c4:
			// Instruction address 0x0000:0x06ce, size: 5
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.Cities[cityID].PlayerID, 
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xcc4));
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L06dd;
		...
		L06dd:
			...
			this.oCPU.CMPUInt8((byte)this.oGameData.Cities[cityID].ActualSize, 0x0);
		...
		L06fa:
			...
			this.oGameData.Cities[cityID].ActualSize -= (sbyte)this.oCPU.AX.LowUInt8;
			goto L0bc6;
		...
		L070d:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TESTUInt16(this.oGameData.Cities[cityID].ImprovementFlags0, 0x80);
		...
		L071f:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.Cities[cityID].PlayerID, 
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xca6));
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0738;
		...
		L0759:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TESTUInt16(this.oGameData.Cities[cityID].ImprovementFlags0, 0x8);
		...
		L076b:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.Cities[cityID].PlayerID, 
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xc2e));
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0784;
		...
		L07b6:
			this.oCPU.TESTUInt16(this.oGameData.Cities[cityID].ImprovementFlags0, 0x4);
		...
		L07c0:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.Cities[cityID].PlayerID, 
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xc10));
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L07d9;
		...
		L0835:
			...
			this.oParent.Array_30b8[0] = this.oGameData.Static.ImprovementDefinitions(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)) + 1).Name;
		...
		L096d:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TESTUInt16(this.oGameData.Cities[cityID].ImprovementFlags0, 0x40);
		...
		L09c3:
			...
			this.oCPU.AX.UInt16 = 0x1;
			this.oCPU.CX.LowUInt8 = (byte)this.oGameData.Cities[cityID].PlayerID;
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.TESTUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.HumanPlayerBitFlag);
		...
		L0af7:
			...
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			if (this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].PlayerID !=
		...
		L0b92:
			this.oParent.Overlay_22.F22_0000_0af5(cityID, 
				this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].PlayerID);
			
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

		L0bc6:
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0xba06), 0x0);
		...
		L0c4c:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))));
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xba06)), 0xa);
		...
		L0cd9:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA("SCORING COMPLETED", 160, 100, 15);
		...
		L0db8:
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			...
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_70e2));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_70e4));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_e8b8));
		...
		L0e00:
			...
			this.oParent.CityWorker.F0_1d12_6da1_GetSpecialWorkerFlags(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)));
		...
		L0e3c:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x80);
			if (this.oCPU.Flags.GE) goto L0e79;
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)));
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.CMPUInt8(this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].StatusFlag, 0xff);
		...
		L0e79:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd766), 10));
		...
		L0f15:
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.WonderCityID[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))];
		...
		L0f2f:
			...
			if (this.oGameData.Cities[this.oCPU.SI.UInt16].PlayerID != playerID) goto L0fb9;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0x98));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0x12c);
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), this.oCPU.AX.UInt16));
		...
		L0f6a:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xb4);
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(
				this.oGameData.Static.Wonders[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].Name,
		...
		L0fb4:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd764, this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd764), 0x14));

		L0fb9:
			if (this.oGameData.WonderCityID[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))] != -1)
				goto L0fca;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), 0x0);
		...
		L0fca:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x15);
		...
		L0fd6:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd764), 10));
			...
			this.oParent.DrawStringTools.F0_1182_0086_DrawStringWithShadowToRectAA(0xba06, 16, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 15);

		L1049:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd764);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd766));
			this.oGameData.Players[0].Score = (short)this.oCPU.AX.UInt16;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xa));
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.Players[oParent.GameData.HumanPlayerID].SpaceshipPopulation;
		...
		L1072:
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].SpaceshipSuccessRate;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.SI.UInt16);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
		...
		L1088:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 10));
		...
		L10e0:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xb8);
			if (this.oCPU.Flags.GE) goto L1114;

			// Instruction address 0x0000:0x110c, size: 5
			this.oParent.DrawStringTools.F0_1182_0086_DrawStringWithShadowToRectAA(0xba06, 16, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 15);
		...
		L1174:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)), 10));
		...
		L11e3:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].FutureTechnologyCount);
			this.oGameData.Players[0].Score += (short)this.oCPU.AX.UInt16;
		...
		L123a:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xa));
		...
		L1269:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)((short)this.oGameData.MaximumPlayers));
			this.oCPU.CX.UInt16 = 0x226;
			this.oCPU.CX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.CX.UInt16, (ushort)this.oGameData.TurnCount);
			...
			this.oCPU.CX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.CX.UInt16, 0x190);
		...
		L128e:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.Players[0].Score;
		...
		L12d6:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)), 10));
		...
		L130c:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xba);
		...
		L1330:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x5116, this.oCPU.DECUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x5116)));
		...
		public void F20_0000_13f8(ushort param1)
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb25c, this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb25c), 0x8));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb25c), 0x124);
			if (this.oCPU.Flags.LE) goto L141d;
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x5116);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb2bc, this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb2bc), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb2bc);
			this.oCPU.AX.UInt16 = this.oCPU.SARUInt16(this.oCPU.AX.UInt16, 0x1);
			this.oCPU.AX.UInt16 = this.oCPU.ANDUInt16(this.oCPU.AX.UInt16, 0x4);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, 0x10);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb25c, this.oCPU.AX.UInt16);

		L141d:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb2bc), 0xa0);
