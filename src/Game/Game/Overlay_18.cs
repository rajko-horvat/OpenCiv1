...
namespace OpenCiv1
{
	public class Overlay_18
	{
		...
		L0055:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0xa);
		...
		L0095:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(240));
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MSCAPI.RNG.Next(192));

			this.oCPU.AX.LowUInt8 = this.oCPU.ADDUInt8(this.oCPU.AX.LowUInt8, 0x8);
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2));
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x14);
			if (this.oCPU.Flags.L) goto L0095;

			// Instruction address 0x0000:0x00e0, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(1, 30, 208, 223);

			// Instruction address 0x0000:0x00f8, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(2, 11, 192, 207);

			// Instruction address 0x0000:0x0110, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(3, 20, 224, 239);

			// Instruction address 0x0000:0x0128, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(4, 8, 144, 159);
		...
		L0154:
			...
			this.oParent.CommonTools.F0_1000_03fa_StartPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x5);
		...
		L018f:
			...
			this.oParent.CommonTools.F0_1000_042b_StopPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)));
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0x5);
		...
		L0286:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 0, 320, 8,
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 1, 0);
		...
		L032a:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 10);
		...
		L0343:
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), 
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].XPos);

			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10),
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].YPos);
			...
			this.oCPU.BX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.BX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)));

			int iPos = (12 * this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].XPos) +
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].YPos;
		...
		L03f9:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)), this.oCPU.AX.UInt16);
			...
			this.oCPU.SI.UInt16 = this.oCPU.ADDUInt16(this.oCPU.SI.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)));
			this.oCPU.DI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10));
			this.oCPU.DI.UInt16 = this.oCPU.ADDUInt16(this.oCPU.DI.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)));
			
			F18_0000_0c11_GetSpaceShipData(playerID, (short)((ushort)(this.oCPU.SI.UInt16 + 0x1)), (short)this.oCPU.DI.UInt16);
			
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), this.oCPU.AX.UInt16));
		...
		L0469:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdea2), 
				this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdea2))));
			goto L04c9;
		...
		L04b0:
			if (this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].BitmapID < 3)
			{
		...
		L04c9:
			...
			if (this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].XPos != -1)
				goto L0343;
		...
		L04ef:
			...
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe));
			this.oCPU.BX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdea2)));
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0xa);
			...
			this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle, 152, 88, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6834));
		...
		L0534:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 240, 8, 80, 192, 
				this.oParent.Array_1946[playerID]);
		...
		L0592:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("Population:", 242, 16, 0);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x8));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

			// Instruction address 0x0000:0x05d5, size: 5
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeae), 10));
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(0xba06, 242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0);

		L0609:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x8));

			// Instruction address 0x0000:0x0619, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdeae), 1, 99);

			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0x64;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeb0));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 10));

			// Instruction address 0x0000:0x0668, size: 5
			this.oParent.MSCAPI.strcat(0xba06, "%");

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 0x64);
		...
		L06b9:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeb2));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), this.oCPU.CX.UInt16);
		...
		L0764:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 
				this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x10));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x0);
			if (this.oCPU.Flags.E) goto L0784;
			
			// Instruction address 0x0000:0x077c, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("Mass:", 242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0);
		...
		L0784:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)) / 10), 10));
		...
		L0817:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdea8), 1, 99);

			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0x64;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeaa));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);
		...
		L08a5:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("Flight Time:", 242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0);
		...
		L08c5:
			...
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x96);
			if (this.oCPU.Flags.LE) goto L0904;
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, 0x96);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.CX.UInt16 = 0xa;
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 
				this.oCPU.SUBUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), this.oCPU.AX.UInt16));
		...
		L0904:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)) / 10), 10));
		...
		L0993:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x10));
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("Prob. of Success", 242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0);
		...
		L09c8:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 10));
		...
		L0a28:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.ADDUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x10));
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeae), 0x0);
		...
		L0a4f:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(((this.oGameData.Players[playerID].SpaceshipETAYear < oParent.GameData.Year) ? "Landed!" : "Launched!"),
				242,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)),
				0);
		...
		L0a7e:
			...
			this.oCPU.CX.UInt16 = 0xa;
			this.oCPU.IDIVUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.Year);
			this.oGameData.Players[playerID].SpaceshipETAYear = (short)this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.HumanPlayerID;
			this.oCPU.CMPUInt16((ushort)playerID, this.oCPU.AX.UInt16);
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("LAUNCH", 256, 190, 0);
		...
		L0b6c:
			...
			this.oCPU.CMPUInt16(this.oParent.Var_db3e, 0xbe);
			if (this.oCPU.Flags.GE) goto L0b89;

		L0b83:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)), 0x6c);
		...
		L0bfc:
			...
			this.oGameData.Players[playerID].SpaceshipPopulation = (short)this.oCPU.AX.UInt16;
		...
		L0c57:
			...
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e), this.oCPU.ADDUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e)), 0x2));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 0x7);

		L0c64:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e)), 0xf0);
		...
		L0c8d:
			...
			this.oParent.CommonTools.F0_1000_104f_SetPixel(this.oCPU.ReadInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e)),
		...
		L0cd0:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e), this.oCPU.INCUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e))));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 0x3);
			goto L0c64;

		L0cde:
			this.oCPU.TESTUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0x687a), 0x1);
		...
		L0cff:
			...
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6866)), 0x0);
		...
		L0d47:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x687a, this.oCPU.INCUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x687a)));
			this.oCPU.SP.UInt16 = this.oCPU.BP.UInt16;
			this.oCPU.BP.UInt16 = this.oCPU.POPUInt16();
			// Far return
		...
		public ushort F18_0000_0d4f(short playerID, short param2)
		{
			...
			this.oCPU.PUSHUInt16(this.oCPU.SI.UInt16);
			this.oCPU.AX.UInt16 = 0;
			this.oGameData.AISpaceshipSuccessRate = (short)this.oCPU.AX.UInt16;
			...
			this.oCPU.CMPUInt16((ushort)param2, 0x2);
			if (this.oCPU.Flags.E) goto L0d9b;
			this.oCPU.SI.UInt16 = (ushort)this.oGameData.Players[playerID].SpaceshipETAYear;
			this.oCPU.CMPUInt16(this.oCPU.SI.UInt16, 0xffff);
			if (this.oCPU.Flags.E) goto L0da0;
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, (ushort)this.oGameData.Year);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0xf);
			if (this.oCPU.Flags.GE) goto L0da0;
			this.oCPU.DI.UInt16 = (ushort)this.oGameData.Players[this.oGameData.HumanPlayerID].SpaceshipETAYear;
			this.oCPU.CMPUInt16(this.oCPU.SI.UInt16, this.oCPU.DI.UInt16);
			if (this.oCPU.Flags.L) goto L0d9b;
			this.oCPU.CMPUInt16(this.oCPU.DI.UInt16, 0xffff);
		...
		L0da0:
			...
			int iPos = (12 * this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].XPos) +
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].YPos;
			...
			this.oCPU.AX.UInt16 = 0x3;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, (ushort)param2);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, 0x3);
			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;

			if (this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].BitmapID >= (short)this.oCPU.CX.UInt16)
			{
		...
		L0df7:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].BitmapID);
			this.oCPU.CX.LowUInt8 = 0x3;
			this.oCPU.IDIVUInt8(this.oCPU.AX, this.oCPU.CX.LowUInt8);
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, (ushort)param2);
		...
		L0e1a:
			...
			if (this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].XPos == -1)
				goto L0e68;

			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.AX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
		...
		L0e4a:
			...
			this.oCPU.AX.UInt16 = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, 
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xe68)));
			this.oCPU.AX.UInt16 = this.oCPU.ORUInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0e68;
		...
		L0eb6:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 96, 15);
			...
			iPos = (12 * this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].XPos) +
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].YPos;

			this.oGameData.Players[playerID].SpaceshipData[iPos] =
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].BitmapID;
			...
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oGameData.SpaceshipFlags |= (short)this.oCPU.AX.UInt16;
		...
		L0fc0:
			...
			this.oParent.Var_b276 = (short)this.oCPU.AX.UInt16;
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x3);
		...
		L1014:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16), this.oCPU.AX.UInt16);
			this.oCPU.CMPUInt16(this.oCPU.AX.UInt16, 0x5);
			if (this.oCPU.Flags.NE) goto L1036;
			goto L12de;
		...
		L1055:
			...
			if (this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].BitmapID >= 3)
				goto L1075;

			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 0x63);
		...
		L1078:
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x21);
			...
			int iPos = (12 * this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].XPos) +
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].YPos;
		...
		L10d2:
			...
			iPos = (12 * this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].XPos) +
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].YPos;
		...
		L1117:
			...
			this.oCPU.CMPUInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x63);
		...
		L1137:
			...
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.CMPUInt8(this.oCPU.ReadUInt8(this.oCPU.ES.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x0)), 0xff);
			...
			this.oCPU.CX.UInt16 = this.oCPU.SUBUInt16(this.oCPU.CX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)));
		...
		L116e:
			...
			if (this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].BitmapID == this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)))
				goto L11cf;
		...
		L11b6:
			...
			if (this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].XPos != -1)
				goto L116e;
		...
		L11cf:
			...
			this.oGameData.Players[playerID].SpaceshipData[iPos] =
				this.oGameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].BitmapID;
		...
		L120c:
			...
			this.oCPU.AX.UInt16 = this.oCPU.SHLUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x687a), this.oCPU.ORUInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x687a)), this.oCPU.AX.UInt16));

			// Instruction address 0x0000:0x122b, size: 5
			this.oParent.MSCAPI.strcpy(0xba06, "No further ");

			this.oCPU.AX.UInt16 = 0x3;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, param2);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)));
			this.oCPU.CX.UInt16 = 0x1a;
			this.oCPU.IMULUInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ADDUInt16(this.oCPU.AX.UInt16, 0x4bd0);
			// Instruction address 0x0000:0x1249, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oCPU.AX.UInt16);
		...
		L128e:
			...
			if (this.oCPU.Flags.NE)
			{
				this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].ContactPlayerCountdown = 0;
			}
		...
		L12c2:
			...
			this.oGameData.Players[this.oGameData.HumanPlayerID].SpaceshipSuccessRate = (short)this.oCPU.AX.UInt16;
		...
		public void F18_0000_1527()
		{
			...
			this.oCPU.TESTUInt16((ushort)this.oGameData.SpaceshipFlags, 0xfe00);
		...
		L154d:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Nationality);
			...
			this.oCPU.AX.UInt16 = (ushort)this.oGameData.SpaceshipFlags;
			this.oCPU.CX.LowUInt8 = 0x9;
			this.oCPU.AX.UInt16 = this.oCPU.SARUInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.AX.LowUInt8 = this.oCPU.XORUInt8(this.oCPU.AX.LowUInt8, 0xff);
			this.oParent.Var_b276 = (short)this.oCPU.AX.UInt16;
		...
		public void F18_0000_15c3(short playerID)
		{
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 92, 15);
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 160, 100, 15);
