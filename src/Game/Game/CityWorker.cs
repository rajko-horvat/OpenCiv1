	...
	public class CityWorker
	{
		...
		public ushort F0_1d12_0045_ProcessCityState(int cityID, short flag)
		{
			...
			if (city.StatusFlag != 0xff)
			{
				...
				for (int i = 0; i < 128; i++)
				{
					if (this.oGameData.Cities[i].StatusFlag != 0xff && i != city.ID)
					{
						...
						local_b0 = this.oGameData.Map.GetDistance(
							...
							this.oGameData.Cities[i].Position.Y);

						if (this.oGameData.Cities[i].PlayerID == city.PlayerID &&
							this.oGameData.Cities[i].HasImprovement(ImprovementEnum.Palace) && local_b0 < this.Var_6b30)
						{
						...
						if (local_b0 <= 5)
						{
							for (int j = 0; j < 21; j++)
							{
								if ((this.oGameData.Cities[i].WorkerFlags & (uint)(1 << j)) != 0 || j == 20)
								{
									int xPos = this.oGameData.Cities[i].Position.X + this.oGameData.Static.CityOffsets[j].X;
									int yPos = this.oGameData.Cities[i].Position.Y + this.oGameData.Static.CityOffsets[j].Y;
				...
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType <= 1)
				{
					local_48 = 1;
				}
				else
				...
				{
					local_4a = -(this.oGameData.DifficultyLevel * 2 - 16);

					if (this.oGameData.Year >= 0 &&
						this.oGameData.Players[this.oGameData.HumanPlayerID].Ranking == 7 &&
						this.oGameData.DifficultyLevel > 1)
					{
						local_4a -= 2;
					}
			...
			L045f:
				...
				if (flag == 1)
				{
					...
					this.oParent.Segment_1866.F0_1866_0006((short)cityID);
					...
					this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 104, 2, 15);
					...
					{
						local_c6 = city.Position.X + this.oGameData.Static.CityOffsets[i].X;
						local_d2 = city.Position.Y + this.oGameData.Static.CityOffsets[i].Y;

						if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID ||
							this.oGameData.Map[local_c6, local_d2].IsVisibleTo(this.Var_6548_PlayerID))
						{
							...
							else
							{
								...
								if (Arr_a6[this.oGameData.Static.CityOffsets[i].X + 2, this.oGameData.Static.CityOffsets[i].Y + 2] != 0)
								{
				...
				if (flag == 0)
				{
					...
					if (city.FoodCount < 0)
					{
						...
						for (int i = 0; i < 128; i++)
						{
							if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID == 0 &&
								this.oGameData.Players[this.Var_6548_PlayerID].Units[i].HomeCityID == cityID)
							{
								local_e8 = i;
								break;
							}
						...
						if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
						{
							...
							this.oParent.Overlay_21.F21_0000_0000((short)cityID);
						...
						else
						{
							...
							if (city.ActualSize <= 0)
							{
								...
								this.oParent.Segment_1ade.F0_1ade_018e((short)cityID, city.Position.X, city.Position.Y);

								this.oParent.StartGameMenu.F5_0000_0e6c_PlayerCheckEndGame(this.Var_6548_PlayerID, 0);
					...
					if ((city.ActualSize + 1) * local_4a <= city.FoodCount)
					{
						...
						if (city.ActualSize > 10 && !city.HasImprovement(ImprovementEnum.Aqueduct) && (this.oGameData.DebugFlags & 0x4) != 0)
						{
							city.ActualSize--;
				...
				for (int i = 0; i < 128; i++)
				{
					if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID != -1 &&
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].HomeCityID == cityID)
					{
						if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID < 26)
						{
							this.oParent.Var_deb8++;

							if (city.ActualSize >= this.oParent.Var_deb8)
							{
								if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType > 1 && (this.oGameData.DebugFlags & 2) != 0)
								{
							...
							if (this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].AttackStrength != 0)
							{
								if (this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].MovementType == UnitMovementTypeEnum.Water)
								{
									this.Var_6546++;
								}
								else
								{
									if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.X != city.Position.X ||
				...
				for (int i = 0; i < this.Var_6540_CityOffsetCount; i++)
				{
					...
					if (this.Var_6548_PlayerID != 0 && !this.oGameData.Map[local_c6, local_d2].IsVisibleTo(this.Var_6548_PlayerID))
					{
						Arr_3e[i] = 1;
					}
					...
					if (local_e8 != -1 && local_e8 != this.Var_6548_PlayerID)
					{
						Arr_a6[this.oGameData.Static.CityOffsets[i].X + 2, this.oGameData.Static.CityOffsets[i].Y + 2] = 1;
						Arr_3e[i] = 1;

						if (local_e8 == this.oGameData.HumanPlayerID)
						{
							this.Var_70e8 = 1;
						}
					}
				...
				if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID ||
					((cityID + this.oGameData.TurnCount) & 0x3) != 0 ||
					(city.StatusFlag & 0x1) != 0 || this.Var_70e8 != 0)
				{
					...
					{
						if (flag == 0 && this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
						{
				...
				if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID && (city.StatusFlag & 0x1) != 0)
				{
			...
			L12c2:
				...
				if (F0_1d12_6c97_PlayerHasWonder(this.Var_6548_PlayerID, (int)WonderEnum.HooverDam) != 0)
				{
					...
					if (this.oGameData.Map[city.Position].Layer3_GroupID ==
						this.oGameData.Map[this.oGameData.Cities[this.oGameData.WonderCityID[(int)WonderEnum.HooverDam]].Position].Layer3_GroupID)
					{
						this.oParent.Var_6c98 = 2;
						local_ac = 2;
					}
				...
				if (flag == 0)
				{
					...
					{
						if ((this.oGameData.Static.Units[city.CurrentProductionID].Price * local_4a) <= city.ShieldsCount)
						{
							if (city.CurrentProductionID == 0 && city.ActualSize == 1 && this.oGameData.DifficultyLevel == 0)
							{
								goto L2307;
							}
							else
							{
								city.ShieldsCount -= (short)(this.oGameData.Static.Units[city.CurrentProductionID].Price * local_4a);

								local_ba = -1;

								if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID || city.CurrentProductionID != 0x1a)
								{
								...
								if ((this.oGameData.TechnologyFirstDiscoveredBy[city.CurrentProductionID] & 0x8) == 0)
								{
									...
									this.oGameData.TechnologyFirstDiscoveredBy[city.CurrentProductionID] |= 8;
								}

								if (city.HasImprovement(ImprovementEnum.Barracks) && local_ba != -1)
								{
									this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].Status |= 0x20;
								}

								if (local_ba != -1 && city.CurrentProductionID == 0 && (city.ActualSize > 1 || this.oGameData.Players[this.Var_6548_PlayerID].CityCount > 1))
								{
									city.ActualSize--;
								...
								if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID && local_ba != -1)
								{
									if (city.CurrentProductionID == 27)
									{
										...
										for (int i = 0; i < 128; i++)
										{
											if (this.oGameData.Cities[i].PlayerID != this.Var_6548_PlayerID && this.oGameData.Cities[i].StatusFlag != 0xff &&
												this.oGameData.Cities[i].PlayerID != this.oGameData.HumanPlayerID && this.oGameData.Cities[i].BaseTrade > local_c8)
											{
												local_c8 = this.oGameData.Cities[i].BaseTrade;
												local_108 = i;
											}
										}
									...
									if (city.CurrentProductionID == 26)
									{
										...
										for (int i = 0; i < 128; i++)
										{
											if (this.oGameData.Cities[i].PlayerID != this.oGameData.HumanPlayerID || this.oGameData.Cities[i].StatusFlag != 0xff)
											{
												...
												if ((this.oGameData.Cities[i].StatusFlag & 0x20) != 0)
												{
												...
												if (local_c8 > this.oParent.Var_6c9a || (local_c8 == this.oParent.Var_6c9a && this.oParent.MSCAPI.RNG.Next(++local_106) == 0))
												{
													...
													if (this.oGameData.Map[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_e8].Position].TerrainType != TerrainTypeEnum.Water)
													{
														// Instruction address 0x1d12:0x1956, size: 5
														// Instruction address 0x1d12:0x1970, size: 5
														if (this.oGameData.Map[this.oGameData.Cities[i].Position].Layer3_GroupID ==
															this.oGameData.Map[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_e8].Position].Layer3_GroupID)
														{
										...
										if (local_c8 > 3 || (this.oGameData.Players[this.Var_6548_PlayerID].Diplomacy[this.oGameData.HumanPlayerID] & 2) != 0)
										{
											city.ShieldsCount += (short)(this.oGameData.Static.Units[city.CurrentProductionID].Price * local_4a);
										}
										else
										{
											...
											local_ba = (short)this.oParent.Segment_1866.F0_1866_0cf5(
												...
												0x1a,
												this.oGameData.Players[this.Var_6548_PlayerID].Units[local_108].Position.X,
												this.oGameData.Players[this.Var_6548_PlayerID].Units[local_108].Position.Y);

											if (local_ba != -1)
											{
												this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].GoToDestination.X = this.oGameData.Cities[local_b0].Position.X;
												this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].GoToDestination.Y = this.oGameData.Cities[local_b0].Position.Y;
											}
										}
									}

									if (city.CurrentProductionID == 25 && this.oGameData.Players[this.Var_6548_PlayerID].ActiveUnits[25] == 1)
									{
										this.oGameData.Players[this.oGameData.HumanPlayerID].ContactPlayerCountdown = -1;
									}
								...
								else
								{
									...
									if (local_ba != -1 && (city.CurrentProductionID == 0 || city.CurrentProductionID >= 26))
									{
										...
										this.oParent.MSCAPI.strcat(0xba06,
											this.oGameData.Static.Units[city.CurrentProductionID].Name);
					...
					{
						if ((this.oGameData.Static.ImprovementDefinitions(-city.CurrentProductionID).Price * local_4a) <= city.ShieldsCount)
						{
							local_e8 = -city.CurrentProductionID;

							if (local_e8 > 24)
							{
								if (this.oGameData.WonderCityID[local_e8 - 24] == -1)
								{
									this.oGameData.WonderCityID[local_e8 - 24] = (short)cityID;
							...
							if (local_e8 != -1)
							{
								...
								city.ShieldsCount -= (short)(this.oGameData.Static.ImprovementDefinitions(-city.CurrentProductionID).Price * local_4a);

								if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID || local_e8 > 24)
								{
									if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID)
									{
										for (int i = 0; i < this.oGameData.Players.Length; i++)
										{
											...
											if (player.ID >= 0 && player.NationalityID >= 0)
											{
												this.oGameData.Map[city.Position.X, city.Position.Y].SetVisiblity(i, true);
											}
										}
									}
									else
									...
									this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Static.ImprovementDefinitions(local_e8).Name);
									...
									{
										this.oParent.CityView.F19_0000_0000_DrawCityLayout(cityID, (short)local_e8);
									}
									else
									{
										this.oParent.Overlay_21.F21_0000_0000((short)cityID);
								...
								if (local_e8 >= 22 && local_e8 <= 24 && ((1 << this.Var_6548_PlayerID) & (ushort)this.oGameData.SpaceshipFlags) == 0)
								{
									if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
									{
									...
									else
									{
										...
										{
											city.ShieldsCount += (short)(this.oGameData.Static.ImprovementDefinitions(local_e8).Price * local_4a);
										...
										if ((this.oGameData.SpaceshipFlags & (1 << this.Var_6548_PlayerID)) == 0 && this.oGameData.AISpaceshipSuccessRate >= 40)
										{
											if (local_c8 == 0)
												goto L1feb;

											// Instruction address 0x1d12:0x1f5d, size: 5
											if (this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oGameData.HumanPlayerID, (int)TechnologyEnum.SpaceFlight) == 0)
												goto L2010;

											if (this.oGameData.AISpaceshipSuccessRate > 75)
												goto L1feb;

											if (this.oGameData.Players[this.oGameData.HumanPlayerID].Ranking > this.oGameData.Players[this.Var_6548_PlayerID].Ranking)
												goto L1feb;

											if ((this.oGameData.SpaceshipFlags & (1 << this.oGameData.HumanPlayerID)) == 0)
												goto L1fc5;

											if ((this.oGameData.Players[this.Var_6548_PlayerID].SpaceshipETAYear - this.oGameData.Year) <=
												(this.oGameData.Players[this.oGameData.HumanPlayerID].SpaceshipETAYear - this.oGameData.Year))
												goto L1feb;
							...
							L2010:
								if (local_e8 == 1)
								{
									for (int i = 0; i < 128; i++)
									{
										if (this.oGameData.Cities[i].PlayerID == this.Var_6548_PlayerID)
										{
											this.oGameData.Cities[i].RemoveImprovement(ImprovementEnum.Palace);
										}
									}

									if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID ||
										(this.oGameData.Players[this.oGameData.HumanPlayerID].Diplomacy[this.Var_6548_PlayerID] & 0x40) != 0)
									{
										this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);
										...
										this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Players[this.Var_6548_PlayerID].Nationality);
										...
										this.oGameData.Players[this.Var_6548_PlayerID].XStart = (short)city.Position.X;
								...
								if (local_e8 == 43 && this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
								{
									for (int i = 0; i < 128; i++)
									{
										if (this.oGameData.Cities[i].StatusFlag != 0xff && this.oGameData.Cities[i].PlayerID != this.Var_6548_PlayerID)
										{
											this.oGameData.Cities[i].VisibleSize = this.oGameData.Cities[i].ActualSize;

											this.oGameData.Map[this.oGameData.Cities[i].Position.X,
												this.oGameData.Cities[i].Position.Y].SetVisiblity(this.Var_6548_PlayerID, true);

											// Instruction address 0x1d12:0x2204, size: 5
											this.oGameData.Map[this.oGameData.Cities[i].Position].UpdateVisibleImprovements(this.Var_6548_PlayerID);
										}
									}
								}
							}
					...
					if ((this.Var_6548_PlayerID == this.oGameData.HumanPlayerID && (city.StatusFlag & 0x10) != 0) &&
				...
				L2307:
					if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID)
					{
						...
						local_104 = this.oGameData.Players[this.Var_6548_PlayerID].Continents[this.oGameData.Map[local_d8, local_e4].Layer3_GroupID].Strategy;
						
						if ((local_104 == 1 || local_104 == 2 || local_104 == 5) && local_e8 != 0 && city.CurrentProductionID >= 0 &&
							this.oGameData.Static.Units[city.CurrentProductionID].UnitCategory == local_104)
						{
							local_cc = this.oGameData.Players[this.Var_6548_PlayerID].Coins / 64;
						}

						if ((this.oGameData.SpaceshipFlags & (1 << (this.oGameData.HumanPlayerID + 8))) != 0 &&
							(-city.CurrentProductionID) >= 0x16 && (-city.CurrentProductionID) <= 0x18)
						{
							local_cc = this.oGameData.Players[this.Var_6548_PlayerID].Coins / 128;
						}
						...
						if ((city.StatusFlag & 0x1) != 0 && city.CurrentProductionID < 0 && city.ShieldsCount != 0)
						{
							...
							local_cc = this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
								(this.oGameData.Static.ImprovementDefinitions(-city.CurrentProductionID).Price * local_4a) - city.ShieldsCount,
								0, this.oGameData.Players[this.Var_6548_PlayerID].Coins / 8);
						}

						// Instruction address 0x1d12:0x24bb, size: 5
						this.oParent.MapManagement.F0_2aea_14e0_GetCellUnitPlayerID(local_d8, local_e4);
						if (((short)this.oCPU.AX.UInt16 == -1 || (city.StatusFlag & 0x10) != 0) && city.CurrentProductionID >= 0 && city.ShieldsCount != 0)
						{
							// Instruction address 0x1d12:0x2530, size: 5
							local_cc = this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
								(this.oGameData.Static.Units[city.CurrentProductionID].Price * local_4a) - city.ShieldsCount,
						...
						if (city.CurrentProductionID >= 0 && city.StatusFlag == 0x19 && this.oGameData.Players[this.Var_6548_PlayerID].ActiveUnits[25] == 0 && city.ShieldsCount != 0)
						{
							...
							local_cc = this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
								(this.oGameData.Static.Units[city.CurrentProductionID].Price * local_4a) - city.ShieldsCount,
								0, this.oGameData.Players[this.Var_6548_PlayerID].Coins / 4);
						}

						if (this.oGameData.Players[this.Var_6548_PlayerID].Coins > 2000)
						{
							local_cc += this.oGameData.Players[this.Var_6548_PlayerID].Coins / 512;
						}

						city.ShieldsCount += (short)local_cc;
						this.oGameData.Players[this.Var_6548_PlayerID].Coins -= (short)(local_cc * 2);
						city.StatusFlag &= 0xef;
					}
				}
				...
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType == 3)
				{
					this.Var_6b30 = 10;
				}
				...
				if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
				{
					...
					local_e8 = ((this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType / 2) + 2) * (local_e8 / 2);
					local_a8 = (((cityID % local_e8) + this.oGameData.Players[this.Var_6548_PlayerID].CityCount - local_e8) / local_e8) +
						city.ActualSize + this.oGameData.DifficultyLevel - 6;
				...
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType < 4)
				{
					local_2 = 0;
					local_e6 = 0;
					...
					while (local_ba != -1)
					{
						...
						if (this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].TypeID].AttackStrength != 0)
						{
							local_e6++;
						...
						local_ba = this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].NextUnitID;
					...
					for (int i = 0; i < 2; i++)
					{
						if (this.oParent.Var_70e4 != 0 && city.Unknown[i] != -1 && this.oGameData.Static.Units[city.Unknown[i] & 0x3f].AttackStrength != 0)
						{
							local_e6++;
						}
					}
				...
				if (F0_1d12_6c97_PlayerHasWonder(this.Var_6548_PlayerID, (int)WonderEnum.JSBachsCathedral) != 0)
				{
					...
					if (this.oGameData.Map[local_d8, local_e4].Layer3_GroupID ==
						this.oGameData.Map[this.oGameData.Cities[this.oGameData.WonderCityID[(int)WonderEnum.JSBachsCathedral]].Position].Layer3_GroupID)
					{
						this.oParent.Var_70e4 -= 2;
					}
				}
				...
				if (flag == 1 && this.Var_2496 == 1 && (this.oParent.Var_70e2 - this.oParent.Var_70e4) != local_e8)
				{
					...
					this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("WONDERS", 190, local_42 + 5, 15);
				...
				if ((this.oGameData.DebugFlags & 0x2) == 0)
				{
					this.oParent.Var_70e4 = 0;
					this.oParent.Var_70e2 = 0;
				}
			...
			L32e0:
				...
				for (int i = 0; i < 128; i++)
				{
						...
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].HomeCityID == cityID)
					{
						if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID < 26)
						{
							...
							if (city.ActualSize >= this.oParent.Var_deb8)
							{
								if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType > 1 && (this.oGameData.DebugFlags & 0x2) != 0)
								{
									this.oParent.Var_d2f6++;
								}
							}
						...
						if (flag == 0)
						{
								...
								this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType >= 4))
							{
								...
								for (int j = 0; j < 128; j++)
								{
									if (this.oGameData.Players[this.Var_6548_PlayerID].Units[j].TypeID != -1 &&
										this.oGameData.Players[this.Var_6548_PlayerID].Units[j].HomeCityID == cityID &&
										this.oGameData.Players[this.Var_6548_PlayerID].Units[j].TypeID < 26)
									{
										...
										local_b2 = this.oGameData.Map.GetDistance(
											...
											this.oGameData.Players[this.Var_6548_PlayerID].Units[j].Position.Y);
								...
								if (this.oParent.Array_70da[1] >= this.oParent.Var_d2f6)
								{
									if (this.oParent.Var_8078 != 0 &&
										...
										this.oGameData.Players[this.oGameData.HumanPlayerID].DiscoveredTechnologyCount)
									{
										this.oParent.Var_db42 = -999; // 0xfc19
									}
									else if (local_c8 > 0 &&
										this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_108].TypeID].MovementType == UnitMovementTypeEnum.Land &&
										this.oGameData.Players[this.Var_6548_PlayerID].Units[local_108].TypeID != 0)
									{
								...
								else
								{
									if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
									{
										...
										this.oParent.MSCAPI.strcat(0xba06,
											this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_108].TypeID].Name);
						...
						if (flag == 1)
						{
							if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID < 26)
							{
								...
								else
								{
									...
									if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType >= 4)
									{
										if (this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].AttackStrength != 0 &&
											local_e8 != 0 &&
											(this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].MovementType == UnitMovementTypeEnum.Water ||
												this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.X != city.Position.X ||
												this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.Y != city.Position.Y))
										{
							...
							F0_1d12_73ea_DrawCityRectangle(
								this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.X,
								this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.Y,
								7);
					...
					if (flag == 1 && local_4e < 18 && this.Var_2496 == 0 &&
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID != -1 &&
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.X == local_d8 &&
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.Y == local_e4)
					{
						...
						this.oParent.Segment_2459.F0_2459_08c6_GetCityName(this.oGameData.Players[this.Var_6548_PlayerID].Units[i].HomeCityID);
						...
						this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(0xba06, local_fa, local_100 + 15, 0);
				...
				if (flag == 0)
				{
					...
					if (city.HasImprovement(ImprovementEnum.MarketPlace))
					{
						this.oParent.Var_db42 -= (5 - this.oGameData.Static.Nations[this.oGameData.Players[this.Var_6548_PlayerID].NationalityID].Ideology) * this.Var_6546;
					}
					else
					{
						this.oParent.Var_db42 -= (7 - this.oGameData.Static.Nations[this.oGameData.Players[this.Var_6548_PlayerID].NationalityID].Ideology) * this.Var_6546;
					}
				}
				...
				if (flag == 1)
				{
					...
					if (local_da == 0)
					{
						for (int i = 0; i < 21; i++)
						{
							if (this.oGameData.WonderCityID[i + 1] == cityID)
							{
								local_e8 = i + 24;

								// Instruction address 0x1d12:0x3b09, size: 5
								this.oParent.MSCAPI.strcpy(0xba06, this.oGameData.Static.Wonders[i + 1].Name);
								...
								this.oCPU.WriteString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06),
									this.oParent.LanguageTools.F0_2f4d_04f7_TrimStringToWidth(this.oCPU.ReadString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06)), 63));
					...
					for (int i = local_da; i < 24; i++)
					{
						if (city.HasImprovement(City.BitToImprovementEnum(i)))
						{
							...
							else
							{
								...
								this.oCPU.WriteString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06),
									this.oParent.LanguageTools.F0_2f4d_04f7_TrimStringToWidth(this.oCPU.ReadString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06)), 56));
					...
					if (city.CurrentProductionID >= 0)
					{
						local_de = this.oGameData.Static.Units[city.CurrentProductionID].Price;
					}
					else
					{
						local_de = this.oGameData.Static.ImprovementDefinitions(-city.CurrentProductionID).Price;
					}
					...
					this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 230, 99, local_f6 + 3, local_fc + 19, 1);
					...
					else
					{
						...
						this.oCPU.WriteString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06),
							this.oParent.LanguageTools.F0_2f4d_04f7_TrimStringToWidth(this.oCPU.ReadString(VCPU.ToLinearAddress(this.oCPU.DS.UInt16, 0xba06)), 86));
					...
					this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("Food Storage", 8, 108, 15);
					...
					this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA("City Resources", 8, local_fc, 15);
					...
					for (int i = 0; i < 3; i++)
					{
						...
						if (local_4c != -1)
						{
							...
							if (this.oGameData.Cities[local_4c].PlayerID != this.Var_6548_PlayerID)
							{
								...
								this.oParent.MSCAPI.strcat(0xba06,
									this.oParent.MSCAPI.itoa((city.BaseTrade + this.oGameData.Cities[local_4c].BaseTrade + 4) / 8, 10));
							}
							else
							{
								// Instruction address 0x1d12:0x4700, size: 5
								this.oParent.MSCAPI.strcat(0xba06,
									this.oParent.MSCAPI.itoa((city.BaseTrade + this.oGameData.Cities[local_4c].BaseTrade + 4) / 16, 10));
							}
							...
							if (this.Var_2496 == 2)
							{
								...
								F0_1d12_73ea_DrawCityRectangle((ushort)((short)this.oGameData.Cities[local_4c].Position.X),
									(ushort)((short)this.oGameData.Cities[local_4c].Position.Y), 10);
							}

							if (this.Var_2496 == 0)
							{
								// Instruction address 0x1d12:0x4765, size: 5
								this.oParent.DrawStringTools.F0_1182_005c_DrawStringToRectAA(0xba06, 98, (i * 6) + 179, 10);
							}
						}
					}
					...
					if (this.Var_2496 == 2)
					{
						...
						F0_1d12_73ea_DrawCityRectangle((ushort)((short)this.oGameData.Cities[this.Var_653e_CityID].Position.X),
							(ushort)((short)this.oGameData.Cities[this.Var_653e_CityID].Position.Y), 15);
					}
					...
					if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
					{
						...
						if (city.CurrentProductionID < -21 && city.CurrentProductionID >= -24 && (this.oGameData.SpaceshipFlags & (1 << this.Var_6548_PlayerID)) != 0)
						{
							local_c0 = 1;
						}
						...
						{
							if (this.oGameData.WonderCityID[Math.Abs(city.CurrentProductionID) - 24] != -1)
							{
								local_c0 = 1;
							}
						}

						if (city.CurrentProductionID >= 0 && this.oGameData.Players[this.Var_6548_PlayerID].UnitCount >= 127)
						{
							local_c0 = 1;
						}
							...
							local_f0 == 65)
						{
							...
							if ((city.StatusFlag & 0x10) != 0)
							{
								...
								if (local_102 != 99)
								{
									...
									this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 230, 99, 90, 100, 0);
								}
								else
								{
									goto L045f;
					...
					L4bf7:
						if (city.CurrentProductionID >= 0)
						{
							local_106 = this.oGameData.Static.Units[city.CurrentProductionID].Price;
						...
						{
							local_106 = this.oGameData.Static.ImprovementDefinitions(-city.CurrentProductionID).Price;
						...
						if (city.CurrentProductionID >= 0)
						{
							...
							this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Static.Units[city.CurrentProductionID].Name);
						}
						else
						{
							// Instruction address 0x1d12:0x4d3e, size: 5
							this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Static.ImprovementDefinitions(-city.CurrentProductionID).Name);
						}
						...
						this.oParent.MSCAPI.strcat(0xba06,
							this.oParent.MSCAPI.itoa(this.oGameData.Players[this.Var_6548_PlayerID].Coins, 10));
						...
						else if (this.oGameData.Players[this.Var_6548_PlayerID].Coins >= local_e8)
						{
						...
						if (this.oParent.MenuBoxDialog.F0_2d05_0031_ShowMenuBox(0xba06, 100, 80, 1) == 0 && this.oGameData.Players[this.Var_6548_PlayerID].Coins >= local_e8)
						{
					...
					L4faf:
						...
						this.oParent.CityView.F19_0000_0000_DrawCityLayout(cityID, -1);
					...
					L4fff:
						for (local_106 = 0; local_106 < local_4e && (this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].Status & 0xcf) == 0; local_106++)
						{
						}
					...
					L504b:
						...
						if (local_fc == '\n' || local_fc == ' ')
						{
							if ((this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].Status & 0x9) != 0)
							{
								this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].RemainingMoves =
									(short)(this.oGameData.Static.Units[this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].TypeID].MoveCount * 3);
							}
					...
					L53ad:
						...
						this.oParent.MenuBoxDialog.F0_2d05_0031_ShowMenuBox(0xba06, 32, 32, 1);
					...
					L55b6:
						if (!this.oGameData.Map[city.Position.X + local_b6, city.Position.Y + local_be].IsVisibleTo(this.oGameData.HumanPlayerID)) goto L55f5;
					...
					L57a5:
						...
						this.oParent.MSCAPI.strcat(0xba06, this.oGameData.Static.ImprovementDefinitions(local_bc + 1).Name);

						// Instruction address 0x1d12:0x57d4, size: 5
						this.oParent.MSCAPI.strcat(0xba06, " for ");

						// Instruction address 0x1d12:0x5802, size: 5
						this.oParent.MSCAPI.strcat(0xba06, this.oParent.MSCAPI.itoa(10 * this.oGameData.Static.ImprovementDefinitions(local_bc + 1).Price, 10));
					...
					L5aa6:
						...
						if (this.oGameData.Map[city.Position.X + this.oGameData.Static.CityOffsets[local_ea].X, 
							city.Position.Y + this.oGameData.Static.CityOffsets[local_ea].Y].IsVisibleTo(this.Var_6548_PlayerID)) goto L5b13;
					...
					L5b13:
						...
						if (Arr_a6[this.oGameData.Static.CityOffsets[local_ea].X + 2, this.oGameData.Static.CityOffsets[local_ea].Y + 2] != 0)
							goto L12c2;
					...
					L5c45:
						...
						this.oParent.MapManagement.F0_2aea_03ba(
							city.Position.X + this.oGameData.Static.CityOffsets[local_ea].X,
							city.Position.Y + this.oGameData.Static.CityOffsets[local_ea].Y);
				...
				if ((this.oGameData.GameSettingFlags & 0x8) != 0) goto L5d4d;
				goto L5d9f;
			...
			L5dd7:
				...
				if ((this.oGameData.GameSettingFlags & 0x1) != 0) goto L5de7;
				goto L5df3;
			...
			L5e05:
				...
				if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID) goto L5e24;
				goto L5ea1;
			...
			L5eb4:
				...
				this.oGameData.Players[this.Var_6548_PlayerID].Diplomacy[0] |= 4;
			...
			L5f5b:
				...
				if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID) goto L5f7a;
				goto L5fc2;
			...
			L604f:
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType != 0) goto L605f;
				goto L606c;

			L605f:
				this.oGameData.Players[this.Var_6548_PlayerID].Coins += (short)this.oParent.Var_e17a;
			...
			L6088:
				...
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType != 0) goto L60b4;
				goto L6213;
			...
			L60c6:
				if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID) goto L60d8;
				goto L619c;

			L60d8:
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType != 0) goto L60e8;
				goto L619c;
			...
			L60e8:
				...
				this.oCPU.BX.UInt16 = (ushort)this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType;
				...
				if ((this.oGameData.GameSettingFlags & 0x8) != 0)
				{
					this.oParent.CityView.F19_0000_0000_DrawCityLayout(cityID, -2);

					this.oParent.CityView.F19_0000_1ae1_LoveDayAnimation();
			...
			L61ac:
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType >= 4) goto L61bc;
				goto L6210;
			...
			L622f:
				if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID) goto L6241;
				goto L62cb;

			L6241:
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType != 0) goto L6251;
				goto L62cb;
			...
			L62d8:
				...
				if (this.oGameData.Players[this.oGameData.HumanPlayerID].CurrentResearchID != -1) goto L62f5;
				goto L630d;
			...
			L62f5:
				...
				if (this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.Var_6548_PlayerID,
					this.oGameData.Players[this.oGameData.HumanPlayerID].CurrentResearchID) == 0)
					goto L630d;

				goto L6327;

			L630d:
				if (this.oGameData.Players[this.oGameData.HumanPlayerID].CurrentResearchID == -1) goto L6317;
				goto L635d;

			L6317:
				if (this.oGameData.Players[this.Var_6548_PlayerID].ResearchProgress != 0) goto L6327;
				goto L635d;

			L6327:
				this.oGameData.Players[this.oGameData.HumanPlayerID].CurrentResearchID = -1;

				if ((this.oGameData.DebugFlags & 0x8) != 0) goto L6337;
				goto L6351;
			...
			L635d:
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType == 0)
				{
					local_e8 = 0;
				}

				this.oGameData.Players[this.Var_6548_PlayerID].ResearchProgress += (short)local_e8;

				if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID && this.oGameData.DifficultyLevel == 0)
				{
					if (this.oGameData.Players[this.oGameData.HumanPlayerID].CurrentResearchID >= 0 &&
						(this.oGameData.TechnologyFirstDiscoveredBy[this.oGameData.Players[this.oGameData.HumanPlayerID].CurrentResearchID] & 7) != 0)
					{
						this.oGameData.Players[this.Var_6548_PlayerID].ResearchProgress += (short)local_e8;
					}
				}
			...
			L63d2:
				this.oGameData.Players[this.Var_6548_PlayerID].ResearchProgress += (short)(local_e8 / 2);

			L63e5:
				if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID)
				{
					local_f4 = 14 - this.oGameData.DifficultyLevel;
				}
				else
				{
					local_f4 = (this.oGameData.DifficultyLevel * 2) + 6;
				}
				...
				if ((11 - this.oGameData.Players[this.Var_6548_PlayerID].DiscoveredTechnologyCount) <= local_f4)
					goto L6441;

				local_f4 = 11 - this.oGameData.Players[this.Var_6548_PlayerID].DiscoveredTechnologyCount;
			...
			L6457:
				if ((this.oGameData.Players[this.Var_6548_PlayerID].ResearchProgress / ((this.oGameData.Year < 0) ? 1 : 2)) >
					(this.oGameData.Players[this.Var_6548_PlayerID].DiscoveredTechnologyCount * local_f4)) goto L6488;
				goto L64b8;

			L6488:
				this.oGameData.Players[this.Var_6548_PlayerID].ResearchProgress = 0;

				if ((this.oGameData.DebugFlags & 0x8) != 0) goto L649e;
				goto L64b8;
			...
			L64b8:
				...
				if ((local_e0 * 2) >
					this.oParent.MSCAPI.RNG.Next(-(((this.oGameData.Players[this.Var_6548_PlayerID].DiscoveredTechnologyCount * this.oGameData.DifficultyLevel) / 2) - 256))) goto L6545;
				goto L6640;

			L6545:
				// Instruction address 0x1d12:0x6549, size: 5
				local_e8 = this.oParent.MSCAPI.RNG.Next(20);
				local_c6 = this.oGameData.Static.CityOffsets[local_e8].X + local_d8;
				local_d2 = this.oGameData.Static.CityOffsets[local_e8].Y + local_e4;

				// Instruction address 0x1d12:0x6581, size: 5
				if (!this.oGameData.Map[local_c6, local_d2].Improvements.ContainsAnyFlag(TerrainImprovementEnum.Pollution)) goto L6590;
				goto L6640;

			L6590:
				// Instruction address 0x1d12:0x6598, size: 5
				if (this.oGameData.Map[local_c6, local_d2].TerrainType != TerrainTypeEnum.Water) goto L65a8;
				goto L6640;

			L65a8:
				// Instruction address 0x1d12:0x65b0, size: 5
				if (!this.oGameData.Map[local_c6, local_d2].Improvements.ContainsAnyFlag(TerrainImprovementEnum.City)) goto L65bf;
				goto L6640;

			L65bf:
				// Instruction address 0x1d12:0x65c7, size: 5
				F0_1d12_6d33_AddPollutionToCell(this.oGameData.HumanPlayerID, local_c6, local_d2);

				// Instruction address 0x1d12:0x65e3, size: 5
				this.oParent.MapManagement.F0_2aea_0008(this.oGameData.HumanPlayerID, local_c6 - 8, local_d2 - 6);
			...
			L6691:
				...
				this.oParent.MapManagement.F0_2aea_0008(this.oGameData.HumanPlayerID, local_d8 - 8, local_e4 - 6);

				this.oParent.Overlay_22.F22_0000_0967(local_d8, local_e4);

				// Instruction address 0x1d12:0x66c5, size: 5
				this.oParent.Segment_29f3.F0_29f3_0ec3(this.oGameData.HumanPlayerID, local_d8, local_e4);
			...
			L676e:
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType != 0) goto L677e;
				goto L6736;

			L677e:
				this.oGameData.Players[this.Var_6548_PlayerID].Coins -= (short)this.oGameData.Static.ImprovementDefinitions(local_bc + 1).MaintenanceCost;

				if (local_bc != 1)
					goto L680b;

				if (this.oGameData.DifficultyLevel < 2)
					goto L67b3;

				this.oGameData.Players[this.Var_6548_PlayerID].Coins--;

			L67b3:
				if (this.oGameData.DifficultyLevel < 4)
					goto L67c7;
			...
			L680b:
				if (this.oGameData.Players[this.Var_6548_PlayerID].Coins < 0) goto L681b;
				goto L6736;

			L681b:
				this.oGameData.Players[this.Var_6548_PlayerID].Coins = 0;
			...
			L6904:
				...
				this.oParent.Segment_1866.F0_1866_00c6((short)cityID);
		...
		private int F0_1d12_000a_FindCityOffset(GPoint point)
		{
			...
			for (int i = 0; i < 21; i++)
			{
				if (this.oGameData.Static.CityOffsets[i].Equals(point))
				{
					return i;
				}
			}
		...
		private void F0_1d12_692d_CityResources(int cityID, int cityOffset, short flag)
		{
			...
			// function body
			int local_4;
			int local_6 = this.oGameData.Cities[cityID].Position.X + this.oGameData.Static.CityOffsets[cityOffset].X;
			int local_8;
			int local_a = this.oGameData.Cities[cityID].Position.Y + this.oGameData.Static.CityOffsets[cityOffset].Y;
			int local_c;
			int local_e = 0;
			int local_10 = 0;
			...
			else
			{
				...
				//this.oParent.Segment_1000.F0_1000_104f_SetPixel(2, local_6 + 80, local_a, (ushort)this.oGameData.Cities[cityID].PlayerID);
				this.oGameData.Map[local_6, local_a].Layer2_PlayerOwnership = this.oGameData.Cities[cityID].PlayerID;
			}
		...
		public int F0_1d12_6abc_GetCityResourceCount(int playerID, int cityID, int xPos, int yPos, int resourceType)
		{
			...
			if (this.oGameData.Map.IsValidPosition(xPos, yPos))
			{
				...
				{
					case 0:
						resourceCount = cell.Food;
						break;

					case 1:
						resourceCount = cell.Production;
						break;

					case 2:
						resourceCount = cell.Trade;
						break;
				...
				EnumFlagCollection<TerrainImprovementEnum> local_4 = new(this.oGameData.Map[xPos, yPos].Improvements);

				if ((this.oGameData.DebugFlags & 0x2) == 0)
				{
					local_4 = new((cell.TerrainType == TerrainTypeEnum.Desert || cell.TerrainType == TerrainTypeEnum.Plains || cell.TerrainType == TerrainTypeEnum.Grassland) ? 
						TerrainImprovementEnum.Irrigation : TerrainImprovementEnum.Mine);
					if (cell.TerrainType != TerrainTypeEnum.Plains)
						local_4 += TerrainImprovementEnum.Roads;
				}

				if (cell.TerrainType != TerrainTypeEnum.Water)
				{
					if (resourceType == 0 && local_4.ContainsAnyFlag(TerrainImprovementEnum.Irrigation))
					{
						resourceCount += -1 - cell.Multi1;
					}

					if (resourceType == 1 && local_4.ContainsAnyFlag(TerrainImprovementEnum.Mine))
					{
						resourceCount += -1 - cell.Multi3;
					}

					if (resourceType == 2 && local_4.ContainsAnyFlag(TerrainImprovementEnum.Roads) && 
						(cell.TerrainType == TerrainTypeEnum.Desert || cell.TerrainType == TerrainTypeEnum.Plains || cell.TerrainType == TerrainTypeEnum.Grassland))
					{
						resourceCount++;
					}
				}

				if (resourceType == 1 && (cell.TerrainType == TerrainTypeEnum.Grassland || cell.TerrainType == TerrainTypeEnum.River))
				{
				...
				if (local_4.ContainsAnyFlag(TerrainImprovementEnum.Railroads))
				{
					resourceCount += resourceCount / 2;
				}

				if (resourceCount > 2 && (this.oGameData.Cities[cityID].StatusFlag & 0x40) == 0)
				{
				...
				if (resourceCount != 0 && resourceType == 2)
				{
					...
					if ((this.oGameData.Cities[cityID].StatusFlag & 0x40) != 0)
					{
						if (this.oGameData.Players[playerID].GovernmentType >= 2)
						{
							resourceCount++;
						}
					}
					...
					{
						if (this.oGameData.Players[playerID].GovernmentType >= 4)
						{
							resourceCount++;
						}
					}
				...
				if (local_4.ContainsAnyFlag(TerrainImprovementEnum.Pollution))
				{
			...
			this.oCPU.AX.UInt16 = (ushort)((short)resourceCount);
		...
		/// <returns></returns>
		public ushort F0_1d12_6c97_PlayerHasWonder(int playerID, int wonderID)
		{
			...
			for (i = 1; i < 8; i++)
			{
				...
				ImprovementDefinition wonder = this.oGameData.Static.Wonders[wonderID];
			...
			if (i < 8 || this.oGameData.WonderCityID[wonderID] == -1 ||
				this.oGameData.Cities[this.oGameData.WonderCityID[wonderID]].PlayerID != playerID)
			{
				this.oCPU.AX.UInt16 = 0;
			}
			else
		...
		private short F0_1d12_6cf3_GetWonderCityID(short wonderID)
		{
			...
			for (i = 1; i < 8; i++)
			{
				...
				if (this.oGameData.Static.Wonders[wonderID].ObsoletesAfterTechnology != TechnologyEnum.None &&
					this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology((short)i, (int)this.oGameData.Static.Wonders[wonderID].ObsoletesAfterTechnology) != 0)
				{
					break;
				}
			}
			...
			{
				this.oCPU.AX.UInt16 = (ushort)this.oGameData.WonderCityID[wonderID];
			}
		...
		/// <param name="xPos"></param>
		/// <param name="yPos"></param>
		public void F0_1d12_6d33_AddPollutionToCell(int playerID, int xPos, int yPos)
		{
			this.oCPU.Log.EnterBlock($"F0_1d12_6d33({xPos}, {yPos})");

			// function body
			// Instruction address 0x1d12:0x6d3c, size: 5
			if (!this.oGameData.Map[xPos, yPos].Improvements.ContainsAnyFlag(TerrainImprovementEnum.Pollution))
			{
				// Instruction address 0x1d12:0x6d52, size: 5
				this.oGameData.Map[xPos, yPos].Improvements += TerrainImprovementEnum.Pollution;

				// Instruction address 0x1d12:0x6d60, size: 5
				this.oGameData.Map[xPos, yPos].UpdateVisibleImprovements(playerID);

				this.oGameData.PollutedSquareCount++;
			}
		...
		public void F0_1d12_6d6e_SetSpecialWorkerFlags(int position, int flag)
		{
			...
			if (position < 8)
			{
				this.oGameData.Cities[this.Var_653e_CityID].SpecialWorkerFlags &= (ushort)(~(0x3 << (position * 2)));

				this.oGameData.Cities[this.Var_653e_CityID].SpecialWorkerFlags |= (ushort)((flag & 0x3) << (position * 2));
			}
		...
		public ushort F0_1d12_6da1_GetSpecialWorkerFlags(int position)
		{
			...
			if (position < 8)
			{
				this.oCPU.AX.UInt16 = (ushort)((this.oGameData.Cities[this.Var_653e_CityID].SpecialWorkerFlags >> (position * 2)) & 0x3);
			}
			else
			{
				this.oCPU.AX.UInt16 = 0x1;
		...
		private void F0_1d12_6dfe(int cityID, int size)
		{
			...
			this.oParent.Var_70e2 = this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oParent.Var_70e2, 0, this.oGameData.Cities[cityID].ActualSize);
			// Instruction address 0x1d12:0x6e98, size: 5
			this.oParent.Var_70e4 = this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oParent.Var_70e4, 0, this.oGameData.Cities[cityID].ActualSize);

			// Instruction address 0x1d12:0x6ebb, size: 5
			while ((this.oParent.Var_70e2 + this.oParent.Var_70e4) > this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oGameData.Cities[cityID].ActualSize - size, 0, 99))
			{
				if (this.Var_6542 > 0)
				{
					this.Var_6542--;
		...
		public int F0_1d12_6ed4_DrawResources(int cityID, int xPos, int yPos, int param4, int width)
		{
			...
			// function body
			int citySize = this.oGameData.Cities[cityID].ActualSize;
			int i;
			int xSpacing;
			...
			for (i = 0; i < param4; i++)
			{
				...
				this.oParent.Graphics.F0_VGA_0d47_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
					xPos, yPos,
					this.oParent.Array_6e96[this.oCPU.AX.UInt16 + 5]);
		...
		public void F0_1d12_71bf_DrawFilledRectangleWithCenteredText(int xPos, int yPos, int xPos1, int yPos1, ushort stringPtr, ushort mode)
		{
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToRectAA(stringPtr,
		...
		private void F0_1d12_72b7_DrawCityWorldMap()
		{
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 101, 117, 120, 75, 0);
			...
			for (int yPos = 0; yPos < 50; yPos++)
			{
				for (int xPos = 0; xPos < 80; xPos++)
				{
					...
					int mapXPos = this.oGameData.Map.WrapXPosition(this.oGameData.Players[this.oGameData.HumanPlayerID].XStart + xPos - 40);
					int mapYPos = yPos;

					if (this.oGameData.Map[mapXPos, mapYPos].IsVisibleTo(this.oGameData.HumanPlayerID))
					{
						...
						if (this.oGameData.Map[mapXPos, mapYPos].TerrainType != TerrainTypeEnum.Water)
						{
							// Instruction address 0x1d12:0x72f7, size: 5
							this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, rectXPos, rectYPos, 2, 2, 2);
						}
						else
						{
							// Instruction address 0x1d12:0x72f7, size: 5
							this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, rectXPos, rectYPos, 2, 2, 1);
						}
					}
				}
			}
		...
		private void F0_1d12_73ea_DrawCityRectangle(int xPos, int yPos, ushort mode)
		{
			...
			if (this.Var_2496 == 2)
			{
				...
				xPos = this.oGameData.Map.WrapXPosition(
					xPos - this.oGameData.Players[this.oGameData.HumanPlayerID].XStart + 40);
