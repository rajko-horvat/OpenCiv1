	...
	public class CityWorker
	{
		...
		public ushort F0_1d12_0045_ProcessCityState(short cityID, short flag)
		{
			...
			L045f:
				...
				if (flag == 1)
				{
					...
					this.oParent.Segment_1182.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 104, 2, 15);
				...
				if (((ushort)this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) != 0 ||
			...
			L12c2:
				...
				if (F0_1d12_6c97_PlayerHasWonder(this.Var_6548_PlayerID, (int)WonderEnum.HooverDam) != 0)
				{
					...
					if (this.oParent.MapManagement.F0_2aea_1942_GetGroupID(city.Position.X, city.Position.Y) ==
						...
						this.oGameData.Cities[this.oGameData.WonderCityID[(int)WonderEnum.HooverDam]].Position.X,
						this.oGameData.Cities[this.oGameData.WonderCityID[(int)WonderEnum.HooverDam]].Position.Y))
					{
						this.oParent.Var_6c98 = 2;
						local_ac = 2;
					}
												...
												if (local_c8 > this.oParent.Var_6c9a || (local_c8 == this.oParent.Var_6c9a && this.oParent.MSCAPI.RNG.Next(++local_106) == 0))
												{
													...
													if (this.oGameData.Map[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_e8].Position].TerrainType != TerrainTypeEnum.Water)
													{
														...
														if (this.oParent.MapManagement.F0_2aea_1942_GetGroupID(
															...
															this.oGameData.Cities[i].Position.Y) ==
															this.oParent.MapManagement.F0_2aea_1942_GetGroupID(
															this.oGameData.Players[this.Var_6548_PlayerID].Units[local_e8].Position.X,
															this.oGameData.Players[this.Var_6548_PlayerID].Units[local_e8].Position.Y))
														{
					...
					else
					{
						if ((this.oGameData.Static.ImprovementDefinitions(-city.CurrentProductionID).Price * local_4a) <= city.ShieldsCount)
						{
							...
							if (local_e8 > 24)
							{
								...
								{
									this.oGameData.WonderCityID[local_e8 - 24] = cityID;
							...
							if (local_e8 != -1)
							{
								...
								if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) != 0 || local_e8 > 24)
								{
									if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) == 0)
									{
									...
									for (int i = 0; i < 128; i++)
									{
										if (this.oGameData.Cities[i].StatusFlag != 0xff && this.oGameData.Cities[i].PlayerID != this.Var_6548_PlayerID)
										{
											...
											this.oParent.MapManagement.F0_2aea_1601_UpdateVisiblemprovements(
												this.oGameData.Cities[i].Position.X, this.oGameData.Cities[i].Position.Y);
										}
									}
								}
							}
				...
				L2307:
					if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) == 0)
					{
						...
						local_104 = this.oGameData.Players[this.oParent.MapManagement.F0_2aea_1942_GetGroupID(local_d8, local_e4) & 0x7].Continents[this.Var_6548_PlayerID].Strategy;
				...
				if (F0_1d12_6c97_PlayerHasWonder(this.Var_6548_PlayerID, (int)WonderEnum.JSBachsCathedral) != 0)
				{
					...
					if (this.oParent.MapManagement.F0_2aea_1942_GetGroupID(local_d8, local_e4) == 
						this.oParent.MapManagement.F0_2aea_1942_GetGroupID(
							this.oGameData.Cities[this.oGameData.WonderCityID[(int)WonderEnum.JSBachsCathedral]].Position.X,
							this.oGameData.Cities[this.oGameData.WonderCityID[(int)WonderEnum.JSBachsCathedral]].Position.Y))
					{
						this.oParent.Var_70e4 -= 2;
					}
				}
				...
				if (flag == 1 && this.Var_2496 == 1 && (this.oParent.Var_70e2 - this.oParent.Var_70e4) != local_e8)
				{
					...
					this.oParent.Segment_1182.F0_1182_005c_DrawStringToRectAA("WONDERS", 190, local_42 + 5, 15);
			...
			L32e0:
				...
				for (int i = 0; i < 128; i++)
				{
						...
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].Position.Y == local_e4)
					{
						...
						this.oParent.Segment_1182.F0_1182_005c_DrawStringToRectAA(0xba06, local_fa, local_100 + 15, 0);
				...
				if (flag == 1)
				{
					...
					if (local_da == 0)
					{
						for (int i = 0; i < 21; i++)
						{
							if (this.oGameData.WonderCityID[i + 1] == cityID)
							{
								...
								this.oParent.Segment_1182.F0_1182_005c_DrawStringToRectAA(0xba06, 253, local_e4 + 2, 15);
					...
					else
					{
						...
						this.oParent.Segment_1182.F0_1182_00b3_DrawCenteredStringToRectAA(0xba06, 274, 100, 15);
					}
					...
					this.oParent.Segment_1182.F0_1182_005c_DrawStringToRectAA("Food Storage", 8, 108, 15);
					...
					this.oParent.Segment_1182.F0_1182_005c_DrawStringToRectAA("City Resources", 8, local_fc, 15);
					...
					for (int i = 0; i < 3; i++)
					{
						...
						if (local_4c != -1)
						{
							...
							if (this.Var_2496 == 0)
							{
								...
								this.oParent.Segment_1182.F0_1182_005c_DrawStringToRectAA(0xba06, 98, (i * 6) + 179, 10);
							}
						}
					}
			...
			L5e05:
				...
				if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) == 0) goto L5e24;
				goto L5ea1;
			...
			L5f5b:
				...
				if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) != 0) goto L5f7a;
				goto L5fc2;
			...
			L60c6:
				if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) != 0) goto L60d8;
				goto L619c;
			...
			L60e8:
				...
				this.oCPU.BX.Word = (ushort)this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType;
			...
			L622f:
				if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) != 0) goto L6241;
				goto L62cb;
			...
			L6545:
				...
				if ((this.oParent.MapManagement.F0_2aea_1585_GetImprovements(local_c6, local_d2) & 0x40) == 0) goto L6590;
				goto L6640;
			...
			L65a8:
				...
				if ((this.oParent.MapManagement.F0_2aea_1585_GetImprovements(local_c6, local_d2) & 0x1) == 0) goto L65bf;
				goto L6640;
		...
		public int F0_1d12_6abc_GetCityResourceCount(int playerID, int cityID, int xPos, int yPos, int resourceType)
		{
			...
			if (this.oGameData.Map.IsValidPosition(xPos, yPos))
			{
				...
				local_4 = (short)this.oParent.MapManagement.F0_2aea_1585_GetImprovements(xPos, yPos);

				if ((this.oGameData.DebugFlags & 0x2) == 0)
				{
					local_4 = (cell.TerrainType == TerrainTypeEnum.Desert || cell.TerrainType == TerrainTypeEnum.Plains || cell.TerrainType == TerrainTypeEnum.Grassland) ? 2 : 4;
					local_4 |= (cell.TerrainType != TerrainTypeEnum.Plains) ? 8 : 0;
				}
				...
				if (cell.TerrainType != TerrainTypeEnum.Water)
				{
					...
					if (resourceType == 2 && (local_4 & 0x8) != 0 && (cell.TerrainType == TerrainTypeEnum.Desert || cell.TerrainType == TerrainTypeEnum.Plains || cell.TerrainType == TerrainTypeEnum.Grassland))
					{
						resourceCount++;
					}
				}
		...
		private short F0_1d12_6cf3_GetWonderCityID(short wonderID)
		{
			...
			{
				this.oCPU.AX.Word = (ushort)this.oGameData.WonderCityID[wonderID];
			}
		...
		public void F0_1d12_6d33(int xPos, int yPos)
		{
			...
			if ((this.oParent.MapManagement.F0_2aea_1585_GetImprovements(xPos, yPos) & 0x40) == 0)
			{
				// Instruction address 0x1d12:0x6d52, size: 5
				this.oParent.MapManagement.F0_2aea_1653_ClearOrSetImprovements(xPos, yPos, 0, 4);
		...
		public ushort F0_1d12_6da1_GetSpecialWorkerFlags(int position)
		{
			...
			if (position < 8)
			{
				this.oCPU.AX.Word = (ushort)((this.oGameData.Cities[this.Var_653e_CityID].SpecialWorkerFlags >> (position * 2)) & 0x3);
			}
			else
			{
				this.oCPU.AX.Word = 0x1;
		...
		public void F0_1d12_71bf_DrawFilledRectangleWithCenteredText(int xPos, int yPos, int xPos1, int yPos1, ushort stringPtr, ushort mode)
		{
			...
			this.oParent.Segment_1182.F0_1182_00b3_DrawCenteredStringToRectAA(stringPtr,
