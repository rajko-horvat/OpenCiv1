...
namespace OpenCiv1
{
	public class GameStaticData
	{
		...
		public readonly NationDefinition[] Nations = new NationDefinition[] {
			new NationDefinition(0, "Attila", "", "Barbarian", 0, 0, 0, 36, 36, new GPoint(0, 0),
				new string[] {"Mecca", "Naples", "Sidon", "Tyre", "Tarsus", "Issus", "Cunaxa", "Cremona", "Cannae", "Capua",
					"Turin", "Genoa", "Utica", "Crete", "Damascus", "Verona" }),
			new NationDefinition(1, "Caesar", "", "Roman", 0, 1, 1, 24, 10, new GPoint(36, 19),
			...
			new NationDefinition(2, "Hammurabi", "", "Babylonian", -1, -1, 1, 28, 14, new GPoint(45, 22),
			...
			new NationDefinition(4, "Ramesses", "", "Egyptian", 0, 0, 1, 21, 7, new GPoint(41, 24),
			...
			new NationDefinition(5, "Abe Lincoln", "", "American", -1, 0, 1, 19, 5, new GPoint(12, 18),
			...
			new NationDefinition(6, "Alexander", "", "Greek", 0, 1, -1, 26, 12, new GPoint(39, 18),
			...
			new NationDefinition(7, "M.Gandhi", "", "Indian", -1, -1, 0, 31, 17, new GPoint(57, 24),
			...
			new NationDefinition(9, "Stalin", "", "Russian", 1, 0, -1, 25, 11, new GPoint(44, 12),
			...
			new NationDefinition(10, "Shaka", "", "Zulu", 1, 0, 0, 22, 8, new GPoint(42, 42),
			...
			new NationDefinition(12, "Montezuma", "", "Aztec", 0, -1, 1, 20, 6, new GPoint(5, 23),
			...
			new NationDefinition(15, "Genghis Khan", "", "Mongol", 1, 1, -1, 30, 16, new GPoint(49, 19),
