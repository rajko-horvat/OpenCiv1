...
namespace OpenCiv1
{
	public class GameStaticData
	{
		...
		public readonly NationDefinition[] Nations = new NationDefinition[] {
			new NationDefinition(0, "Attila", "Barbarians", "Barbarian", 0, 0, 0, 36, 36, new GPoint(0, 0),
				new string[] {"Mecca", "Naples", "Sidon", "Tyre", "Tarsus", "Issus", "Cunaxa", "Cremona", "Cannae", "Capua",
					"Turin", "Genoa", "Utica", "Crete", "Damascus", "Verona" }),
			new NationDefinition(1, "Caesar", "Romans", "Roman", 0, 1, 1, 24, 10, new GPoint(36, 19),
			...
			new NationDefinition(2, "Hammurabi", "Babylonians", "Babylonian", -1, -1, 1, 28, 14, new GPoint(45, 22),
				new string[] {"Babylon", "Sumer", "Uruk", "Nineveh", "Ashur", "Ellipi", "Akkad", "Eridu", "Kish", "Nippur",
					"Shuruppak", "Zariqum", "Izibia", "Nimrud", "Arbela", "Zamua" }),
			new NationDefinition(3, "Frederick", "Germans", "German", 1, -1, 1, 32, 18, new GPoint(38, 15),
			...
			new NationDefinition(4, "Ramesses", "Egyptians", "Egyptian", 0, 0, 1, 21, 7, new GPoint(41, 24),
			...
			new NationDefinition(5, "Abe Lincoln", "Americans", "American", -1, 0, 1, 19, 5, new GPoint(12, 18),
			...
			new NationDefinition(6, "Alexander", "Greeks", "Greek", 0, 1, -1, 26, 12, new GPoint(39, 18),
			...
			new NationDefinition(7, "M.Gandhi", "Indians", "Indian", -1, -1, 0, 31, 17, new GPoint(57, 24),
			...
			new NationDefinition(8, "", "", "", 0, 0, 0, 36, 36, new GPoint(0, 0),
			...
			new NationDefinition(9, "Stalin", "Russians", "Russian", 1, 0, -1, 25, 11, new GPoint(44, 12),
			...
			new NationDefinition(10, "Shaka", "Zulus", "Zulu", 1, 0, 0, 22, 8, new GPoint(42, 42),
			...
			new NationDefinition(11, "Napoleon", "French", "French", 1, 1, 1, 23, 9, new GPoint(33, 16),
			...
			new NationDefinition(12, "Montezuma", "Aztecs", "Aztec", 0, -1, 1, 20, 6, new GPoint(5, 23),
			...
			new NationDefinition(13, "Mao Tse Tung", "Chinese", "Chinese", 0, 0, 1, 29, 15, new GPoint(66, 19),
			...
			new NationDefinition(14, "Elizabeth I", "English", "English", 0, 1, 0, 27, 13, new GPoint(31, 14),
			...
			new NationDefinition(15, "Genghis Khan", "Mongols", "Mongol", 1, 1, -1, 30, 16, new GPoint(49, 19),
		...
		// Units
		public readonly UnitDefinition[] Units = new UnitDefinition[] {
