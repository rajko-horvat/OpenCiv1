	...
	public class Help
	{
		...
		L010a:
			...
			this.oParent.Graphics.F0_VGA_038c_GetPixel(2,
				this.oParent.GameState.Players[playerID].Units[unitID].Position.X + 80,
		...
		L017e:
			...
			this.oParent.Segment_2aea.F0_2aea_0008(this.oParent.GameState.HumanPlayerID,
				this.oParent.GameState.Players[playerID].Units[unitID].Position.X - 7, this.oParent.GameState.Players[playerID].Units[unitID].Position.Y - 6);
		...
		L01c3:
			...
			this.oParent.Segment_2dc4.F0_2dc4_0102(this.oParent.GameState.Players[playerID].Units[unitID].Position.X, this.oParent.GameState.Players[playerID].Units[unitID].Position.Y);
		...
		L0211:
			...
			this.oParent.Segment_2aea.F0_2aea_1585(this.oParent.GameState.Players[playerID].Units[unitID].Position.X, this.oParent.GameState.Players[playerID].Units[unitID].Position.Y);
		...
		L025f:
			...
			this.oParent.Segment_1403.F0_1403_3fd0(this.oParent.GameState.Players[playerID].Units[unitID].Position.X, this.oParent.GameState.Players[playerID].Units[unitID].Position.Y);
