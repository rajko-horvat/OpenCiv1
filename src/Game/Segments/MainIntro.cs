...
namespace OpenCiv1
{
	public class MainIntro
	{
		...
		L17fc:
			...
			GPoint direction = this.oParent.MoveDirections[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))];
		...
		L1891:
			...
			direction = this.oParent.MoveDirections[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))];
		...
		public void F2_0000_195a(int xPos1, int yPos1, int xPos2, int yPos2)
		{
			...
			this.oParent.Graphics.F0_VGA_0599_DrawLine(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0xaa), xPos1, yPos1, xPos2, yPos2 + 6, 15);
