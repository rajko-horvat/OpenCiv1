...
namespace OpenCiv1
{
	public class Segment_29f3
	{
		...
		L0195:
			...
			if (this.oParent.GameState.UnitDefinitions[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe))].TerrainCategory == 1)
				goto L01f2;
		...
		L05de:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				this.oCPU.ReadUInt16(this.oCPU.DS.Word,
					(ushort)(((this.oParent.GameState.Players[playerID1].Units[unitID1].TypeID +
		...
		L0dae:
			...
			this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, (ushort)((short)xPos));
