...
namespace OpenCiv1
{
	public class GameInitAndIntro
	{
		...
		public GameInitAndIntro(Game parent)
		{
			this.oParent = parent;
		...
		L054f:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa), 
				this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)), (ushort)((short)direction.X)));

			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc), 
				this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc)), (ushort)((short)direction.Y)));
			goto L0493;
		...
		L0784:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6), 
				this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)), (ushort)((short)direction.X)));

			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa), 
				this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)), (ushort)((short)direction.Y)));
		...
		L0b45:
			...
			{
				case 0:
					this.oParent.GameState.Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xd0))].Size +=
						this.oParent.GameState.Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x22))].Size;

					this.oParent.GameState.Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x22))].Size = 0;
					break;

				case 1:
					this.oParent.GameState.Oceans[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xd0))].Size +=
						this.oParent.GameState.Oceans[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x22))].Size;

					this.oParent.GameState.Oceans[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x22))].Size = 0;
					break;
		...
		L0b87:
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xac), 
				this.oCPU.INCWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xac))));
		...
		L0bac:
			...
			{
				case 0:
					if (this.oParent.GameState.Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xae))].Size != 0)
						goto L0bac;

					break;

				case 1:
					if (this.oParent.GameState.Oceans[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xae))].Size != 0)
						goto L0bac;
		...
		L0ce6:
			...
			{
				case 0:
					if (this.oParent.GameState.Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + this.oCPU.DI.Word - 0xce))].Size >=
						this.oParent.GameState.Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24))].Size)
						goto L0ce2;

					break;

				case 1:
					if (this.oParent.GameState.Oceans[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + this.oCPU.DI.Word - 0xce))].Size >=
						this.oParent.GameState.Oceans[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24))].Size)
						goto L0ce2;
					break;
		...
		L0d28:
			...
			this.oCPU.AX.Word = this.oParent.GameState.MapVisibility[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)),
		...
		L0d87:
			...
			{
				case 0:
					this.oCPU.WriteInt16(this.oCPU.DS.Word, this.oCPU.SI.Word, this.oParent.GameState.Continents[this.oCPU.ReadInt16(this.oCPU.DS.Word, this.oCPU.SI.Word)].Size);
					break;

				case 1:
					this.oCPU.WriteInt16(this.oCPU.DS.Word, this.oCPU.SI.Word, this.oParent.GameState.Oceans[this.oCPU.ReadInt16(this.oCPU.DS.Word, this.oCPU.SI.Word)].Size);
					break;
		...
		L0db1:
			...
			{
				case 0:
					this.oParent.GameState.Continents[0].Size = 0;
					this.oParent.GameState.Continents[15].Size = 1;
					break;

				case 1:
					this.oParent.GameState.Oceans[0].Size = 0;
					this.oParent.GameState.Oceans[15].Size = 1;
					break;
		...
		L0f32:
			...
			this.oCPU.SI.Word = (ushort)this.oParent.GameState.TerrainMultipliers[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Multi1;
		...
		L0f9c:
			...
			this.oCPU.SI.Word = (ushort)this.oParent.GameState.TerrainMultipliers[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Multi3;
			this.oCPU.SI.Word = this.oCPU.ORWord(this.oCPU.SI.Word, this.oCPU.SI.Word);
		...
		public void F7_0000_1188()
		{
			...
			for (int i = 0; i < 260; i++)
			{
				this.oParent.GameState.LandPathfinding[i] = 0;
			}
		...
		L13b1:
			this.oCPU.CMPWord(this.oCPU.AX.Word, 20);
		...
		L13b9:
			...
			this.oParent.GameState.LandPathfinding[(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14)) * 13) + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1a))] |= 
				this.oCPU.AX.Low;
		...
		L140a:
			...
			this.oParent.GameState.LandPathfinding[(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)) * 13) + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))] |=
				this.oCPU.AX.Low;
		...
		L15ce:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 
				this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)), (ushort)((short)direction.X)));

			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4), 
				this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)), (ushort)((short)direction.Y)));
