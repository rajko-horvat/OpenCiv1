...
namespace OpenCiv1
{
	public class Overlay_14
	{
		...
		L03f1:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(this.oParent.GameState.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].AttackStrength, 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(this.oParent.GameState.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].DefenseStrength, 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(this.oParent.GameState.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].MoveCount, 10));
		...
		L0680:
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0(
				this.oParent.GameState.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))].Name,
				36,
		...
		L0980:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.Word, this.oCPU.SI.Word,
				this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.DS.Word, this.oCPU.SI.Word),
					(ushort)((short)this.oParent.GameState.BuildingDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x3c)) + 1].Maintenance)));
		...
		L0bd9:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(
					...
					this.oParent.GameState.BuildingDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x3c)) + 1].Maintenance, 10));
		...
		L0bf6:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oParent.GameState.BuildingDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x3c)) + 1].Name);
		...
		L0d9f:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Name);
		...
		L0f1d:
			...
			this.oParent.MSCAPI.strcpy(0xba06, this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1c))].Nation);
		...
		L0ff7:
			...
			this.oParent.MSCAPI.strcpy(0xba06, this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Nation);
		...
		public void F14_0000_1164(short playerID)
		{
			...
			if (this.oParent.GameState.Nations[this.oParent.GameState.Players[playerID].NationalityID].Mood == 1)
			{
			...
			if (this.oParent.GameState.Nations[this.oParent.GameState.Players[playerID].NationalityID].Policy == 1)
			{
			...
			if (this.oParent.GameState.Nations[this.oParent.GameState.Players[playerID].NationalityID].Ideology == 1)
			{
		...
		L14d5:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))].Nation);
		...
		L1892:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 
				this.oParent.GameState.BuildingDefinitions[-this.oParent.GameState.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].CurrentProductionID].Name);
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(
					10 * this.oParent.GameState.BuildingDefinitions[-this.oParent.GameState.Cities[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].CurrentProductionID].Price,
				10));
		...
		L1adf:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 
				this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].CurrentProductionID].Name);
