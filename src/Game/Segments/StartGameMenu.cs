...
namespace OpenCiv1
{
	public class StartGameMenu
	{
		...
		public StartGameMenu(Game parent)
		{
			this.oParent = parent;
		...
		L00a8:
			...
			if (this.oCPU.Flags.NE)
			{
				...
				this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
					80, (35 * this.oParent.GameState.DifficultyLevel) + 6, 53, 47, this.oParent.Var_aa_Rectangle, 20, 100);
			}
			else
			{
				// Instruction address 0x0000:0x00fb, size: 5
				this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
					21, (35 * this.oParent.GameState.DifficultyLevel) + 6, 53, 47, this.oParent.Var_aa_Rectangle, 20, 100);
			}
		...
		L01e1:
			...
			if (this.oCPU.Flags.NE)
			{
				...
				this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
					80, (35 * this.oParent.GameState.DifficultyLevel) + 6, 53, 47,
			...
			else
			{
				// Instruction address 0x0000:0x01d6, size: 5
				this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
					21, (35 * this.oParent.GameState.DifficultyLevel) + 6, 53, 47,
					this.oParent.Var_aa_Rectangle,
					(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) << 1) + 20,
					(3 * this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))) + 100);
		...
		L02a2:
			this.oParent.GameState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))].NationalityID = -1;
		...
		L032f:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.GameState.Nations[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))].Nationality);
		...
		L0421:
			...
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID & 7].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) + 2] = -1;
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID & 7].PalaceData2[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))] = 0;
		...
		L0440:
			...
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID & 7].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) + 2] = 0;
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID & 7].PalaceData1[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) + 8] = 0;
		...
		L048b:
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].Nationality = "";
			...
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].NationalityID = this.oParent.GameState.HumanPlayerID;

			// Instruction address 0x0000:0x0569, size: 5
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].Name =
				this.oParent.GameState.Nations[this.oParent.GameState.HumanPlayerID].Leader;
		...
		L04c2:
			...
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].NationalityID = (short)this.oCPU.AX.Word;

			// Instruction address 0x0000:0x04ec, size: 5
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].Name =
				this.oParent.GameState.Nations[this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].NationalityID].Leader;
			...
			this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].Nationality = 
				this.oParent.GameState.Nations[this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].NationalityID].Nationality;

			// Instruction address 0x0000:0x0526, size: 5
			this.oParent.MSCAPI.strcpy(0xba06,
				this.oParent.GameState.Nations[this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].NationalityID].Nation);
			...
			this.oParent.MSCAPI.strcpy(0xba06, this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].Nationality);
		...
		L0569:
			...
			this.oParent.Segment_1182.F0_1182_00b3_DrawCenteredStringToScreen0(
				this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].Nation,
				46, 92, 15);
		...
		L0609:
			if (this.oParent.GameState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))].NationalityID >= 8)
			{
				this.oCPU.AX.Word = 0x1;
		...
		L0708:
			...
			if (this.oCPU.Flags.NE)
			{
				...
				this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
					80, (35 * this.oParent.GameState.DifficultyLevel) + 6, 53, 47, this.oParent.Var_aa_Rectangle, 134, 20);
			}
			else
			{
				// Instruction address 0x0000:0x0799, size: 5
				this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
					21, (35 * this.oParent.GameState.DifficultyLevel) + 6, 53, 47, this.oParent.Var_aa_Rectangle, 134, 20);
			}
		...
		public ushort F5_0000_07c7(short playerID)
		{
			...
			L08a3:
				...
				this.oParent.GameState.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))].TypeID = -1;
				this.oParent.GameState.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))].Status = 0;
			...
			L09ec:
				...
				this.oParent.GameState.Players[playerID].NationalityID = (short)this.oParent.MSCAPI.RNG.Next(16);
				this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe), 0x1);

				if ((this.oParent.GameState.Players[playerID].NationalityID & 7) != playerID)
				{
					this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe), 0x0);
				}
			...
			L0a1e:
				if (this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc)) != playerID &&
					this.oParent.GameState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))].NationalityID ==
					this.oParent.GameState.Players[playerID].NationalityID)
				{
					this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe), 0x0);
				}
			...
			L0a4f:
				this.oParent.GameState.Players[playerID].NationalityID ^= 8;
			...
			L0ad8:
				...
				this.oParent.Segment_2dc4.F0_2dc4_0289_GetShortestDistance(
					this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8)),
					this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)),
					this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Units[0].Position.X,
					this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Units[0].Position.Y);
			...
			L0c1b:
				...
				this.oCPU.SI.Word = (ushort)this.oParent.GameState.Players[playerID].NationalityID;
				this.oCPU.SI.Word = this.oCPU.SHLWord(this.oCPU.SI.Word, 0x1);
			...
			L0c49:
				...
				this.oCPU.CMPWord((ushort)this.oParent.GameState.Players[playerID].NationalityID, 0x8);
			...
			L0c8e:
				...
				this.oCPU.AX.Word = (ushort)this.oParent.GameState.Nations[this.oParent.GameState.Players[playerID].NationalityID].Ideology;
			...
			L0d12:
				...
				this.oParent.GameState.Players[playerID].Name =
					this.oParent.GameState.Nations[this.oParent.GameState.Players[playerID].NationalityID].Leader;

				this.oCPU.AX.Word = (ushort)this.oParent.GameState.HumanPlayerID;
				this.oCPU.CMPWord((ushort)playerID, this.oCPU.AX.Word);
				if (this.oCPU.Flags.NE) goto L0d3f;

				if (!string.IsNullOrEmpty(this.oParent.GameState.Players[playerID].Nationality))
					goto L0dae;
			...
			L0d3f:
				...
				this.oParent.GameState.Players[playerID].Nationality = 
			...
			L0d99:
				...
				this.oParent.GameState.Players[playerID].Nation = this.oCPU.ReadString(this.oCPU.DS.Word, 0xba06);
			...
			L0de4:
				...
				if (this.oParent.GameState.Players[0].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))].TypeID == -1)
					goto L0e20;
				...
				this.oParent.Segment_2dc4.F0_2dc4_0289_GetShortestDistance(
					this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8)),
					this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)),
					this.oParent.GameState.Players[0].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))].Position.X,
					this.oParent.GameState.Players[0].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))].Position.Y);
		...
		L0f60:
			...
			if (this.oParent.GameState.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8))].TypeID == -1)
				goto L0f85;
		...
		L1010:
			...
			if (this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].TypeID != -1)
			{
				...
				this.oParent.Segment_2aea.F0_2aea_1942(
					this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Position.X,
					this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Position.Y);
		...
		L1241:
			...
			if (this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x48))].Units[0].TypeID == -1)
				goto L12c7;
			...
			this.oParent.Segment_2aea.F0_2aea_1942(
				this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x48))].Units[0].Position.X,
				this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x48))].Units[0].Position.Y);
		...
		L135b:
			...
			this.oParent.MSCAPI.strcat(0xba06, 
				this.oParent.GameState.TechnologyDefinitions[(short)this.oCPU.AX.Word].Name);
		...
		L13ca:
			...
			this.oParent.Segment_1866.F0_1866_0cf5(
				...
				0,
				this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Units[0].Position.X,
				this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Units[0].Position.Y);
		...
		L1b40:
			...
			this.oCPU.AX.Word = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(oParent.GameState.HumanPlayerID, (int)TechnologyEnum.Invention);
			this.oCPU.AX.Word = this.oCPU.ORWord(this.oCPU.AX.Word, this.oCPU.AX.Word);
			if (this.oCPU.Flags.NE)
			{
		...
		public void F5_0000_1d1a_InitSpaceshipData(short playerID)
		{
			...
			for (int i = 0; i < 15; i++)
			{
				for (int j = 0; j < 12; j++)
				{
					this.oParent.GameState.Players[playerID].SpaceshipData[(12 * i) + j] = -1;
				}
			}
