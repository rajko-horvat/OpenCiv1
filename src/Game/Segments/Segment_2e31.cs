...
namespace OpenCiv1
{
	public class Segment_2e31
	{
		...
		L032d:
			...
			direction = this.oParent.MoveOffsets[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x18))];
		...
		L0699:
			...
			// !!! Illegal memory access, this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x6590) = 0xff
