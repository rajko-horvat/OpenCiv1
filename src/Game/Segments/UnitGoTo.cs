...
namespace OpenCiv1
{
	public class UnitGoTo
	{
		...
		public ushort F0_2e31_000e_GetNextMove(short playerID, short unitID)
		{
			...
			Game.LogUnit(this.oParent, this.oParent.GoToLog, playerID, unitID, this.oParent.GameState.HumanPlayerID);
			...
			GPoint move = this.oParent.GameState.Players[playerID].Units[unitID].GoToPosition - this.oParent.GameState.Players[playerID].Units[unitID].Position;
			GPoint absMove = GPoint.Abs(move);

			if (playerID == this.oParent.GameState.HumanPlayerID && absMove.X < 2 && absMove.Y < 2)
			{
				move.X = (absMove.X >= 40) ? -Math.Sign(move.X) : Math.Sign(move.X);
				move.Y = Math.Sign(move.Y);

				this.oParent.GameState.Players[playerID].Units[unitID].GoToPosition = new GPoint(-1);
			...
			else
			{
				...
				{
					this.Var_6590_XPos = (short)this.oParent.GameState.Players[playerID].Units[unitID].GoToPosition.X;
					this.Var_6592_YPos = (short)this.oParent.GameState.Players[playerID].Units[unitID].GoToPosition.Y;
			...
			L0208:
				move.X = this.Var_6590_XPos - this.oParent.GameState.Players[playerID].Units[unitID].Position.X;
				move.Y = this.Var_6592_YPos - this.oParent.GameState.Players[playerID].Units[unitID].Position.Y;
				...
				this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, (ushort)((short)absMove.X));
				this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, (ushort)((short)absMove.Y));
				...
				else
				{
					...
					this.oParent.Segment_2aea.F0_2aea_1585(
						this.oParent.GameState.Players[playerID].Units[unitID].Position.X, this.oParent.GameState.Players[playerID].Units[unitID].Position.Y);
				...
				L032d:
					...
					this.oCPU.WriteInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x10), (short)(this.oParent.GameState.Players[playerID].Units[unitID].Position.X + direction.X));
					this.oCPU.WriteInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12), (short)(this.oParent.GameState.Players[playerID].Units[unitID].Position.Y + direction.Y));
				...
				L03e0:
					...
					if (this.oParent.GameState.Players[playerID].Units[unitID].TypeID == -1 ||
						this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Players[playerID].Units[unitID].TypeID].TerrainCategory != 2)
					{
						this.oCPU.AX.Word = 0;
					}
					else
				...
				L0436:
					// !!! Illegal memory access
					if (this.oParent.GameState.Players[playerID].Units[unitID].TypeID != -1 &&
						this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Players[playerID].Units[unitID].TypeID].TerrainCategory == 1)
						goto L0480;
				...
				L04b4:
					// !!! Illegal memory access
					if (this.oParent.GameState.Players[playerID].Units[unitID].TypeID == -1 ||
						this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Players[playerID].Units[unitID].TypeID].MoveCount <= 1)
						goto L04e3;

					this.oCPU.AX.Low = 0x3;
					this.oCPU.IMULByte(this.oCPU.AX, 
						(byte)this.oParent.GameState.Terrains[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1a))].MovementCost);
				...
				L04f0:
					this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8),
						this.oCPU.ADDWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8)),
					...
					if (this.oParent.GameState.Players[playerID].Units[unitID].GoToNextDirection != -1)
					{
						this.oCPU.WriteInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6),
							(short)Math.Abs(this.oParent.GameState.Players[playerID].Units[unitID].GoToNextDirection - this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x18))));
				...
				L0571:
					...
					{
						this.oParent.GameState.Players[playerID].Units[unitID].GoToNextDirection = this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14));
		...
		public ushort F0_2e31_05e6(short playerID, short unitID)
		{
			...
			else
			{
				...
				F0_2e31_0a2c(
					...
					(ushort)((this.oParent.GameState.Players[playerID].Units[unitID].TypeID == -1 || this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Players[playerID].Units[unitID].TypeID].TerrainCategory != 2) ? 0 : 1));
				...
				else
				{
					...
					F0_2e31_0a2c(
						...
						(ushort)((this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Players[playerID].Units[unitID].TypeID].TerrainCategory != 0x2) ? 0 : 1));
				...
				L0981:
					...
					this.oParent.Segment_2aea.F0_2aea_134a(this.Var_6590_XPos, this.Var_6592_YPos);
		...
		L0b12:
			...
			// !!! Illegal memory access
			if (((this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) * 13) + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))) >= this.oParent.GameState.LandPathfinding.Length ||
				this.oParent.GameState.LandPathfinding[(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) * 13) + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))] == 0)
				goto L0ad5;
		...
		L0dea:
			...
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, (ushort)this.Var_6590_XPos);
			...
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, (ushort)this.Var_6592_YPos);
		...
		L0f61:
			...
			if (((this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Players[playerID].Units[unitID].TypeID].TerrainCategory != 2) ? 0 : 1) == ((this.oCPU.AX.Word != 0xa) ? 0 : 1))
				goto L0fec;
		...
		public ushort F0_2e31_111c(int xPos, int yPos, int xPos1, int yPos1, ushort flag, ushort param6)
		{
			...
			{
				// Temporary unit...
				this.oParent.GameState.Players[0].Units[127].TypeID = (short)((flag == 0) ? 1 : 0x10);
				this.oParent.GameState.Players[0].Units[127].Position.X = xPos;
				this.oParent.GameState.Players[0].Units[127].Position.Y = yPos;
				this.oParent.GameState.Players[0].Units[127].GoToPosition.X = xPos1;
				this.oParent.GameState.Players[0].Units[127].GoToPosition.Y = yPos1;
				...
				this.oParent.GameState.Players[0].Units[127].Position.X = -1;
				this.oParent.GameState.Players[0].Units[127].Position.Y = -1;
				this.oParent.GameState.Players[0].Units[127].GoToPosition.X = -1;
				this.oParent.GameState.Players[0].Units[127].GoToPosition.Y = -1;
