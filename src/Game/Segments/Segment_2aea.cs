...
namespace OpenCiv1
{
	public class Segment_2aea
	{
		...
		public Segment_2aea(Game parent)
		{
			this.oParent = parent;
		...
		L05ef:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
				(short)this.oCPU.AX.Word, (short)this.oCPU.PopWord(), this.oCPU.PopWord());
		...
		public ushort F0_2aea_0e29(short playerID, short unitID)
		{
			...
			if (this.oParent.GameState.Players[playerID].Units[unitID].TypeID != 0)
				goto L0e53;

			// Instruction address 0x2aea:0x0e77, size: 5
			this.oParent.Segment_1000.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle,
				(this.oParent.GameState.Players[playerID].Units[unitID].Position.X * 4) + 1,
				(this.oParent.GameState.Players[playerID].Units[unitID].Position.Y * 4) + 1,
				3, 3, 6);
			goto L0e55;
		...
		L0e55:
			...
			this.oParent.Segment_1000.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle,
				this.oParent.GameState.Players[playerID].Units[unitID].Position.X * 4,
				this.oParent.GameState.Players[playerID].Units[unitID].Position.Y * 4,
				3, 3,
				this.oCPU.ReadUInt16(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x1946)));
			goto L0fae;
		...
		L0f0e:
			...
			F0_2aea_134a(this.oParent.GameState.Players[playerID].Units[unitID].Position.X, this.oParent.GameState.Players[playerID].Units[unitID].Position.Y);
		...
		L1005:
			...
			if ((this.oParent.GameState.Players[playerID].Units[unitID].Status & 0x4) == 0)
				goto L1045;
		...
		L108d:
			...
			if ((this.oParent.GameState.Players[playerID].Units[unitID].Status & 0x40) == 0)
				goto L10d7;
		...
		L10d7:
			...
			if ((this.oParent.GameState.Players[playerID].Units[unitID].Status & 0x80) != 0)
			{
				...
				if ((this.oParent.GameState.Players[playerID].Units[unitID].Status & 0x2) != 0)
				{
		...
		public void F0_2aea_11d4(int xPos, int yPos)
		{
			...
			this.oCPU.AX.Word = this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.DS.Word, 0xd20a)].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].VisibleByPlayer;
		...
		L12ac:
			...
			this.oCPU.WriteInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 
				(short)this.oParent.GameState.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].NextUnitID);
			...
			if (this.oParent.GameState.UnitDefinitions[this.oParent.GameState.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].TypeID].TerrainCategory != 2)
				goto L12ed;
		...
		L1481:
			...
			if ((this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].TypeID == -1) ||
				(this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Position.X != xPos) ||
				(this.oParent.GameState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].Position.Y != yPos))
				goto L147e;
