...
namespace OpenCiv1
{
	public class Overlay_10
	{
		...
		public void F10_0000_0000()
		{
			...
			this.oParent.CAPI.strcpy(0xba06, "Which army?\n ");

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), 0x1);

		L001b:
			// Instruction address 0x0000:0x0028, size: 5
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Nationality);
		...
		L00b6:
			...
			this.oCPU.AX.UInt16 = this.oParent.Array_1946[this.oCPU.BX.UInt16];
		...
		L0164:
			...
			this.oCPU.AX.UInt16 = this.oParent.GameData.MapVisibility[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
			...
			if (!this.oParent.Var_d806_DebugFlag) goto L0161;
		...
		L01e3:
			...
			this.oParent.CAPI.strcpy(0xba06, "S");
		...
		L0224:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0x20);
		...
		L025a:
			// Instruction address 0x0000:0x01eb, size: 5
			this.oParent.CAPI.strcpy(0xba06, "D");
			goto L01f3;

		L025f:
			// Instruction address 0x0000:0x01eb, size: 5
			this.oParent.CAPI.strcpy(0xba06, "N");
			goto L01f3;
		...
		L02ac:
			...
			this.oCPU.AX.LowUInt8 = (byte)this.oParent.GameData.Players[playerID].StrategicLocations[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Active;
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.LowUInt8);
		...
		L02f1:
			...
			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Attack == 0)
				goto L0453;
			...
			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Strategy == 0)
			{
				// Instruction address 0x0000:0x0357, size: 5
				this.oParent.CAPI.strcat(0xba06, "S");
			}
		
			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Strategy == 2)
			{
				// Instruction address 0x0000:0x037a, size: 5
				this.oParent.CAPI.strcat(0xba06, "D");
			}
		
			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Strategy == 1)
			{
				// Instruction address 0x0000:0x039d, size: 5
				this.oParent.CAPI.strcat(0xba06, "A");
			}
		
			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Strategy == 5)
			{
				// Instruction address 0x0000:0x03c0, size: 5
				this.oParent.CAPI.strcat(0xba06, "T");
			}
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].Defense, 10));
		...
		public void F10_0000_0477(int playerID, int unitID)
		{
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)unitID, 10));
			...
			this.oParent.CAPI.strcat(0xba06, "Loc:");

			// Instruction address 0x0000:0x0543, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].Units[unitID].Position.X, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].Units[unitID].Position.Y, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].Units[unitID].GoToDestination.X, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].Units[unitID].GoToDestination.Y, 10));
		...
		L060e:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID].Units[unitID].NextUnitID);
			goto L0687;
		...
		L0634:
			...
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x200);
			...
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Units[this.oParent.GameData.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].TypeID].Name);

			// Instruction address 0x0000:0x067b, size: 5
			this.oParent.CAPI.strcat(0xba06, "\n*");

			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].NextUnitID);
