...
namespace OpenCiv1
{
	public class HallOfFame
	{
		...
		public ushort F3_0000_00d7(short param1)
		{
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0("CIVILIZATION", 160, 16, 0);

			// Instruction address 0x0000:0x0121, size: 5
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0("HALL OF FAME", 160, 24, 0);
		...
		L01d1:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 8, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)), 0);
		...
		L0426:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, (short)this.oCPU.SI.UInt16,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)),
				7);
		...
		L0788:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 6, 15);
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 14, 15);
		...
		L08cd:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 22, 15);
		...
		L08fc:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160,
		...
		L0ae4:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160,
				...
				this.oParent.Array_1946[this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12))].PlayerID]);
