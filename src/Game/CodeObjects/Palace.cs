...
namespace OpenCiv1
{
	public class Palace
	{
		...
		L0591:
			...
			if (this.oParent.Var_d762_AlwaysOneForVGA == 0) goto L05a9;
			goto L0426;
		...
		L0792:
			...
			if (this.oParent.Var_d762_AlwaysOneForVGA != 0) goto L07dc;
		...
		L0c94:
			...
			if (this.oParent.Var_d762_AlwaysOneForVGA == 0) goto L0cc1;
