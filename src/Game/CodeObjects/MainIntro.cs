...
namespace OpenCiv1
{
	public class MainIntro
	{
		...
		public void F2_0000_0000()
		{
			...
			this.oCPU.SP.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.SP.UInt16, 0x4e);
			this.oCPU.PUSH_UInt16(this.oCPU.SI.UInt16);

			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xdeba, 0x1);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), 0x1);

		L0012:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48));
			this.oCPU.AX.UInt16 = this.oCPU.INC_UInt16(this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xdeba, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), 
				this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48))));
			...
			this.oParent.Var_d762_AlwaysTrueForVGA = true;
			this.oParent.Var_aa_Rectangle.FontID = 1;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x6dfc, 0);
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), (short)((this.oParent.Var_d762_AlwaysTrueForVGA) ? 3 : 4));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), 0);

			goto L0196;

		L018d:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x6dfc, 0x1);
		...
		L0196:
			...
			this.oParent.Graphics.F0_VGA_04ae_AllocateScreen(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)));
			
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x32d6, this.oCPU.AX.UInt16);
		...
		L01be:
			...
			this.oParent.CommonTools.F0_1000_0a2b_InitSound();

			// Instruction address 0x0000:0x01c3, size: 5
			this.oParent.CommonTools.F0_1000_0000_InitializeTimer();
			...
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L020a;

			// Instruction address 0x0000:0x0202, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_19fc_Rectangle, 0, 0, 320, 200, 0);
		...
		L020a:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 12, 320, 176, 0);

			// Instruction address 0x0000:0x02f4, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(1, 14, 146, 152);

			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L031c;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), 0x1);

		L0308:
			// Instruction address 0x0000:0x030b, size: 5
			this.oParent.CommonTools.F0_1000_03fa_StartPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)));
			
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), 
				this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48))));

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x3);
		...
		L031c:
			...
			this.oParent.CAPI.fopen("credits.txt", "rt");

			this.oParent.Var_d768 = this.oCPU.AX.UInt16;
			...
			this.oParent.CommonTools.F0_1000_0a32_PlayTune(3, 0);
		...
		L0355:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 184, this.oCPU.AX.LowUInt8);

			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L0376;

			this.oCPU.AX.UInt16 = 0xf8;
			goto L0379;
		...
		L0379:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 182, this.oCPU.AX.LowUInt8);

			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L039a;

			this.oCPU.AX.UInt16 = 0xfa;
			goto L039d;
		...
		L039d:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 183, this.oCPU.AX.LowUInt8);

			this.oParent.Var_aa_Rectangle.ScreenID = this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x44));

		L03bb:
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L03d4;
		...
		L03d2:
			this.oParent.Var_aa_Rectangle.ScreenID = (short)this.oCPU.AX.UInt16;

		L03d4:
			this.oCPU.AX.UInt16 = 0x140;
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)));
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				0, 0, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 64,
				this.oParent.Var_aa_Rectangle, (short)this.oCPU.SI.UInt16, 12);
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				0, 88, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 88,
				this.oParent.Var_aa_Rectangle, (short)this.oCPU.SI.UInt16, 100);

			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L0476;
			
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x44), (short)this.oParent.Var_aa_Rectangle.ScreenID);

			this.oParent.Var_aa_Rectangle.ScreenID = 0;

			// Instruction address 0x0000:0x045c, size: 5
			this.oParent.Graphics.F0_VGA_0550_SetPixel(this.oParent.Var_aa_Rectangle.ScreenID, 0, 0, 0);
		...
		L0476:
			...
			this.oCPU.TEST_UInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x1);
		...
		L04a0:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), 0x3e7);

		L04cf:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48))));

		L04d2:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x140);
		...
		L04dc:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_19d4_Rectangle, 0, 176, (short)this.oCPU.SI.UInt16, 24, 0);

			// Instruction address 0x0000:0x051a, size: 5
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				0, 64, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 24, 
				this.oParent.Var_19d4_Rectangle, (short)this.oCPU.SI.UInt16, 176);

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0xa);
			if (this.oCPU.Flags.NE) goto L053c;

			this.oParent.Var_aa_Rectangle.FontID = 5;


			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L053c:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x32);
			if (this.oCPU.Flags.NE) goto L0547;
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

		L0547:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x46);
			if (this.oCPU.Flags.NE) goto L0558;

			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L0558:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x78);
			if (this.oCPU.Flags.NE) goto L0569;

			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L0569:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0xa0);
			if (this.oCPU.Flags.NE) goto L0575;
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

		L0575:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0xaa);
			if (this.oCPU.Flags.NE) goto L0587;

			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L0587:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0xbe);
		...
		L05ab:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0xe6);
			if (this.oCPU.Flags.NE) goto L05bd;
			
			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L05bd:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0xfa);
			if (this.oCPU.Flags.NE) goto L05cf;
			
			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L05cf:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x10e);
			if (this.oCPU.Flags.NE) goto L05e1;

			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L05e1:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x122);
			if (this.oCPU.Flags.NE) goto L05f3;
			
			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L05f3:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x136);
		...
		L0618:
			...
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L062f;
			goto L0352;

		L062f:
			this.oCPU.AX.UInt16 = 0xfc;
			goto L0355;
		...
		L0640:
			...
			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L0661;
		...
		L0664:
			...
			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L0685;
		...
		L06a6:
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L06bf;

			if (this.oParent.Var_aa_Rectangle.ScreenID == 0) goto L06ba;
		...
		L06bf:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0, 
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 64, 
		...
		L06ee:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19e8_Rectangle,
				0, 0, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 64,
				this.oParent.Var_aa_Rectangle, 320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 12);
		...
		L071a:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 88,
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 88,
		...
		L0770:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19e8_Rectangle,
				0, 88, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 88,
				this.oParent.Var_aa_Rectangle, 320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 100);

		L079c:
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L07d0;
		...
		L07d0:
			...
			this.oCPU.AX.UInt16 = 0x15;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)));
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, 0x1a40);
			this.oCPU.BX.UInt16 = this.oCPU.CX.UInt16;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.AX.UInt16 = this.oCPU.XOR_UInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, this.oCPU.DX.UInt16);
		...
		L0845:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 64,
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 24,
		...
		L0870:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19e8_Rectangle,
				...
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 176);
		...
		L08b0:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x1e);
		...
		L08cc:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x40);
			if (this.oCPU.Flags.NE) goto L08dd;
			
			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L08dd:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x54);
			if (this.oCPU.Flags.NE) goto L08ee;

			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L08ee:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x74);
			if (this.oCPU.Flags.NE) goto L08f9;
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

		L08f9:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x82);
			if (this.oCPU.Flags.NE) goto L090b;
			
			this.oParent.CAPI.fscanf((short)this.oParent.Var_d768, "%[^\n]\n", 0xba06);

		L090b:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x96);
		...
		L09ba:
			...
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L09d1;
			goto L063d;
		...
		L09d7:
			this.oParent.Var_6b32_SelectedGameType = -2;
			...
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x45);
			if (this.oCPU.Flags.E) goto L0a2d;
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x4c);
			if (this.oCPU.Flags.E) goto L0a25;
			goto L0a0f;

		L0a09:
			this.oParent.Var_6b32_SelectedGameType = 0;

		L0a0f:
			if (this.oParent.Var_6b32_SelectedGameType == -2) goto L0a19;
			goto L0b26;
		...
		L0a19:
			...
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0xd00); // !!! was 0xd87
		...
		L0a35:
			this.oParent.Var_6b32_SelectedGameType = 3;
			goto L0a0f;

		L0a3d:
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x63);
			if (this.oCPU.Flags.E) goto L0a35;
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x65);
			if (this.oCPU.Flags.E) goto L0a2d;
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x6c);
			if (this.oCPU.Flags.E) goto L0a25;
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x6e);
			if (this.oCPU.Flags.E) goto L0a09;
			goto L0a0f;
		...
		L0a53:
			...
			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L0ab4;

			// Instruction address 0x0000:0x0aa0, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(4, 14, 224, 239);
		...
		L0ab9:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 64, 4, 80,
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x4));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x140);
		...
		L0b0c:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x64);
		...
		L0b26:
			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L0b4a;
		...
		L0b37:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)), 0x4);
			if (this.oCPU.Flags.G) goto L0b52;

			// Instruction address 0x0000:0x0b40, size: 5
			this.oParent.CommonTools.F0_1000_042b_StopPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x48)));
		...
		L0b52:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_19d4_Rectangle, 0, 0, 320, 200, 0);
		...
		public void F2_0000_0bd7(short playerID)
		{
			...
			this.oCPU.PUSH_UInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.SP.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.SP.UInt16, 0x246);
			this.oCPU.PUSH_UInt16(this.oCPU.SI.UInt16);

			// Instruction address 0x0000:0x0bf9, size: 5
			this.oParent.ImageTools.F0_2fa1_01a2_LoadBitmapOrPalette(1, 0, 0, 0x32d8, 0);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e), 0x0);

		L0c0c:
			// Instruction address 0x0000:0x0c39, size: 5
			this.oParent.Graphics.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)) % 6) * 0x32) + 1),
				(ushort)(((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)) / 6) * 0x32) + 1),
				0x31, 0x31);

			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e));
			this.oCPU.SI.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.SI.UInt16, 0x1);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x238), this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e), this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e))));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 0x18);
			if (this.oCPU.Flags.L) goto L0c0c;

			// Instruction address 0x0000:0x0c5b, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_065f();

			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L0c6c;
			
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x246), 0xec);
			// Instruction address 0x0000:0x0c83, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 0, 320, 200, 236);

			goto L0c6e;

		L0c6c:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x246), 0);
			// Instruction address 0x0000:0x0c83, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 0, 320, 200, 0);
		...
		L0c6e:			
			...
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L0d17;
		...
		L0d17:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 0, 320, 200,
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x246)));

			// Instruction address 0x0000:0x0d4a, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 12, 320, 176,
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x246)));
			...
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30b8), 0xba06);

			this.oCPU.SI.UInt16 = (ushort)playerID;
			this.oCPU.SI.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.SI.UInt16, 0x1);

			// Instruction address 0x0000:0x0db1, size: 5
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30ba), this.oParent.GameData.Players[playerID].Nationality);

			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

			// Instruction address 0x0000:0x0dd7, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].SpaceshipPopulation, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].SpaceshipLaunchYear, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Year, 10));

			// Instruction address 0x0000:0x0e53, size: 5
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30c0), 0xba06);

			// Instruction address 0x0000:0x0e70, size: 5
			this.oParent.LanguageTools.F0_2f4d_01ad(0x3301, 
				(ushort)((playerID != this.oParent.GameData.HumanPlayerID) ? 0x32f9 : 0x32f2));

			// Instruction address 0x0000:0x0e78, size: 5
			this.oParent.LanguageTools.F0_2f4d_0471();

			// Instruction address 0x0000:0x0e86, size: 5
			this.oParent.CAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x200), 0xba06);

			this.oParent.Var_aa_Rectangle.FontID = 6;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x242), 0xfff6);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x244), 0x5c);
			this.oCPU.AX.UInt16 = 0xffff;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204), this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23c), this.oCPU.AX.UInt16);

			// Instruction address 0x0000:0x0eb2, size: 5
			this.oParent.CAPI.strlen(0xba06);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x240), this.oCPU.AX.UInt16);
		...
		L0edb:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0((ushort)(0xba06 + this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23c))),
				160, 184, this.oCPU.AX.LowUInt8);

			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L0f00;

			this.oCPU.AX.UInt16 = 0x3c;
			goto L0f03;
		...
		L0f03:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0((ushort)(0xba06 + this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23c))),
				160, 183, this.oCPU.AX.LowUInt8);

			this.oParent.Var_aa_Rectangle.ScreenID = this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23a));

		L0f26:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x208), this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x208))));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x208)), 0x17);
			if (this.oCPU.Flags.L) goto L0f37;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x208), 0x0);

		L0f37:
			// Instruction address 0x0000:0x0f4d, size: 5
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_19d4_Rectangle,
				135, 51,
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x238 +
					(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x208)) << 1))));

			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L0f6e;
		...
		L0f6e:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 0x140);
			if (this.oCPU.Flags.GE) goto L0f95;

			// Instruction address 0x0000:0x0f8d, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 0, 12, 319, 20,
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x246)));

		L0f95:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 0x0);
			if (this.oCPU.Flags.E) goto L0fc4;

			// Instruction address 0x0000:0x0fbc, size: 5
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(
				this.oParent.Var_19d4_Rectangle,
				0, 0, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 20,
				this.oParent.Var_aa_Rectangle,
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 12);
		...
		L0fc4:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 
				0, 56, 320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 132,
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x246)));
		...
		L1015:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				0, 44, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 132,
				this.oParent.Var_aa_Rectangle,
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 56);

		L1047:
			this.oCPU.TEST_UInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 0x1);
			...
			this.oParent.Graphics.F0_VGA_0550_SetPixel(this.oParent.Var_aa_Rectangle.ScreenID,
		...
		L106f:
			...
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L10a9;
			
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23a), (short)this.oParent.Var_aa_Rectangle.ScreenID);
			this.oParent.Var_aa_Rectangle.ScreenID = 0;
		...
		L10d7:
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_19d4_Rectangle, 0, 176,
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 24,
				this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x246)));
		...
		L1107:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Rectangle,
				0, 20, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 24,
				this.oParent.Var_19d4_Rectangle,
				320 - this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 176);

		L1139:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.CX.UInt16 = 0x16;
			...
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204));
			this.oCPU.AX.UInt16 = this.oCPU.INC_UInt16(this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23c), this.oCPU.AX.UInt16);

		L1150:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204), this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204))));
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204));
			...
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x240));
		...
		L1174:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x240));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204)), this.oCPU.AX.UInt16);
		...
		L1181:
			...
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L1199;
			goto L0ed8;
		...
		L119f:
			...
			this.oParent.CAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x200), this.oCPU.AX.UInt16);

			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204));
			this.oCPU.AX.UInt16 = this.oCPU.INC_UInt16(this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x240), this.oCPU.SUB_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x240)), this.oCPU.AX.UInt16));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204), 0xffff);

			if (playerID == this.oParent.GameData.HumanPlayerID) goto L11ed;
			goto L1350;
		...
		L11ed:
			...
			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L1233;
		...
		L1233:
			...
			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L12a1;
			goto L137e;

		L12a1:
			// Instruction address 0x0000:0x12b1, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(1, 15, 16, 31);

			// Instruction address 0x0000:0x12c9, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(2, 100, 32, 34);

			// Instruction address 0x0000:0x12e1, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(3, 42, 35, 40);

			// Instruction address 0x0000:0x12f9, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(4, 300, 41, 47);

			// Instruction address 0x0000:0x1311, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(5, 60, 48, 53);

			// Instruction address 0x0000:0x1329, size: 5
			this.oParent.CommonTools.F0_1000_0382_AddPaletteCycleSlot(6, 37, 54, 63);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e), 0x1);

		L1337:
			// Instruction address 0x0000:0x133b, size: 5
			this.oParent.CommonTools.F0_1000_03fa_StartPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)));
			
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e), 
				this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e))));

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)), 0x6);
		...
		L1387:
			...
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x200)), 0x5e);
			if (this.oCPU.Flags.E) goto L139e;
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x240));
			this.oCPU.CMP_UInt16(this.oCPU.SI.UInt16, this.oCPU.AX.UInt16);
		...
		L139e:
			...
			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x204));
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 + this.oCPU.SI.UInt16 - 0x200), 0x0);
		...
		L13be:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0((ushort)(this.oCPU.BP.UInt16 + this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23c)) - 0x200),
				160, 5, 11);
			...
			this.oParent.Graphics.F0_VGA_0550_SetPixel(this.oParent.Var_aa_Rectangle.ScreenID, 280, 32, 15);
			...
			this.oParent.Graphics.F0_VGA_0550_SetPixel(this.oParent.Var_aa_Rectangle.ScreenID, 280, 32, 0);
		...
		L146c:
			...
			if (playerID != this.oParent.GameData.HumanPlayerID) goto L149d;

			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L149d;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e), 0x1);

		L1486:
			// Instruction address 0x0000:0x148a, size: 5
			this.oParent.CommonTools.F0_1000_042b_StopPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x23e)));
		...
		L149d:
			...
			this.oParent.CAPI.fclose((short)this.oParent.Var_d768);

			this.oParent.Var_aa_Rectangle.FontID = 1;

			if (this.oParent.Var_d762_AlwaysTrueForVGA) goto L1500;
		...
		public void F2_0000_152a()
		{
			...
			this.oParent.CAPI.strcpy(0xba06, "Irrigation");
		...
		L161f:
			...
			this.oParent.LanguageTools.F0_2f4d_01ad(0x3348, 0x3342);
		...
		L16a5:
			...
			if (!this.oParent.Var_d762_AlwaysTrueForVGA) goto L170d;

			// Instruction address 0x0000:0x16e5, size: 5
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0((ushort)(0xba06 + this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))),
				160, 7, 15);
		...
		L172b:
			...
			this.oParent.DrawStringTools.F0_1182_00b3_DrawCenteredStringToScreen0((ushort)(0xba06 + this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))),
				160, 8, this.oCPU.AX.LowUInt8);

			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2));
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xba05)), 0x21);
			...
			this.oParent.CommonTools.F0_1182_0134_WaitTimer(200);
		...
		L186c:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.MapManagement.F0_2aea_1894_CellHasMinorTribeHut(
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
				(TerrainTypeEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))) ? 1 : 0);

			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.E) goto L1891;

			// Instruction address 0x0000:0x1889, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Village");
		...
		L1891:
			...
			F2_0000_195a_ShowIntroDialog((direction.X * 16) + 200, (direction.Y * 16) + 112, (direction.X * 64) + 170, (direction.Y * 48) + 100);
		...
		L18d6:
			...
			this.oParent.CAPI.strcpy(0xba06, "Menu Bar");

			F2_0000_195a_ShowIntroDialog(160, 6, 200, 16);

			// Instruction address 0x0000:0x1905, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Map Window");

			F2_0000_195a_ShowIntroDialog(48, 32, 88, 24);

			// Instruction address 0x0000:0x192c, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Active Unit");

			F2_0000_195a_ShowIntroDialog(40, 128, 88, 170);
		...
		public void F2_0000_195a_ShowIntroDialog(int lineX, int lineY, int windowX, int windowY)
		{
			//this.oCPU.Log.EnterBlock($"F2_0000_195a({lineX}, {lineY}, {windowX}, {windowY})");

			// function body			
			// Instruction address 0x0000:0x1971, size: 5
			this.oParent.Graphics.F0_VGA_0599_DrawLine(this.oParent.Var_aa_Rectangle, lineX, lineY, windowX, windowY + 6, 15);
			...
			this.oParent.MenuBoxDialog.F0_2d05_0031_ShowMenuBox(0xba06, windowX, windowY, true, false, true);
		}
	}
}
