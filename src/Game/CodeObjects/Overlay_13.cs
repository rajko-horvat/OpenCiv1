...
namespace OpenCiv1
{
	public class Overlay_13
	{
		...
		public void F13_0000_0000(int playerID)
		{
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Screen0_Rectangle, 0, 0, 320, 200, 1);
			...
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Screen0_Rectangle, 16, 4,
		...
		public void F13_0000_082a()
		{
			...
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Screen0_Rectangle, 0, 0, 320, 200, 4);
		...
		L085d:
			...
			this.oParent.DrawStringTools.F0_1182_0086_DrawStringWithShadowToScreen0(
