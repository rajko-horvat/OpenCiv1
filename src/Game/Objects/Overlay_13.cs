...
namespace OpenCiv1
{
	public class Overlay_13
	{
		...
		public void F13_0000_0000(short playerID)
		{
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0(this.oParent.GameData.Players[playerID].Nationality,
				128, 4, 15);
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0("/Units/Cities/Settlers/Land", 16, 50, 15);
		...
		L029f:
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0(0xba06, 256, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 7);
		...
		L03a1:
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0(0xba06, 192, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 7);
		...
		L0464:
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0("Civilization:", 16, 56, 15);
		...
		public void F13_0000_0554()
		{
			...
			this.oParent.Segment_2d05.F0_2d05_096c_FillRectangleWithDoubleShadow(0, 0, 317, 197, 1);
