...
namespace OpenCiv1
{
	public class Overlay_13
	{
		...
		public void F13_0000_0000(int playerID)
		{
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(this.oParent.GameData.Players[playerID].Nationality,
				128, 4, 15);
			...
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
				16, 4, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)((((playerID << 5) + 0x40) << 1) + 0xd4ce)));

			// Instruction address 0x0000:0x0088, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Government: ");

			this.oCPU.BX.UInt16 = (ushort)this.oParent.GameData.Players[playerID].GovernmentType;
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 16, 24, 15);
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 16, 32, 15);

			// Instruction address 0x0000:0x00f9, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Treasury: $");
			...
			this.oParent.CAPI.strcat(0xba06, ", Taxes/Science: ");

			// Instruction address 0x0000:0x014b, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].TaxRate, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].ScienceTaxRate, 10));

			// Instruction address 0x0000:0x0194, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 16, 40, 15);

			// Instruction address 0x0000:0x01ac, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0("/Units/Cities/Settlers/Land", 16, 50, 15);
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].CityCount, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].SettlerCount, 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].LandCount, 10));

			// Instruction address 0x0000:0x0275, size: 5
			this.oParent.CAPI.strcat(0xba06, "/");

			// Instruction address 0x0000:0x028d, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 192, 48, 15);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x4);
		...
		L029f:
			...
			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Attack == 0)
				goto L0379;

			// Instruction address 0x0000:0x02bd, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Settle");

			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Strategy == 2)
			{
				// Instruction address 0x0000:0x02e0, size: 5
				this.oParent.CAPI.strcpy(0xba06, "Defend");
			}

			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Strategy == 1)
			{
				// Instruction address 0x0000:0x0303, size: 5
				this.oParent.CAPI.strcpy(0xba06, "Attack");
			}

			if (this.oParent.GameData.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Strategy == 5)
			{
				// Instruction address 0x0000:0x0326, size: 5
				this.oParent.CAPI.strcpy(0xba06, "Transport");
			}
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 256, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 7);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x8));
		...
		L0379:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), 0xf);
			if (this.oCPU.Flags.GE) goto L0385;
			goto L029f;

		L0385:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x18);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), 0x1);
			goto L03f5;
		...
		L03a1:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))] & 8) != 0)
			{
				// Instruction address 0x0000:0x03bc, size: 5
				this.oParent.CAPI.strcat(0xba06, ": Vendetta");
			}
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))] & 0xb) == 0)
				goto L03f2;

			// Instruction address 0x0000:0x03e6, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 192, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 7);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x8));
		...
		L03f5:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Nationality);

			this.oCPU.BX.UInt16 = (ushort)playerID;
			this.oCPU.CX.LowUInt8 = 0x4;
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, this.oCPU.CX.LowUInt8);

			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))] & 0xb) == 0x1)
			{
				// Instruction address 0x0000:0x0431, size: 5
				this.oParent.CAPI.strcat(0xba06, ": Contact");
			}
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))] & 2) == 0)
				goto L03a1;

			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))] & 4) == 0)
				goto L0391;

			// Instruction address 0x0000:0x0399, size: 5
			this.oParent.CAPI.strcat(0xba06, ": Allied");

			goto L03a1;

		L0464:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x38);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), 0x0);

			// Instruction address 0x0000:0x047e, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0("Civilization:", 16, 56, 15);
		...
		L0494:
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06,
				((this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) % 3) * 100) + 8,
		...
		L04cc:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0xc0);
		...
		L04d6:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), 0x48);
		...
		public void F13_0000_0554()
		{
			...
			this.oParent.ManuBoxDialog.F0_2d05_096c_FillRectangleWithDoubleShadow(0, 0, 317, 197, 1);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 0x0);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), 0x12);
		...
		L05b1:
			...
			if (this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].ActiveUnits[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] != 0)
				goto L05cc;
			
			if (this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].UnitsInProduction[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] == 0)
				goto L05d1;
		...
		L05d1:
			...
			this.oParent.Graphics.F0_VGA_0599_DrawLine(this.oParent.Var_aa_Rectangle,
				36, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) - 1,
				319, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) - 1, 9);
			...
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(
				...
				((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)) & 1) << 4) + 2,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) - 4,
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16,
					(ushort)(((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)) + 0x60) << 1) + 0xd4ce)));
		...
		L0641:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x1c);
		...
		L067b:
			...
			if (this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].ActiveUnits[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] != 0)
				goto L0696;

			if (this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].UnitsInProduction[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] == 0)
				goto L069b;
		...
		L06c8:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].ActiveUnits[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))], 10));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].UnitsInProduction[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))], 10));

			// Instruction address 0x0000:0x074c, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06,
				(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)) * 30) + 88,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)),
				15);
		...
		L0767:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Ranking, 10));

			if (!this.oParent.Var_d806_DebugFlag) goto L07b7;

			// Instruction address 0x0000:0x07af, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06,
				(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)) * 30) + 84,
				1,
				15);
		...
		L07b7:
			...
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
				(30 * this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))) + 90, 2,
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16,
					(ushort)((((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)) << 5) + 0x40) << 1) + 0xd4ce)));

			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.HumanPlayerID;
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.E) goto L07ea;
			
			if (this.oParent.Var_d806_DebugFlag) goto L07ea;
			goto L075b;
		...
		L085d:
			...
			this.oParent.DrawStringTools.F0_1182_0086_DrawStringWithShadow(
				this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].Nationality,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)) * 40, 8,
				(byte)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x1946)));

			// Instruction address 0x0000:0x088f, size: 5
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
				(short)this.oCPU.DI.UInt16, 16,
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16,
					(ushort)((((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)) << 5) + 0x40) << 1) + 0xd4ce)));

			// Instruction address 0x0000:0x08ad, size: 5
			this.oParent.DrawStringTools.F0_1182_0086_DrawStringWithShadow(
				this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].Nationality,
				4, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)) * 12 + 32,
				(byte)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x1946)));
		...
		L08d2:
			...
			if (this.oParent.Var_d806_DebugFlag) goto L08ee;
		...
		L08ee:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(
					this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].UnitsDestroyed[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))],
					10));

			// Instruction address 0x0000:0x0928, size: 5
			this.oParent.CAPI.strcat(0xba06, "/");

			this.oCPU.SI.UInt16 = (ushort)(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)) << 1);

			// Instruction address 0x0000:0x0955, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(
					this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].UnitsDestroyed[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))],
					10));

			// Instruction address 0x0000:0x0976, size: 5
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)) * 40,
				(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)) * 12) + 32,
				(byte)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x1946)));
