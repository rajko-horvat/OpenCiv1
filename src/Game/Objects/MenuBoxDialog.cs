...
namespace OpenCiv1
{
	public class MenuBoxDialog
	{
		...
		L0081:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb1ec, 0xffff);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd2e2, 0x1);
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x2fa4, this.oCPU.AX.UInt16);
		...
		L00b5:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 0x7);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 0x16);

			if (yPos == 139)
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 0x8);
			}
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0xf);
		...
		L00ff:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x654c, this.oCPU.AX.UInt16);
			this.oCPU.CMP_UInt16(this.oParent.Var_d762, 0x0);
			if (this.oCPU.Flags.NE) goto L010e;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 0xffff);

		L010e:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x2fa4);
			...
			F0_2d05_0475(stringPtr, xPos, yPos, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x2f9a));

			// Instruction address 0x2d05:0x0135, size: 5
			this.oParent.Segment_11a8.F0_11a8_0250();

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdb38), 0x0);
			if (this.oCPU.Flags.E) goto L014d;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xdb38, 0x0);
			this.oCPU.AX.UInt16 = 0xffff;
			goto L0470;
		...
		L018a:
			...
			this.oCPU.CX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x2fa4);
		...
		L020b:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd208);
		...
		L0217:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x8066), 0x0);
			if (this.oCPU.Flags.NE) goto L0233;
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd206), 0x0);
		...
		L0243:
			...
			this.oParent.Graphics.F0_VGA_009a_ReplaceColor(this.oParent.Var_aa_Rectangle,
				xPos + 3,
				((this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)) + this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xb1ec)) *
					this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x2fa4)) + yPos + 4,
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xd4c8) + 5,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)),
				11, (byte)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)));
			...
			this.oParent.Graphics.F0_VGA_009a_ReplaceColor(this.oParent.Var_aa_Rectangle,
				...
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xd4c8) + 5,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)),
				3, (byte)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)));
		...
		L02ba:
			...
			this.oParent.Graphics.F0_VGA_009a_ReplaceColor(this.oParent.Var_aa_Rectangle,
				xPos + 3,
				((this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)) + this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xb1ec)) *
					this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x2fa4)) + yPos + 4,
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xd4c8) + 5,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)),
				(byte)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)),
				11);
			...
			this.oParent.Graphics.F0_VGA_009a_ReplaceColor(this.oParent.Var_aa_Rectangle,
				...
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xd4c8) + 5,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)),
				(byte)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				3);
		...
		L0371:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.DEC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))));
			goto L0217;
		...
		L039a:
			...
			if (!this.oParent.GameData.GameSettingFlags.Sound) goto L03a9;
			goto L0217;
		...
		L03bb:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), 0x20);
		...
		L03c4:
			...
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdc4a)), 0xff);
			if (this.oCPU.Flags.E) goto L03b8;
			this.oCPU.AX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdc4a));
			this.oCPU.AX.LowUInt8 = this.oCPU.AND_UInt8(this.oCPU.AX.LowUInt8, 0x1f);
			this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.CX.LowUInt8 = this.oCPU.AND_UInt8(this.oCPU.CX.LowUInt8, 0x1f);
			this.oCPU.CMP_UInt8(this.oCPU.AX.LowUInt8, this.oCPU.CX.LowUInt8);
			if (this.oCPU.Flags.NE) goto L03b8;
			this.oCPU.AX.UInt16 = this.oCPU.BX.UInt16;
			goto L01c8;

		L03e3:
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x2300);
			if (this.oCPU.Flags.E) goto L0386;
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x2f00);
		...
		L0406:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x654c);
		...
		L0456:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x2f9a, 0xffff);

			this.oCPU.AX.UInt16 = 0;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x2fa0, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd206, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb276, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd7f2, this.oCPU.AX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
		...
		public void F0_2d05_0475(ushort stringPtr, int xPos, int yPos, ushort param4)
		{
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x654e, 0x0);
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd2e2), 0x1);
		...
		L04ba:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdc4a), 0xff);
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56)), 0x20);
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x658e, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x54), this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd4c8, this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56), this.oCPU.AX.UInt16);
			goto L053b;

		L04de:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x54)), 0x0);
			...
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5c), this.oCPU.AX.LowUInt8);
			this.oCPU.CMP_UInt8(this.oCPU.AX.LowUInt8, 0x20);
			if (this.oCPU.Flags.E) goto L04f7;
			this.oCPU.CMP_UInt8(this.oCPU.AX.LowUInt8, 0x5f);
			if (this.oCPU.Flags.NE) goto L051c;

		L04f7:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a)), 0x20);
			if (this.oCPU.Flags.GE) goto L050c;
			this.oCPU.SI.UInt16 = this.oCPU.BX.UInt16;
			this.oCPU.BX.UInt16 = stringPtr;
			this.oCPU.AX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + this.oCPU.SI.UInt16 + 0x1));
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdc4a), this.oCPU.AX.LowUInt8);

		L050c:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb1ec), 0xffff);
			if (this.oCPU.Flags.NE) goto L0519;
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x658e);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb1ec, this.oCPU.AX.UInt16);

		L0519:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a), 
				this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a))));
		...
		L051c:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x54), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x54)), this.oCPU.AX.UInt16));
		...
		L053b:
			...
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56));
			this.oCPU.SI.UInt16 = stringPtr;
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + this.oCPU.SI.UInt16)), 0xa);
			if (this.oCPU.Flags.NE) goto L04de;
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd4c8);
		...
		L0564:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x658e, this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x658e)));
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x658e);
			...
			this.oCPU.AX.UInt16 = this.oCPU.INC_UInt16(this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x654e), this.oCPU.AX.UInt16);
			goto L0538;

		L057d:
			// Instruction address 0x2d05:0x0592, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x658e),
				0, (192 - yPos) / this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x2fa4));

			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x658e, this.oCPU.AX.UInt16);
			this.oCPU.AX.UInt16 = (ushort)xPos;
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd4c8));
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, 0x8);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xde0e, this.oCPU.AX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x658e);
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x2fa4));
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, (ushort)yPos);
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x2fa0), 0x0);
			if (this.oCPU.Flags.E) goto L05c5;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x52), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x52)), 0x2));
		...
		L05c5:
			...
			this.oCPU.BX.UInt16 = stringPtr;
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + this.oCPU.SI.UInt16 - 0x1)), 0xa);
			if (this.oCPU.Flags.E) goto L05de;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a), 
				this.oCPU.DEC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a))));

		L05de:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a));
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd208, this.oCPU.AX.UInt16);
		...
		L05ed:
			...
			F0_2d05_096c_FillRectangleWithDoubleShadow(xPos, yPos,
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xde0e) - xPos, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x52)) - yPos, 7);

			goto L075b;

		L0613:
			this.oCPU.BX.UInt16 = (ushort)((short)this.oParent.Var_2f9e_MessageBoxStyle);
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
			// Instruction address 0x2d05:0x0621, size: 5
			this.oParent.CAPI.strcpy((ushort)(this.oCPU.BP.UInt16 - 0x50), this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x2fa6)));
			...
			this.oParent.CAPI.strcat((ushort)(this.oCPU.BP.UInt16 - 0x50), " report:");
		...
		L0640:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xde0e), this.oCPU.SI.UInt16);
			if (this.oCPU.Flags.GE) goto L0661;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xde0e, this.oCPU.SI.UInt16);

		L0661:
			this.oCPU.SI.UInt16 = (ushort)((short)(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x52)) - yPos));

			// Instruction address 0x2d05:0x0677, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange((short)this.oCPU.SI.UInt16 + 8, 61, 999);

			// Instruction address 0x2d05:0x0699, size: 3
			F0_2d05_096c_FillRectangleWithDoubleShadow(xPos - 42, yPos - 8,
				(this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xde0e) - xPos) + 42, (short)this.oCPU.AX.UInt16, 7);

			// LEA
			this.oCPU.AX.UInt16 = (ushort)(this.oCPU.SI.UInt16 - 0x34);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x58), this.oCPU.AX.UInt16);
		...
		L06d2:
			...
			if (this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x58)) > 0)
			{
				...
				this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19e8_Rectangle,
					...
					xPos - 40, ((this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x58)) - 1) + yPos) - 6);
			}
			else
			{
				// Instruction address 0x2d05:0x070d, size: 5
		...
		L075b:
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56), (short)this.oParent.Var_aa_Rectangle.FontID);
			...
			this.oParent.Var_aa_Rectangle.FontID = this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56));
		...
		L0799:
			...
			F0_2d05_0a05_DrawRectangle(
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xde0e) - 20,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x52)) - 10,
				20, 10, 11);

		L07df:
			this.oCPU.BX.UInt16 = stringPtr;
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, this.oCPU.BX.UInt16), 0x20);
			if (this.oCPU.Flags.E) goto L07ec;
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, this.oCPU.BX.UInt16), 0x5f);
		...
		L07f3:
			...
			this.oParent.Var_aa_Rectangle.FrontColor = (byte)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x654c);
		...
		L0808:
			this.oCPU.AX.UInt16 = 0x1;
			this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a));
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.TEST_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb276));
		...
		L081d:
			...
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x654e));
			this.oCPU.BX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.BX.UInt16, stringPtr);
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, this.oCPU.BX.UInt16, 0x20);
			goto L08ce;

		L0849:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a)), 0x0);
			if (this.oCPU.Flags.GE) goto L0883;
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x2fa4), 0x9);
		...
		L08ce:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56));
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.SI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6550));
			this.oCPU.BX.UInt16 = stringPtr;
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + this.oCPU.SI.UInt16 - 0x1), 0xa);

		L08de:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x56));
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6550));
			this.oCPU.SI.UInt16 = stringPtr;
			this.oCPU.AX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + this.oCPU.SI.UInt16));
			this.oCPU.WriteUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5c), this.oCPU.AX.LowUInt8);
			this.oCPU.CMP_UInt8(this.oCPU.AX.LowUInt8, 0x20);
		...
		L08f7:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a), this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a))));
		...
		L08fd:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd2e2), 0x0);
			if (this.oCPU.Flags.NE) goto L0920;
			this.oCPU.AX.UInt16 = param4;
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a)));
		...
		L0920:
			...
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x6550));
			this.oCPU.BX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.BX.UInt16, stringPtr);
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 - 0x1), 0x0);
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a)), 0x0);
		...
		L0939:
			...
			this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a));
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.TEST_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd7f2));
			if (this.oCPU.Flags.NE) goto L094a;
			goto L0849;

		L094a:
			this.oCPU.DI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x654e));
			this.oCPU.DI.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.DI.UInt16, stringPtr);
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, this.oCPU.DI.UInt16, 0x5e);
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x5a)), 0x0);
		...
		public int F0_2d05_0ac9_GetNavigationKey()
		{
			...
			int iKey = this.oParent.CAPI.getch();
