	...
	public class Segment_29f3
	{
		...
		public ushort F0_29f3_000e(short playerID1, short unitID1, short playerID2, short unitID2, ushort flag)
		{
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8),
				(short)this.oParent.GameData.Players[playerID1].Units[unitID1].TypeID);
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe),
				(short)this.oParent.GameData.Players[playerID2].Units[unitID2].TypeID);
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].AttackStrength);
			...
			this.oCPU.AX.LowUInt8 = (byte)this.oParent.GameData.TerrainTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))].DefenseBonus;
			this.oCPU.CBW(this.oCPU.AX);

			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, 
				(ushort)((short)this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].DefenseStrength));
			this.oCPU.CX.LowUInt8 = 0x3;
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
		...
		L013c:
			...
			if (this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].MovementType == UnitMovementTypeEnum.Air)
				goto L0152;

			if (this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].MovementType != UnitMovementTypeEnum.Water)
				goto L0165;
		...
		L0152:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].DefenseStrength);
			this.oCPU.CX.LowUInt8 = 0x3;
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a), this.oCPU.AX.UInt16);
		...
		L0195:
			...
			if (this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].AttackStrength == 12)
				goto L01f2;
		...
		L0416:
			...
			if (this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].AttackStrength > 4)
				goto L043a;
			...
			if (this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].DefenseStrength <= 2)
				goto L045d;
		...
		L043f:
			...
			if (this.oParent.GameData.UnitTypes[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].AttackStrength > 4)
				goto L043a;
			...
			if (this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].DefenseStrength > 2)
				goto L043a;
		...
		L04ec:
			...
			this.oParent.UnitGoTo.F0_2e31_119b_AdjustXPosition(this.oParent.GameData.Players[playerID1].Units[unitID1].Position.X - this.oParent.Var_d4cc_MapViewX);
		...
		L05de:
			...
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
				...
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(((this.oParent.GameData.Players[playerID1].Units[unitID1].TypeID +
		...
		L06c1:
			...
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
				...
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16,
					(ushort)(((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)) + 0x20) << 1) + 0xd4ce)));
		...
		L0721:
			...
			this.oParent.GameData.Players[playerID1].Diplomacy[playerID2] |= 0x20;
			...
			this.oParent.GameData.Players[playerID2].Diplomacy[playerID1] |= 0x20;
		...
		L0753:
			...
			if ((this.oParent.GameData.Players[playerID2].Diplomacy[playerID1] & 2) != 0)
				goto L0782;
		...
		L076e:
			...
			if ((this.oParent.GameData.Players[playerID1].Diplomacy[playerID2] & 0x200) == 0)
				goto L07e2;
		...
		L0782:
			...
			this.oParent.GameData.Players[playerID1].Diplomacy[playerID2] &= 0xfdff;
		...
		L087a:
			...
			if ((this.oParent.GameData.Players[playerID2].Diplomacy[playerID1] & 2) != 0)
			{
				this.oParent.GameData.Players[playerID2].Diplomacy[playerID1] |= 8;
			}
		...
		L08ae:
			...
			this.oParent.GameData.Players[playerID2].Diplomacy[playerID1] &= 0xfdff;
		...
		L0902:
			if (playerID2 == 0)
			{
				...
				if (this.oParent.GameData.Players[playerID2].Units[unitID2].TypeID == 26)
				{
					...
					if (playerID1 == this.oParent.GameData.HumanPlayerID)
					{
						...
						this.oParent.LanguageTools.F0_2f4d_044f(0x2ae7);
		...
		L0a4c:
			...
			GPoint direction = this.oParent.MoveOffsets[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))];
			...
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.HumanPlayerID;
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd7f0), this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.E) goto L0aaf;

			// Instruction address 0x29f3:0x0aa7, size: 5
			this.oParent.Segment_1866.F0_1866_144b(this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xd7f0),
		...
		L0e4d:
			...
			this.oParent.Segment_1866.F0_1866_1251(this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xd7f0),
			...
			this.oParent.GameData.Players[playerID].UnitsDestroyed[this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd7f0)] += (short)this.oCPU.AX.UInt16;
			...
			this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd7f0)].Diplomacy[playerID] |= 0x88;
		...
		L0ed1:
			...
			this.oParent.CityWorker.F0_1d12_6d33(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)));
