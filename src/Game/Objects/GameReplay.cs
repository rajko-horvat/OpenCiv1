...
namespace OpenCiv1
{
	public class GameReplay
	{
		...
		L04a8:
			...
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.UnitTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);
		...
		L05ad:
			// Instruction address 0x0000:0x0405, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.GameData.WonderTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);
		...
		L0e67:
			// Instruction address 0x0000:0x0e7f, size: 5
			this.oParent.CommonTools.F0_1000_0bfa_FillRectangle(this.oParent.Var_aa_Rectangle, 18, 150, 284, 32, 7);
		...
		public void F9_0000_0f79(short playerID, ushort param2)
		{
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x32)), 0x3);
			if (this.oCPU.Flags.NE) goto L0fd2;
		...
		L10bc:
			...
			this.oParent.ImageTools.F0_2fa1_01a2_LoadBitmapOrPalette(1, 0, 0x85, (ushort)(this.oCPU.BP.UInt16 - 0x24), 0);
		...
		L122d:
			...
			this.oParent.CommonTools.F0_1000_04aa_TransformPalette(8, 0xbdee);
		...
		L135f:
			...
			this.oParent.Segment_2dc4.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0);
