...
namespace OpenCiv1
{
	public class Palace
	{
		...
		public void F17_0000_0000()
		{
			...
			this.oParent.ManuBoxDialog.F0_2d05_0031_ShowMenuBox((ushort)(this.oCPU.BP.UInt16 - 0x100), 20, 16, true);
			...
			this.oParent.ManuBoxDialog.F0_2d05_0031_ShowMenuBox(0x4af0, 40, 16, true);
