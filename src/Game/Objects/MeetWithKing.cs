...
namespace OpenCiv1
{
	public class MeetWithKing
	{
		...
		L01f5:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 8) == 0)
				goto L02a0;
		...
		L02a0:
			...
			this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] |= 0x80;
		...
		L0417:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 0x80) != 0)
				goto L0452;
		...
		L0492:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 0x4) != 0)
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), 0x0);
			}
		...
		L04b1:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 0x8) != 0)
			{
		...
		L04df:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 3) == 1)
			{
				...
				if ((this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 0x2) != 0)
				{
		...
		L0544:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.NationTypes[this.oParent.GameData.Players[playerID].NationalityID].Mood;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2a), 
			...
			this.oCPU.CX.UInt16 = (ushort)((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 2) == 0 ? 1 : 0);
		...
		L0666:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.HumanPlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
		...
		L0762:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x3776);
		...
		L0822:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 2) != 2)
				goto L084e;
		...
		L0891:
			...
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30ba),
				this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x30))].Nation);

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x24)), 0x0);
			if (this.oCPU.Flags.E) goto L08b6;
			
			// Instruction address 0x0000:0x08be, size: 5
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30be), "demand");

			goto L08b9;

		L08b6:
			// Instruction address 0x0000:0x08be, size: 5
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30be), "request");

		L08b9:
			// Instruction address 0x0000:0x08ca, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x378f);
		...
		L092d:
			...
			this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x30))].Diplomacy[this.oParent.GameData.HumanPlayerID] |= 8;
		...
		L098c:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x3797);
		...
		L0a44:
			...
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30be),
				this.oParent.GameData.TechnologyTypes[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].Name);

			// Instruction address 0x0000:0x0a76, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x37a0);
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(playerID, 
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), this.oParent.GameData.HumanPlayerID);
		...
		L0ad9:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x37a9);

		L0b1a:
			// Instruction address 0x0000:0x0b27, size: 5
			this.oParent.LanguageTools.F0_2f4d_0000(0x28);
		...
		L0b54:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x37b2);
		...
		L0b82:
			...
			// Instruction address 0x0000:0x0b1b, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x37bb);
		...
		L0ba1:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 1) == 0)
				goto L0bbb;
		...
		L0bbb:
			...
			// Instruction address 0x0000:0x0b1b, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x37c3);
		...
		L0be5:
			...
			// Instruction address 0x0000:0x0bee, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x37c8);
		...
		L0c65:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x37cd);

			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x6b8e, 0x0);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x3936, 0x0);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd76c, 0xc);
		...
		L0d03:
			...
			this.oParent.Segment_2517.F0_2517_0aa1_ClearDiplomacyFlags(this.oParent.GameData.HumanPlayerID, playerID, 2);
		...
		L0d3c:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 0xa) != 0)
				goto L0e0e;
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x3805);
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(this.oParent.GameData.HumanPlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)), playerID);
		...
		L0e5a:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x380e);
		...
		L0f05:
			...
			if ((this.oParent.GameData.Players[(ushort)playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] & 0xa) != 0)
				goto L1041;
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x3818);
		...
		L0fd1:
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(this.oParent.GameData.HumanPlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20)), playerID);
		...
		L1041:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x3820);
		...
		L1102:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x382a);
		...
		L1209:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x388f);
		...
		L1289:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x3897);
		...
		L1332:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x38a1);
		...
		L144a:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 1) != 0)
				goto L1487;

			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

			// Instruction address 0x0000:0x15c7, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x38e9);
		...
		L1487:
			...
			if ((this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x20))] & 2) != 0)
				goto L14c1;

			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

			// Instruction address 0x0000:0x14a3, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x38f4);
		...
		L14c1:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x38fb);
		...
		L15be:
			...
			// Instruction address 0x0000:0x15c7, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x391e);
		...
		L15e2:
			...
			this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] |= 0x100;
		...
		L15fa:
			...
			this.oParent.GameData.Players[playerID].Diplomacy[this.oParent.GameData.HumanPlayerID] &= 0xffdf;
			...
			this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].Diplomacy[playerID] &= 0xffdf;
		...
		L16de:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3934), 0x0);
		...
		L16ee:
			...
			this.oParent.MapManagement.F0_2aea_0008_DrawVisibleMap(oParent.GameData.HumanPlayerID, xPos - 8, yPos - 2);
		...
		L1771:
			...
			this.oParent.CommonTools.F0_1000_0a32_PlayTune(this.oParent.GameData.NationTypes[this.oParent.GameData.Players[playerID].NationalityID].ShortTune, 3);
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x3934), 0xfffe);
		...
		L17d1:
			...
			this.oParent.CommonTools.F0_1000_0a32_PlayTune(this.oParent.GameData.NationTypes[this.oParent.GameData.Players[playerID].NationalityID].LongTune, 3);
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x3936, 1);
		...
		public void F6_0000_1a3f(short playerID)
		{
			...
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30be), this.oParent.GameData.Players[playerID].Nationality);

			// Instruction address 0x0000:0x1a65, size: 5
			this.oParent.CAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x30b8), this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].Nationality);

			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd76c, 0xc);
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);

			// Instruction address 0x0000:0x1a7c, size: 5
			this.oParent.LanguageTools.F0_2f4d_044f(0x3a8c);
		...
		public void F6_0000_1a99(short playerID)
		{
			...
			this.oParent.Segment_2517.F0_2517_0a30_SetDiplomacyFlags(this.oParent.GameData.HumanPlayerID, playerID, 2);
		...
		public void F6_0000_1d2b(short playerID)
		{
			...
			this.oCPU.WriteInt16(this.oCPU.DS.UInt16, 0x67f2, playerID);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f0, 0);

			if (!this.oParent.GameData.GameSettingFlags.Animations) goto L1d49;
			goto L1e2c;
		...
		L1d60:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67f0, 0x1);
			...
			this.oParent.ManuBoxDialog.F0_2d05_0a66_DrawShadowRectangle(0, 128, 319, 71, 15, 8);

			this.oCPU.SI.UInt16 = (ushort)playerID;
			this.oCPU.SI.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.SI.UInt16, 0x1);

			// Instruction address 0x0000:0x1dae, size: 5
			this.oParent.CAPI.strcpy(0xba06, this.oParent.GameData.Players[playerID].Name);
			...
			this.oParent.DrawStringTools.F0_1182_005c_DrawStringToScreen0(0xba06, 8, 130, 15);
		...
		L1e3e:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, TechnologyEnum.Invention) ? 1 : 0);
		...
		L1ea5:
			...
			this.oParent.Segment_11a8.F0_11a8_02a4((ushort)((this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f8) / 7) + 4), 1);
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f8), 0x0);
			if (this.oCPU.Flags.E) goto L1f42;
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x67f8), 0x3);
			if (this.oCPU.Flags.NE) goto L1f46;
		...
		L217a:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x67fa, 0x0);
		...
		L2244:
			...
			this.oParent.CommonTools.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_19d4_Rectangle, 90, 0, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb1e6));
