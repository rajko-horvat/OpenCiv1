...
namespace OpenCiv1
{
	public class Help
	{
		...
		L025f:
			...
			this.oParent.Segment_1403.F0_1403_3fd0(this.oParent.GameData.Players[playerID].Units[unitID].Position.X, this.oParent.GameData.Players[playerID].Units[unitID].Position.Y);
