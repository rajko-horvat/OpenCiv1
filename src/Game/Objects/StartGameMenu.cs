	...
	public class StartGameMenu
	{
		...
		public ushort F5_0000_07c7(int playerID)
		{
			...
			L0de4:
				...
				this.oParent.Segment_1866.F0_1866_0f10_DeleteUnit(0, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)));
		...
		L0f60:
			...
			this.oParent.Segment_1866.F0_1866_0f10_DeleteUnit(playerID, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
		...
		L13ca:
			...
			this.oParent.Segment_1866.F0_1866_0cf5_CreateUnit(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), 0,
