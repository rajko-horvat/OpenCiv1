...
namespace OpenCiv1
{
	public class Overlay_20
	{
		...
		L00fe:
			byte ubCityNameID = this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID;
			char[] acCityName = this.oParent.GameData.CityNames[ubCityNameID].ToCharArray();
			acCityName[12] = '\0';
			this.oParent.GameData.CityNames[ubCityNameID] = new string(acCityName);

		L0118:
			ubCityNameID = this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID;
			...
			while (this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)) > 0 &&
				this.oParent.GameData.CityNames[ubCityNameID][this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] == ' ')
			{
				acCityName = this.oParent.GameData.CityNames[ubCityNameID].ToCharArray();
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, TechnologyEnum.Conscription) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
			{
				this.oCPU.AX.UInt16 = 0x1c;
		...
		L038d:
			...
			this.oParent.CommonTools.F0_1000_104f_SetPixel(2, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)) + 0x50,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
				8);
		...
		L0502:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x4f74);
		...
		L0698:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID, TechnologyEnum.Medicine) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
		...
		L06c4:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xcc4)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L06dd;
		...
		L06dd:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x4f99);
		...
		L071f:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xca6)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0738;
		...
		L0738:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x4f9d);
		...
		L076b:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xc2e)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0784;
		...
		L0784:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x4fa1);
		...
		L07c0:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xc10)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L07d9;
		...
		L07d9:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x4fa5);
		...
		L0835:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x4fc3);
		...
		L08cd:
			...
			this.oParent.LanguageTools.F0_2f4d_044f(0x4fc7);
		...
		L0995:
			...
			if (this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID, TechnologyEnum.Religion) &&
		...
		L0fd6:
			...
			this.oParent.DrawStringTools.F0_1182_0086_DrawStringWithShadow(0xba06, 16, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 15);
		...
		L10e0:
			...
			this.oParent.DrawStringTools.F0_1182_0086_DrawStringWithShadow(0xba06, 16, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 15);
		...
		L1174:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oParent.GameData.PeaceTurnCount * 3, 0, 100);
