...
namespace OpenCiv1
{
	public partial class CivGame
	{
		...
		public void Start()
		{
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3772, 0x0, 0x4b0, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3772, 0x16e0, 0x5a0, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x19c2, 20, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x19d6, 20, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x19ea, 20, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x2494, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x2496, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x6b64, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x6b92, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0x8078, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xb222, 0x18, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xb23a, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xb2ba, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xb3be, 0x1c0, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xd2de, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xd762, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xd91a, 0x1c, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xdb36, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xdb44, 0x104, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xdcfe, 0x100, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xdeb6, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xdeb8, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
			...
			this.oCPU.Memory.MemoryRegions.Add(new CPUMemoryRegion(0x3b01, 0xe3c2, 2, CPUMemoryFlagsEnum.AccessNotAllowed));
