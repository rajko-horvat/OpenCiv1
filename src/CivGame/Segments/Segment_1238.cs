	...
	public class Segment_1238
	{
		...
		L00e7:
			...
			this.oParent.Var_d4cc_XPos = 
				(short)(this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Units[0].Position.X - 7);

			this.oParent.Var_d75e_YPos = 
				(short)(this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Units[0].Position.Y - 6);
		...
		L0306:
			...
			this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Coins);
		...
		L039e:
			...
			this.oCPU.TESTByte((byte)(this.oParent.CivState.SpaceshipFlags & 0xff), 0xfe);
		...
		L03f9:
			this.oCPU.CMPWord((ushort)this.oParent.CivState.HumanPlayerID, 0xffff);
			if (this.oCPU.Flags.NE) goto L0416;
			goto L055e;
			
		L0416:
			this.oCPU.TESTByte((byte)(this.oParent.CivState.GameSettingFlags & 0xff), 0x2);
		...
		L0616:
			...
			this.oCPU.TESTByte((byte)(this.oParent.CivState.GameSettingFlags & 0xff), 0x80);
			if (this.oCPU.Flags.E) goto L066e;
			...
			this.oParent.Overlay_20.F20_0000_0ca9(this.oParent.CivState.HumanPlayerID, false);
		...
		L09a9:
			this.oCPU.TESTWord((ushort)this.oParent.CivState.TechnologyFirstDiscoveredBy[58], 0x7);
		...
		L0a8b:
			...
			this.oCPU.TESTWord((ushort)this.oParent.CivState.TechnologyFirstDiscoveredBy[56], 0x7);
		...
		L0aa6:
			...
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.CMPByte(this.oParent.CivState.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14))].StatusFlag, 0xff);
		...
		L0d75:
			...
			this.oCPU.TESTWord((ushort)this.oParent.CivState.TechnologyFirstDiscoveredBy[35], 0x7);
		...
		L0de0:
			...
			this.oCPU.BX.Word = this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6));
			this.oCPU.BX.Word = this.oCPU.SHLWord(this.oCPU.BX.Word, 0x1);
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].ActiveUnits[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))]);
			this.oCPU.SI.Word = this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2));
			this.oCPU.SI.Word = this.oCPU.SHLWord(this.oCPU.SI.Word, 0x1);
		...
		L0fb0:
			...
			this.oCPU.CMPWord(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)), (ushort)this.oParent.CivState.HumanPlayerID);
			...
			this.oCPU.CX.Low = 0x4;
			this.oCPU.SI.Word = this.oCPU.SHLWord(this.oCPU.SI.Word, this.oCPU.CX.Low);
			this.oCPU.AX.Word = this.oCPU.SHLWord((ushort)this.oParent.CivState.HumanPlayerID, 0x1);
		...
		L151c:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oParent.CivState.RandomSeed);
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4), this.oCPU.AX.Word);
		...
		L16f9:
			...
			this.oCPU.CX.Word = this.oCPU.SUBWord(this.oCPU.CX.Word, (ushort)this.oParent.CivState.DifficultyLevel);
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.Word);
		...
		public void F0_1238_1767()
		{
			...
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.PollutionEffectLevel);
			this.oCPU.AX.Word = (ushort)Math.Sign((short)this.oCPU.AX.Word);
			this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.PollutionEffectLevel);
		...
		L18ab:
			...
			this.oCPU.AX.Word = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.CivState.HumanPlayerID,
				(int)this.oParent.CivState.BuildingDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8))].RequiresTechnology);
		...
		L1981:
			...
			this.oCPU.CMPWord((ushort)this.oParent.CivState.WonderCityID[17], 0xffff);
			if (this.oCPU.Flags.NE) goto L19ba;
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8), 0x11);
		...
		L1a11:			
			if (this.oParent.CivState.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].ActualSize <= 
				(this.oParent.CivState.BuildingDefinitions[24 + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8))].Price / 10))
				goto L189d;

			// Instruction address 0x1238:0x1a44, size: 5
			this.oCPU.AX.Word = this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(
				this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc)),
				(int)this.oParent.CivState.BuildingDefinitions[24 + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8))].RequiresTechnology);
		...
		L1a53:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oParent.CivState.BuildingDefinitions[24 + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8))].Name);
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				...
				0,
				(10 * this.oParent.CivState.BuildingDefinitions[24 + this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8))].Price) -
