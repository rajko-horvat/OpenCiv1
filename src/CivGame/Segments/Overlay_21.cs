...
namespace OpenCiv1
{
	public class Overlay_21
	{
		...
		public Overlay_21(CivGame parent)
		{
			this.oParent = parent;
		...
		L0016:
			...
			this.oCPU.TESTWord(this.oParent.CivState.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].BuildingFlags0, 0x1);
