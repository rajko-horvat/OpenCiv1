	...
	public class Segment_1d12
	{
		...
		public void F0_1d12_0045(short cityID, short flag)
		{
				...
				for (int i = 0; i < 128; i++)
				{
					if (this.oParent.CivState.Cities[i].StatusFlag != 0xff && i != city.ID)
					{
						...
						if (this.oParent.CivState.Cities[i].PlayerID == city.PlayerID &&
							(this.oParent.CivState.Cities[i].BuildingFlags0 & 0x1) != 0 && local_b0 < (short)this.Var_6b30)
						{
			...
			L073e:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].TypeID != 0 ||
					this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].HomeCityID != cityID)
					goto L073a;
			...
			L09f3:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].TypeID == -1)
					goto L09ef;

				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].HomeCityID != cityID)
					goto L09ef;

				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].TypeID >= 26)
					goto L0b2b;
			...
			L0a8d:
				if (this.oParent.CivState.UnitDefinitions[this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].TypeID].AttackStrength == 0)
					goto L0b2b;

				if (this.oParent.CivState.UnitDefinitions[this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].TypeID].TerrainCategory == 1)
					goto L0b27;

				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.X == city.Position.X)
					goto L0afe;

				goto L0b27;

			L0afe:
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.Y == city.Position.Y)
					goto L0b2b;
			...
			L0cd4:
				...
				if (((cityID + this.oParent.CivState.TurnCount) & 0x3) != 0)
					goto L0d1b;
			...
			L0e7a:
				if (local_50 == (short)this.oParent.Var_e8b8 || local_50 == 0)
					goto L1292;
			...
			L12c2:
				...
				city.FoodCount += (short)(this.oParent.Var_70da_Arr[0] - (local_48 * (short)this.oParent.Var_e3c6) - (city.ActualSize * 2));
				...
				if (city.CurrentProductionID == 0x1a)
				{
					...
					for (int i = 0; i < 128; i++)
					{
						if (this.oParent.CivState.Cities[i].PlayerID != this.oParent.CivState.HumanPlayerID || this.oParent.CivState.Cities[i].StatusFlag != 0xff)
						{
							...
							this.oParent.Var_6c9a = (ushort)((short)Math.Abs((short)this.oParent.Var_6c9a - 3));
							...
							if (local_c8 > (short)this.oParent.Var_6c9a ||
								(local_c8 == (short)this.oParent.Var_6c9a && this.oParent.MSCAPI.RNG.Next(++local_106) == 0))
							{
			...
			L1f41:
				if (this.oParent.CivState.AISpaceshipSuccessRate >= 40) goto L1f4b;
				goto L1ffa;
			...
			L1f6d:
				if (this.oParent.CivState.AISpaceshipSuccessRate <= 75) goto L1f77;
				goto L1feb;

			L1f77:
				if (this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Ranking >
					this.oParent.CivState.Players[this.Var_6548_PlayerID].Ranking) goto L1feb;
				...
				this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.Var_6548_PlayerID].SpaceshipETAYear;
				this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.Year);
				this.oCPU.CX.Word = (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].SpaceshipETAYear;
				this.oCPU.CX.Word = this.oCPU.SUBWord(this.oCPU.CX.Word, (ushort)this.oParent.CivState.Year);
			...
			L1fc5:
				...
				if (this.oParent.CivState.Players[this.oParent.CivState.ActiveCivilizations].Coins <= 1000) goto L1ff7;
			...
			L2025:
				...
				this.oParent.CivState.Cities[local_4c].BuildingFlags0 &= 0xfffe;
				this.oParent.CivState.Cities[local_4c].BuildingFlags1 &= 0xffff;
			...
			L205a:
				...
				if ((this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Diplomacy[this.Var_6548_PlayerID] & 0x40) == 0)
					goto L212c;
			...
			L2181:
				...
				this.oCPU.CMPByte(this.oParent.CivState.Cities[local_4c].StatusFlag, 0xff);
			...
			L219d:
				...
				this.oCPU.AX.Low = (byte)this.oParent.CivState.Cities[local_4c].ActualSize;
				this.oParent.CivState.Cities[local_4c].VisibleSize = (sbyte)this.oCPU.AX.Low;

				this.oParent.CivState.MapVisibility[this.oParent.CivState.Cities[local_4c].Position.X,
					this.oParent.CivState.Cities[local_4c].Position.Y] |= (ushort)(1 << this.Var_6548_PlayerID);

				// Instruction address 0x1d12:0x2204, size: 5
				this.oParent.Segment_2aea.F0_2aea_1601(
					this.oParent.CivState.Cities[local_4c].Position.X,
					this.oParent.CivState.Cities[local_4c].Position.Y);
			...
			L2336:
				...
				if (this.oCPU.AX.Word >= this.oParent.CivState.Players.Length)
				{
					this.oCPU.AX.Word = 0;
				}
				else
				{
					this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.oCPU.AX.Word].Continents[this.Var_6548_PlayerID].Strategy;
				}
			...
			L237e:
				...
				{
					if (this.oParent.CivState.UnitDefinitions[city.CurrentProductionID].UnitCategory == local_104)
					{
			...
			L2416:
				this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.Var_6548_PlayerID].Coins;
			...
			L25af:
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].ActiveUnits[25] != 0)
					goto L2619;
			...
			L2619:
				this.oCPU.CMPWord((ushort)this.oParent.CivState.Players[this.Var_6548_PlayerID].Coins, 0x7d0);
			...
			L277e:
				...
				this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX,
					(ushort)this.oParent.CivState.Players[this.Var_6548_PlayerID].GovernmentType);
			...
			L2848:
				...
				this.oCPU.AX.Low = (byte)this.oParent.CivState.Cities[local_4c].BaseTrade;
				this.oCPU.CBW(this.oCPU.AX);
			...
			L28d9:
				...
				this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
					((this.oParent.CivState.Players[this.Var_6548_PlayerID].TaxRate * (this.oParent.Var_70da_Arr[2] - (short)this.oParent.Var_d2e0)) + 5) / 10,
			...
			L2aeb:
				...
				this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.Var_6548_PlayerID].GovernmentType;
				this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
				this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, this.oCPU.DX.Word);
				this.oCPU.AX.Word = this.oCPU.SARWord(this.oCPU.AX.Word, 0x1);
				this.oCPU.AX.Word = this.oCPU.INCWord(this.oCPU.AX.Word);
				...
				this.oCPU.AX.Word += (ushort)this.oParent.CivState.Players[this.Var_6548_PlayerID].CityCount;
				...
				this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.DifficultyLevel);
			...
			L2ef3:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].GovernmentType < 4) goto L2f08;
				goto L3088;
			...
			L3031:
				if (this.oParent.CivState.UnitDefinitions[city.Unknown[local_ba] & 0x3f].AttackStrength != 0)
				{
					local_e6++;
				}
			...
			L33f1:
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].GovernmentType > 1) goto L3401;
				goto L340f;
			...
			L3447:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].GovernmentType >= 4) goto L3463;
				goto L3672;
			...
			L347b:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_106].TypeID == -1)
					goto L3477;

				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_106].HomeCityID != cityID)
					goto L3477;

				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_106].TypeID >= 26)
					goto L3477;
				...
				this.oParent.Segment_2dc4.F0_2dc4_0289_GetShortestDistance(
					city.Position.X,
					city.Position.Y,
					this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_106].Position.X,
					this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_106].Position.Y);
			...
			L3555:
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].DiscoveredTechnologyCount <
			...
			L372a:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].GovernmentType >= 4) goto L3769;
				goto L384a;
			...
			L3769:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.X !=
					city.Position.X)
					goto L380d;

				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.Y ==
					city.Position.Y)
					goto L384a;
			...
			L384a:
				...
				this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
					local_f6, local_fc,
					this.oCPU.ReadUInt16(this.oCPU.DS.Word,
						(ushort)(((this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].TypeID +
							(this.Var_6548_PlayerID << 5) + 0x40) << 1) + 0xd4ce)));

				// Instruction address 0x1d12:0x38a3, size: 5
				F0_1d12_73ea(
					this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.X,
					this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.Y,
					7);
			...
			L38d4:
				...
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.X != local_d8)
					goto L3371;

				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].Position.Y != local_e4)
					goto L3371;
				...
				this.oParent.Segment_2459.F0_2459_08c6_GetCityName(this.oParent.CivState.Players[this.Var_6548_PlayerID].Units[local_ea].HomeCityID);
			...
			L3a53:
				this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word,
					(ushort)this.oParent.CivState.Nations[this.oParent.CivState.Players[this.Var_6548_PlayerID].NationalityID].Ideology);
				this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.Var_6546);
			...
			L3ad3:
				...
				if (this.oParent.CivState.WonderCityID[local_bc + 1] != cityID)
					goto L3b7d;
			...
			L3d1b:
				this.oCPU.AX.Word = (ushort)((short)this.oParent.CivState.UnitDefinitions[city.CurrentProductionID].Cost);
			...
			L3d36:
				...
				this.oCPU.AX.Word = (ushort)((short)this.oParent.CivState.BuildingDefinitions[-city.CurrentProductionID].Price);
			...
			L460c:
				...
				this.oParent.MSCAPI.strcat(0xba06,
					this.oParent.MSCAPI.itoa((short)((city.BaseTrade + this.oParent.CivState.Cities[local_4c].BaseTrade + 4) / 8), 10));
			...
			L46bb:
				...
				this.oParent.MSCAPI.strcat(0xba06,
					this.oParent.MSCAPI.itoa((short)(((short)city.BaseTrade +
						(short)this.oParent.CivState.Cities[local_4c].BaseTrade + 4) >> 4),
						10));
			...
			L497e:
				if (this.oParent.CivState.Players[this.Var_6548_PlayerID].UnitCount >= 127)
				{
					local_c0 = 1;
				}
			...
			L605f:
				this.oCPU.AX.Word = this.oParent.Var_e17a;
				this.oParent.CivState.Players[this.Var_6548_PlayerID].Coins += (short)this.oCPU.AX.Word;
