...
namespace OpenCiv1
{
	public class Overlay_22
	{
		...
		L0096:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.TESTByte(this.oParent.CivState.Cities[cityID].StatusFlag, 0x20);
		...
		L02d5:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.CMPWord((ushort)this.oParent.CivState.Cities[cityID].ShieldsCount, 0x0);
		...
		L0341:
			...
			this.oParent.MSCAPI.strcpy(0xba06,
				this.oParent.CivState.BuildingDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x22)) + 1].Name);
		...
		L03c9:
			// Instruction address 0x0000:0x03e5, size: 5
			this.oParent.MSCAPI.strcpy(0xba06, this.oParent.CivState.BuildingDefinitions[-this.oParent.CivState.Cities[cityID].CurrentProductionID].Name);
		...
		L04a4:
			...
			this.oCPU.CMPWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.Players[playerID].Coins);
			if (this.oCPU.Flags.G) goto L054b;
		...
		L059e:
			...
			this.oParent.Segment_2aea.F0_2aea_11d4(this.oParent.CivState.Cities[cityID].Position.X, this.oParent.CivState.Cities[cityID].Position.Y);
		...
		L065b:
			...
			this.oCPU.CX.Word = this.oCPU.INCWord(this.oCPU.CX.Word);
			this.oCPU.IDIVWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.Word);
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)((short)this.oParent.CivState.UnitDefinitions[this.oParent.CivState.Players[playerID].Units[unitID].TypeID].Cost));
