...
namespace OpenCiv1
{
	public class GameReplay
	{
		...
		L0671:
			this.oCPU.TESTByte(this.oParent.CivState.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))], 0xf0);
		...
		L06e8:
			this.oCPU.TESTByte(this.oParent.CivState.ReplayData[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))], 0xf);
