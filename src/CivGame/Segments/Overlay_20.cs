...
namespace OpenCiv1
{
	public class Overlay_20
	{
		...
		L05da:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.TESTWord(this.oParent.CivState.Cities[cityID].BuildingFlags0, 0xfffe);
		...
		L06b9:
			this.oCPU.TESTWord(this.oParent.CivState.Cities[cityID].BuildingFlags0, 0x100);
		...
		L06dd:
			...
			this.oCPU.CMPByte((byte)this.oParent.CivState.Cities[cityID].ActualSize, 0x0);
		...
		L070d:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.TESTWord(this.oParent.CivState.Cities[cityID].BuildingFlags0, 0x80);
		...
		L0759:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.TESTWord(this.oParent.CivState.Cities[cityID].BuildingFlags0, 0x8);
		...
		L07b6:
			this.oCPU.TESTWord(this.oParent.CivState.Cities[cityID].BuildingFlags0, 0x4);
		...
		L096d:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.TESTWord(this.oParent.CivState.Cities[cityID].BuildingFlags0, 0x40);
		...
		L0cd9:
			...
			this.oCPU.TESTWord((ushort)this.oParent.CivState.SpaceshipFlags, 0x100);
		...
		L0db8:
			...
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, (ushort)((short)this.oParent.Var_70e4));
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, (ushort)((short)this.oParent.Var_e8b8));
		...
		L0e3c:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x10)));
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.CMPByte(this.oParent.CivState.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x10))].StatusFlag, 0xff);
		...
		L1118:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.CivState.PollutedSquareCount);
			this.oParent.CivState.Players[0].Score -= (short)this.oCPU.AX.Word;
		...
		L11e3:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].FutureTechnologyCount);
			this.oParent.CivState.Players[0].Score += (short)this.oCPU.AX.Word;
		...
		L1269:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.CivState.AIOpponentCount);
			this.oCPU.CX.Word = 0x226;
			this.oCPU.CX.Word = this.oCPU.SUBWord(this.oCPU.CX.Word, (ushort)this.oParent.CivState.TurnCount);
