...
namespace OpenCiv1
{
	public class MeetWithKing
	{
		...
		L0091:
			this.oCPU.CMPWord((ushort)this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].CityCount, this.oCPU.AX.Word);
		...
		L0131:
			...
			this.oCPU.CMPWord((ushort)this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].CityCount, 0x1);
		...
		L01f5:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.CivState.Players[playerID].MilitaryPower);
			this.oCPU.CMPWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].MilitaryPower);
		...
		L0417:
			...
			this.oCPU.AX.Word = this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6));
			this.oCPU.CMPWord((ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Coins, this.oCPU.AX.Word);
		...
		L04df:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))] & 3) == 1)
			{
				...
				this.oCPU.CMPWord((ushort)this.oParent.CivState.Players[playerID].MilitaryPower, this.oCPU.AX.Word);
		...
		L124d:
			...
			this.oCPU.CMPWord(this.oCPU.AX.Word, (ushort)this.oParent.CivState.ActiveCivilizations);
