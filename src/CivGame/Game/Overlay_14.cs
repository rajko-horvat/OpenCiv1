...
namespace OpenCiv1
{
	public class Overlay_14
	{
		...
		public void F14_0000_014b(short playerID)
		{
			...
			this.oCPU.AX.Word = (ushort)oParent.GameData.DifficultyLevel;
		...
		L0281:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oStaticGameData.Technologies[this.oGameData.Players[this.oGameData.HumanPlayerID].CurrentResearchID].Name);
		...
		L0355:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 
				this.oStaticGameData.Technologies[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))].Name);
		...
		L03f1:
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0(
				this.oStaticGameData.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].Name,
				36,
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(this.oStaticGameData.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].AttackStrength, 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(this.oStaticGameData.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].DefenseStrength, 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(this.oStaticGameData.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].MoveCount, 10));
		...
		L0680:
			...
			this.oParent.Segment_1182.F0_1182_005c_DrawStringToScreen0(
				this.oStaticGameData.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))].Name,
				36,
		...
		L0980:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.Word, this.oCPU.SI.Word,
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.Word, this.oCPU.SI.Word),
					(ushort)((short)this.oStaticGameData.ImprovementDefinitions(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x3c)) + 1).MaintenanceCost)));
		...
		L0b36:
			...
			this.oCPU.CX.Word = (ushort)oParent.GameData.DifficultyLevel;
		...
		L0bd9:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(
					...
					this.oStaticGameData.ImprovementDefinitions(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x3c)) + 1).MaintenanceCost, 10));
		...
		L0bf6:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oStaticGameData.ImprovementDefinitions(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x3c)) + 1).Name);
		...
		L0d9f:
			...
			this.oCPU.BX.Word = (ushort)this.oGameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].GovernmentType;
			this.oCPU.BX.Word = this.oCPU.SHL_UInt16(this.oCPU.BX.Word, 0x1);
		...
		public void F14_0000_1164(short playerID)
		{
			...
			if (this.oStaticGameData.Nations[this.oGameData.Players[playerID].NationalityID].Mood == 1)
			{
			...
			if (this.oStaticGameData.Nations[this.oGameData.Players[playerID].NationalityID].Policy == 1)
			{
			...
			if (this.oStaticGameData.Nations[this.oGameData.Players[playerID].NationalityID].Ideology == 1)
			{
		...
		L1892:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 
				this.oStaticGameData.ImprovementDefinitions(-this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].CurrentProductionID).Name);
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(
					10 * this.oStaticGameData.ImprovementDefinitions(-this.oGameData.Cities[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].CurrentProductionID).Price,
				10));
		...
		L1adf:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 
				this.oStaticGameData.UnitDefinitions[this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].CurrentProductionID].Name);
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(
					10 * this.oStaticGameData.UnitDefinitions[this.oGameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))].CurrentProductionID].Price, 10));
