...
namespace OpenCiv1
{
	public class Segment_2517
	{
		...
		L004c:
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.CityWorker.F0_1d12_6c97_PlayerHasWonder(playerID, WonderEnum.Pyramids) ? 1 : 0);
		...
		L00e9:
			this.oCPU.TEST_UInt8((byte)(this.oParent.CivState.TurnCount & 0xff), 0xf);
		...
		L02e4:
			...
			this.oCPU.AX.Word = this.oCPU.SHL_UInt16(this.oCPU.AX.Word, 0x1);
			this.oCPU.CMP_UInt16(this.oCPU.AX.Word, (ushort)this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].MilitaryPower);
		...
		L0541:
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, TechnologyEnum.Democracy) ? 1 : 0);
			this.oCPU.AX.Word = this.oCPU.OR_UInt16(this.oCPU.AX.Word, this.oCPU.AX.Word);
			if (this.oCPU.Flags.E)
				goto L058d;
		...
		L05e9:
			this.oCPU.AX.Word = (ushort)governmentType;
			this.oCPU.CMP_UInt16((ushort)this.oParent.CivState.Players[playerID].GovernmentType, this.oCPU.AX.Word);
		...
		L080a:
			...
			this.oCPU.AX.Low = this.oCPU.ADD_UInt8(this.oCPU.AX.Low, (byte)(oParent.CivState.TurnCount & 0xff));
		...
		L0821:
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.CityWorker.F0_1d12_6c97_PlayerHasWonder(playerID2, WonderEnum.GreatWall) ? 1 : 0);
		...
		L087e:
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.CityWorker.F0_1d12_6c97_PlayerHasWonder(playerID1, WonderEnum.GreatWall) ? 1 : 0);
		...
		L0d5b:
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(playerID1,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)), playerID2);
			
			// Instruction address 0x2517:0x0d84, size: 5
			this.oParent.Segment_1ade.F0_1ade_1d2e(playerID2,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)), playerID1);
