...
namespace OpenCiv1
{
	public class Help
	{
		...
		L0211:
			...
			this.oParent.MapManagement.F0_2aea_1585(this.oParent.CivState.Players[playerID].Units[unitID].Position.X, this.oParent.CivState.Players[playerID].Units[unitID].Position.Y);
