...
namespace OpenCiv1
{
	public class Segment_1866
	{
		...
		L0605:
			...
			if (this.oParent.CivState.UnitDefinitions[this.oParent.CivState.Players[this.oCPU.ReadInt16(this.oCPU.DS.Word, 0xd7f0)].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].TypeID].TerrainCategory == UnitCategoryEnum.Air)
				goto L02e2;
		...
		L06f3:			
			...
			if (this.oParent.CivState.UnitDefinitions[this.oParent.CivState.Players[this.oCPU.ReadInt16(this.oCPU.DS.Word, 0xd7f0)].Units[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].TypeID].TerrainCategory != UnitCategoryEnum.Ocean)
				goto L0760;
		...
		L0b75:
			...
			this.oParent.MapManagement.F0_2aea_03ba(this.oParent.CivState.Players[playerID].Units[unitID].Position.X, this.oParent.CivState.Players[playerID].Units[unitID].Position.Y);
		...
		public void F0_1866_1169(short playerID, short unitID)
		{
			...
			if (this.oParent.CivState.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].TerrainCategory != UnitCategoryEnum.Ocean)
				goto L124b;
		...
		L11b7:
			...
			if (this.oParent.CivState.UnitDefinitions[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))].TerrainCategory != UnitCategoryEnum.Land)
				goto L1202;
		...
		L1d8b:
			...
			if (this.oParent.CivState.UnitDefinitions[this.oParent.CivState.Players[playerID].Units[this.oParent.CivState.Players[playerID].Units[unitID].NextUnitID].TypeID].TerrainCategory != UnitCategoryEnum.Ocean)
				goto L1e61;
