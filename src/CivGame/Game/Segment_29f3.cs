...
namespace OpenCiv1
{
	public class Segment_29f3
	{
		...
		L013c:
			...
			if (this.oParent.CivState.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe))].TerrainCategory == UnitCategoryEnum.Air)
				goto L0152;

			if (this.oParent.CivState.UnitDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe))].TerrainCategory != UnitCategoryEnum.Ocean)
				goto L0165;
