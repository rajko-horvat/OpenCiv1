...
namespace OpenCiv1
{
	public class CityWorker
	{
		...
		public ushort F0_1d12_0045_ProcessCityState(short cityID, short flag)
		{
					...
					if (this.oGameData.Cities[i].StatusFlag != 0xff && i != city.ID)
					{
						...
						if (local_b0 <= 5)
						{
							for (int j = 0; j < 21; j++)
							{
								...
								{
									int xPos = this.oGameData.Cities[i].Position.X + this.oStaticGameData.CityOffsets[j].X;
									int yPos = this.oGameData.Cities[i].Position.Y + this.oStaticGameData.CityOffsets[j].Y;
			...
			L045f:
				...
				if (flag == 1)
				{
					...
					{
						local_c6 = city.Position.X + this.oStaticGameData.CityOffsets[i].X;
						local_d2 = city.Position.Y + this.oStaticGameData.CityOffsets[i].Y;

						if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID ||
							(this.oGameData.Map[local_c6, local_d2].Visibility & (1 << this.Var_6548_PlayerID)) != 0)
						{
							...
							else
							{
								...
								if (Arr_a6[this.oStaticGameData.CityOffsets[i].X + 2, this.oStaticGameData.CityOffsets[i].Y + 2] != 0)
								{
				...
				for (int i = 0; i < 128; i++)
				{
						...
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].HomeCityID == cityID)
					{
						if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID < 26)
						{
							...
							if (this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].AttackStrength != 0)
							{
								if (this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].MovementType == UnitMovementTypeEnum.Sea)
								{
									this.Var_6546++;
								}
								else
				...
				for (int i = 0; i < this.Var_6540_CityOffsetCount; i++)
				{
					...
					if (this.Var_6548_PlayerID != 0 && (this.oGameData.Map[local_c6, local_d2].Visibility & (1 << this.Var_6548_PlayerID)) == 0)
					{
						Arr_3e[i] = 1;
					}
					...
					if (local_e8 != -1 && local_e8 != this.Var_6548_PlayerID)
					{
						Arr_a6[this.oStaticGameData.CityOffsets[i].X + 2, this.oStaticGameData.CityOffsets[i].Y + 2] = 1;
						Arr_3e[i] = 1;
			...
			L12c2:
				...
				if (F0_1d12_6c97_PlayerHasWonder(this.Var_6548_PlayerID, (int)WonderEnum.HooverDam) != 0)
				{
					...
					if (this.oParent.Segment_2aea.F0_2aea_1942_GetGroupID(city.Position.X, city.Position.Y) ==
				...
				if (flag == 0)
				{
					...
					{
						if ((this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].Price * local_4a) <= city.ShieldsCount)
						{
							...
							{
								city.ShieldsCount -= (short)(this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].Price * local_4a);
								...
								if (this.Var_6548_PlayerID != this.oGameData.HumanPlayerID && local_ba != -1)
								{
									...
									if (city.CurrentProductionID == 26)
									{
										...
										else
										{
											...
											if (local_ba != -1)
											{
												this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].GoToPosition.X = this.oGameData.Cities[local_b0].Position.X;
												this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].GoToPosition.Y = this.oGameData.Cities[local_b0].Position.Y;
											}
										}
									}
								...
								else
								{
									...
									if (local_ba != -1 && (city.CurrentProductionID == 0 || city.CurrentProductionID >= 26))
									{
										...
										this.oParent.MSCAPI.strcat(0xba06,
											this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].Name);
					...
					{
						if ((this.oStaticGameData.ImprovementDefinitions(-city.CurrentProductionID).Price * local_4a) <= city.ShieldsCount)
						{
							...
							if (local_e8 != -1)
							{
								...
								city.ShieldsCount -= (short)(this.oStaticGameData.ImprovementDefinitions(-city.CurrentProductionID).Price * local_4a);
								...
								if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) != 0 || local_e8 > 24)
								{
									...
									{
										this.oGameData.Map[city.Position.X, city.Position.Y].Visibility = 0xffff;
									}
									else
									{
										this.oParent.Var_b1e8 = 1;
									...
									this.oParent.MSCAPI.strcat(0xba06, this.oStaticGameData.ImprovementDefinitions(local_e8).Name);
								...
								if (local_e8 >= 22 && local_e8 <= 24 && ((1 << this.Var_6548_PlayerID) & (ushort)this.oGameData.SpaceshipFlags) == 0)
								{
									...
									else
									{
										...
										{
											city.ShieldsCount += (short)(this.oStaticGameData.ImprovementDefinitions(local_e8).Price * local_4a);
									...
									for (int i = 0; i < 128; i++)
									{
										if (this.oGameData.Cities[i].StatusFlag != 0xff && this.oGameData.Cities[i].PlayerID != this.Var_6548_PlayerID)
										{
											...
											this.oGameData.Map[this.oGameData.Cities[i].Position.X,
												this.oGameData.Cities[i].Position.Y].Visibility |= 1 << this.Var_6548_PlayerID;
				...
				L2307:
					if ((this.oGameData.PlayerFlags & (1 << this.Var_6548_PlayerID)) == 0)
					{
						...
						local_104 = this.oGameData.Players[this.oParent.Segment_2aea.F0_2aea_1942_GetGroupID(local_d8, local_e4) & 0x7].Continents[this.Var_6548_PlayerID].Strategy;

						if ((local_104 == 1 || local_104 == 2 || local_104 == 5) && local_e8 != 0 && city.CurrentProductionID >= 0 &&
							this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].UnitCategory == local_104)
						{
						...
						if ((city.StatusFlag & 0x1) != 0 && city.CurrentProductionID < 0 && city.ShieldsCount != 0)
						{
							...
							local_cc = this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
								(this.oStaticGameData.ImprovementDefinitions(-city.CurrentProductionID).Price * local_4a) - city.ShieldsCount,
						...
						if (((short)this.oCPU.AX.Word == -1 || (city.StatusFlag & 0x10) != 0) && city.CurrentProductionID >= 0 && city.ShieldsCount != 0)
						{
							...
							local_cc = this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
								(this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].Price * local_4a) - city.ShieldsCount,
				...
				if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType < 4)
				{
					...
					while (local_ba != -1)
					{
						...
						if (this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].TypeID].AttackStrength != 0)
						{
							local_e6++;
							...
							if (flag == 1 && this.Var_2496 == 1 && local_e6 <= 3)
							{
								...
								this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
									...
									this.oCPU.ReadUInt16(this.oCPU.DS.Word,
										(ushort)(((this.oGameData.Players[this.Var_6548_PlayerID].Units[local_ba].TypeID +
					...
					for (int i = 0; i < 2; i++)
					{
						if (this.oParent.Var_70e4 != 0 && city.Unknown[i] != -1 && this.oStaticGameData.UnitDefinitions[city.Unknown[i] & 0x3f].AttackStrength != 0)
						{
							local_e6++;
						}
					}
				...
				if (F0_1d12_6c97_PlayerHasWonder(this.Var_6548_PlayerID, (int)WonderEnum.JSBachsCathedral) != 0)
				{
					...
					if (this.oParent.Segment_2aea.F0_2aea_1942_GetGroupID(local_d8, local_e4) == 
						this.oParent.Segment_2aea.F0_2aea_1942_GetGroupID(
			...
			L32e0:
						...
						this.oGameData.Players[this.Var_6548_PlayerID].Units[i].HomeCityID == cityID)
					{
								...
								this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType >= 4))
							{
								...
								if (this.oParent.Var_70da_Arr[1] >= this.oParent.Var_d2f6)
								{
										...
										this.oGameData.Players[this.oGameData.HumanPlayerID].DiscoveredTechnologyCount)
									{
										...
										this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_108].TypeID].MovementType == UnitMovementTypeEnum.Land &&
								...
								else
								{
									if (this.Var_6548_PlayerID == this.oGameData.HumanPlayerID)
									{
										...
										this.oParent.MSCAPI.strcat(0xba06,
											this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[local_108].TypeID].Name);
						...
						if (flag == 1)
						{
							if (this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID < 26)
							{
								...
								else
								{
									...
									if (this.oGameData.Players[this.Var_6548_PlayerID].GovernmentType >= 4)
									{
										if (this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].AttackStrength != 0 &&
											local_e8 != 0 &&
											(this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID].MovementType == UnitMovementTypeEnum.Sea ||
							...
							this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
								local_f6, local_fc,
								this.oCPU.ReadUInt16(this.oCPU.DS.Word,
									(ushort)(((this.oGameData.Players[this.Var_6548_PlayerID].Units[i].TypeID +
										(this.Var_6548_PlayerID << 5) + 0x40) << 1) + 0xd4ce)));
				...
				if (flag == 0)
				{
					...
					if (city.HasImprovement(ImprovementEnum.MarketPlace))
					{
						this.oParent.Var_db42 -= (5 - this.oStaticGameData.Nations[this.oGameData.Players[this.Var_6548_PlayerID].NationalityID].Ideology) * this.Var_6546;
					}
					else
					{
						this.oParent.Var_db42 -= (7 - this.oStaticGameData.Nations[this.oGameData.Players[this.Var_6548_PlayerID].NationalityID].Ideology) * this.Var_6546;
					}
				}
				...
				if (flag == 1)
				{
					...
					if (local_da == 0)
					{
						for (int i = 0; i < 21; i++)
						{
							if (this.oGameData.WonderCityID[i + 1] == cityID)
							{
								...
								this.oParent.MSCAPI.strcpy(0xba06, this.oStaticGameData.Wonders[i + 1].Name);
					...
					for (int i = local_da; i < 24; i++)
					{
						if (city.HasImprovement(City.BitToImprovementEnum(i)))
						{
							...
							else
							{
								...
								this.oParent.MSCAPI.strcpy(0xba06, this.oStaticGameData.ImprovementDefinitions(i + 1).Name);
					...
					if (city.CurrentProductionID >= 0)
					{
						local_de = this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].Price;
					}
					else
					{
						local_de = this.oStaticGameData.ImprovementDefinitions(-city.CurrentProductionID).Price;
					}
					...
					else
					{
						...
						this.oParent.MSCAPI.strcpy(0xba06, this.oStaticGameData.ImprovementDefinitions(-city.CurrentProductionID).Name);
					...
					L4bf7:
						if (city.CurrentProductionID >= 0)
						{
							local_106 = this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].Price;
						...
						{
							local_106 = this.oStaticGameData.ImprovementDefinitions(-city.CurrentProductionID).Price;
						...
						if (city.CurrentProductionID >= 0)
						{
							...
							this.oParent.MSCAPI.strcat(0xba06, this.oStaticGameData.UnitDefinitions[city.CurrentProductionID].Name);
						}
						else
						{
							// Instruction address 0x1d12:0x4d3e, size: 5
							this.oParent.MSCAPI.strcat(0xba06, this.oStaticGameData.ImprovementDefinitions(-city.CurrentProductionID).Name);
						}
						...
						if (this.oParent.Segment_2d05.F0_2d05_0031(0xba06, 100, 80, 1) == 0 && this.oGameData.Players[this.Var_6548_PlayerID].Coins >= local_e8)
						{
						...
						if (local_fc == '\n' || local_fc == ' ')
						{
							if ((this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].Status & 0x9) != 0)
							{
								this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].RemainingMoves =
									(short)(this.oStaticGameData.UnitDefinitions[this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].TypeID].MoveCount * 3);
							}

							this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].Status &= 0x30;
							this.oGameData.Players[this.Var_6548_PlayerID].Units[Arr_74[local_106]].GoToPosition.X = -1;
						}
					...
					L55b6:
						if ((this.oGameData.Map[city.Position.X + local_b6, city.Position.Y + local_be].Visibility & (1 << this.oGameData.HumanPlayerID)) == 0) goto L55f5;
						goto L5605;
					...
					L57a5:
						...
						this.oParent.MSCAPI.strcat(0xba06, this.oStaticGameData.ImprovementDefinitions(local_bc + 1).Name);

						// Instruction address 0x1d12:0x57d4, size: 5
						this.oParent.MSCAPI.strcat(0xba06, " for ");

						// Instruction address 0x1d12:0x5802, size: 5
						this.oParent.MSCAPI.strcat(0xba06, this.oParent.MSCAPI.itoa(10 * this.oStaticGameData.ImprovementDefinitions(local_bc + 1).Price, 10));
					...
					L5844:
						this.oGameData.Players[this.Var_6548_PlayerID].Coins += (short)(10 * this.oStaticGameData.ImprovementDefinitions(local_bc + 1).Price);
					...
					L5aa6:
						...
						if ((this.oGameData.Map[city.Position.X + this.oStaticGameData.CityOffsets[local_ea].X, city.Position.Y + this.oStaticGameData.CityOffsets[local_ea].Y].Visibility &
					...
					L5b13:
						...
						if (Arr_a6[this.oStaticGameData.CityOffsets[local_ea].X + 2, this.oStaticGameData.CityOffsets[local_ea].Y + 2] != 0)
							goto L12c2;
					...
					L5bf6:
						...
						local_cc = F0_1d12_6abc_GetCityResourceCount(this.Var_6548_PlayerID, this.Var_653e_CityID,
							city.Position.X + this.oStaticGameData.CityOffsets[local_ea].X, city.Position.Y + this.oStaticGameData.CityOffsets[local_ea].Y, local_bc);
					...
					L5c45:
						...
						this.oParent.Segment_2aea.F0_2aea_03ba(
							city.Position.X + this.oStaticGameData.CityOffsets[local_ea].X,
							city.Position.Y + this.oStaticGameData.CityOffsets[local_ea].Y);
			...
			L6545:
				...
				local_c6 = this.oStaticGameData.CityOffsets[local_e8].X + local_d8;
				local_d2 = this.oStaticGameData.CityOffsets[local_e8].Y + local_e4;

				// Instruction address 0x1d12:0x6581, size: 5
				if ((this.oParent.Segment_2aea.F0_2aea_1585_GetImprovements(local_c6, local_d2) & 0x40) == 0) goto L6590;
				goto L6640;

			L6590:
				// Instruction address 0x1d12:0x6598, size: 5
				if (this.oParent.Segment_2aea.F0_2aea_134a_GetMapLayer1_TerrainType(local_c6, local_d2) != TerrainTypeEnum.Water) goto L65a8;
				goto L6640;

			L65a8:
				// Instruction address 0x1d12:0x65b0, size: 5
				if ((this.oParent.Segment_2aea.F0_2aea_1585_GetImprovements(local_c6, local_d2) & 0x1) == 0) goto L65bf;
				goto L6640;
			...
			L65bf:
				...
				this.oParent.Segment_2aea.F0_2aea_0008(this.oGameData.HumanPlayerID, local_c6 - 8, local_d2 - 6);
			...
			L6691:
				...
				this.oParent.Segment_2aea.F0_2aea_0008(this.oGameData.HumanPlayerID, local_d8 - 8, local_e4 - 6);
			...
			L677e:
				this.oGameData.Players[this.Var_6548_PlayerID].Coins -= (short)this.oStaticGameData.ImprovementDefinitions(local_bc + 1).MaintenanceCost;
		...
		private int F0_1d12_000a_FindCityOffset(GPoint point)
		{
			...
			for (int i = 0; i < 21; i++)
			{
				if (this.oStaticGameData.CityOffsets[i].Equals(point))
				{
					return i;
				}
			}
		...
		private void F0_1d12_692d_CityResources(short cityID, int cityOffset, short flag)
		{
			...
			// function body
			int local_4;
			int local_6 = this.oGameData.Cities[cityID].Position.X + this.oStaticGameData.CityOffsets[cityOffset].X;
			int local_8;
			int local_a = this.oGameData.Cities[cityID].Position.Y + this.oStaticGameData.CityOffsets[cityOffset].Y;
			int local_c;
			int local_e = 0;
			int local_10 = 0;
			...
			for (int i = 0; i < 3; i++)
			{
				...
				while (flag == 1 && local_c > 0)
				{
					...
					this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
						161 + (this.oStaticGameData.CityOffsets[cityOffset].X * 16) + local_4,
						57 + (this.oStaticGameData.CityOffsets[cityOffset].Y * 16) + local_8,
						this.oCPU.ReadUInt16(this.oCPU.DS.Word, (ushort)(((i + 8) << 1) + 0xd4ce)));
			...
			if (flag == 1 && local_10 == 0)
			{
				...
				this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(this.oParent.Var_aa_Rectangle,
					165 + (this.oStaticGameData.CityOffsets[cityOffset].X * 16),
					61 + (this.oStaticGameData.CityOffsets[cityOffset].Y * 16),
					this.oCPU.ReadUInt16(this.oCPU.DS.Word, (ushort)((0xd << 1) + 0xd4ce)));
			}
		...
		public int F0_1d12_6abc_GetCityResourceCount(int playerID, int cityID, int xPos, int yPos, int resourceType)
		{
			...
			if (this.oParent.Segment_2aea.F0_2aea_1326_CheckMapBounds(xPos, yPos) != 0)
			{
				...
				if (!this.oGameData.Map[xPos, yPos].HasSpecialResource)
				{
					...
					{
						case 0:
							resourceCount = this.oStaticGameData.Terrains[local_6].Food;
							break;

						case 1:
							resourceCount = this.oStaticGameData.Terrains[local_6].Production;
							break;

						case 2:
							resourceCount = this.oStaticGameData.Terrains[local_6].Trade;
							break;
				...
				else
				{
					...
					{
						case 0:
							resourceCount = this.oStaticGameData.Terrains[12 + local_6].Food;
							break;

						case 1:
							resourceCount = this.oStaticGameData.Terrains[12 + local_6].Production;
							break;

						case 2:
							resourceCount = this.oStaticGameData.Terrains[12 + local_6].Trade;
							break;
				...
				local_4 = (short)this.oParent.Segment_2aea.F0_2aea_1585_GetImprovements(xPos, yPos);
				...
				if (local_6 != 10)
				{
					...
					{
						resourceCount += -1 - this.oStaticGameData.TerrainMultipliers[local_6].Multi1;
					}

					if (resourceType == 1 && (local_4 & 0x4) != 0)
					{
						resourceCount += -1 - this.oStaticGameData.TerrainMultipliers[local_6].Multi3;
					}
		...
		public ushort F0_1d12_6c97_PlayerHasWonder(short playerID, short wonderID)
		{
			...
			for (i = 1; i < 8; i++)
			{
				...
				ImprovementDefinition wonder = this.oStaticGameData.Wonders[wonderID];
		...
		private short F0_1d12_6cf3_GetWonderCityID(short wonderID)
		{
			...
			for (i = 1; i < 8; i++)
			{
				...
				if (this.oStaticGameData.Wonders[wonderID].ObsoletesAfterTechnology != TechnologyEnum.None &&
					this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology((short)i, (int)this.oStaticGameData.Wonders[wonderID].ObsoletesAfterTechnology) != 0)
				{
					break;
				}
			}
		...
		public void F0_1d12_6d33(int xPos, int yPos)
		{
			...
			if ((this.oParent.Segment_2aea.F0_2aea_1585_GetImprovements(xPos, yPos) & 0x40) == 0)
			{
				// Instruction address 0x1d12:0x6d52, size: 5
				this.oParent.Segment_2aea.F0_2aea_1653_ClearOrSetImprovements(xPos, yPos, 0, 4);

				// Instruction address 0x1d12:0x6d60, size: 5
				this.oParent.Segment_2aea.F0_2aea_1601_UpdateVisiblemprovements(xPos, yPos);
		...
		private void F0_1d12_72b7_DrawCityWorldMap()
		{
			...
			for (int yPos = 0; yPos < 50; yPos++)
			{
				for (int xPos = 0; xPos < 80; xPos++)
				{
					...
					int mapXPos = this.oParent.UnitGoTo.F0_2e31_119b_AdjustXPosition(this.oGameData.Players[this.oGameData.HumanPlayerID].XStart + xPos - 40);
					int mapYPos = yPos;

					if ((this.oGameData.Map[mapXPos, mapYPos].Visibility & (1 << this.oGameData.HumanPlayerID)) != 0)
					{
						...
						if (this.oParent.Segment_2aea.F0_2aea_134a_GetMapLayer1_TerrainType(mapXPos, mapYPos) != TerrainTypeEnum.Water)
						{
