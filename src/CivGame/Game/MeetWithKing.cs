...
namespace OpenCiv1
{
	public class MeetWithKing
	{
		...
		public void F6_0000_0000(short playerID, int xPos, int yPos, ushort param4)
		{
			...
			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[playerID].ContactPlayerCountdown;
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x34), this.oCPU.AX.Word);

			if (this.oParent.CivState.Players[playerID].NationalityID == 14)
			{
			...
			{
				this.oParent.CivState.Players[playerID].ContactPlayerCountdown = this.oParent.CivState.TurnCount;
			}
		...
		L0091:
			this.oCPU.CMP_UInt16((ushort)this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].CityCount, this.oCPU.AX.Word);
			if (this.oCPU.Flags.LE) goto L010c;

			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Attack;
			this.oCPU.SI.Word = this.oCPU.AX.Word;

			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Defense;
			...
			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[oParent.CivState.HumanPlayerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Defense;

			this.oCPU.CX.Word = this.oCPU.AX.Word;
			this.oCPU.DI.Word = this.oCPU.CX.Word;
			
			if (this.oParent.CivState.DifficultyLevel == 0) goto L00fe;
		...
		L010c:
			...
			if (this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Attack == 0)
				goto L0131;
			...
			if (this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Attack == 0)
				goto L0131;
		...
		L0131:
			...
			if (this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].CityCount == 0)
				goto L0182;
			...
			this.oCPU.CMP_UInt16((ushort)this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].CityCount, 0x1);
			if (this.oCPU.Flags.LE) goto L0170;

			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Continents[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Defense;

			this.oCPU.CX.Word = (ushort)this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Defense;
		...
		L0170:
			...
			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Defense;
			goto L01d4;
		...
		L0182:
			...
			if (this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].CityCount == 0)
				goto L01ac;
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.CivState.Players[playerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Attack -
				this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Continents[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26))].Defense);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
		...
		L01da:
			...
			if (this.oParent.CivState.Players[playerID].CityCount > 1) goto L01ef;
			goto L008f;
		...
		L01f5:
			if (this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Ranking != 7 ||
				...
				this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].ActiveUnits[(int)UnitTypeEnum.Nuclear] != 0 ||
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 8) == 0)
				goto L02a0;

			this.oCPU.AX.Word = 0x3;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.CivState.Players[playerID].MilitaryPower);
			this.oCPU.CMP_UInt16(this.oCPU.AX.Word, (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].MilitaryPower);
			if (this.oCPU.Flags.LE) goto L02a0;

		L0267:
			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].ActiveUnits[(int)UnitTypeEnum.Nuclear];
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				...
				10 * this.oParent.CivState.Players[playerID].Ranking, 9999);
		...
		L02a0:
			...
			if (this.oParent.CivState.Players[playerID].ActiveUnits[(int)UnitTypeEnum.Nuclear] == 0) 
				goto L02c1;
			...
			this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] |= 0x80;
		...
		L02c1:
			...
			if (this.oParent.CivState.Players[playerID].ActiveUnits[(int)UnitTypeEnum.Nuclear] == 0) goto L02fb;
		...
		L02fb:
			...
			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[playerID].ActiveUnits[(int)UnitTypeEnum.Nuclear];
		...
		L0321:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.CivState.HumanPlayerID);
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.CX.Word = (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].ActiveUnits[(int)UnitTypeEnum.Nuclear];
		...
		L035c:
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.CityWorker.F0_1d12_6c97_PlayerHasWonder(this.oParent.CivState.HumanPlayerID, WonderEnum.GreatWall) ? 1 : 0);
			
			this.oCPU.AX.Word = this.oCPU.OR_UInt16(this.oCPU.AX.Word, this.oCPU.AX.Word);
			if (this.oCPU.Flags.NE) goto L0384;

			// Instruction address 0x0000:0x0378, size: 5
			this.oCPU.AX.Word = (ushort)(this.oParent.CityWorker.F0_1d12_6c97_PlayerHasWonder(this.oParent.CivState.HumanPlayerID, WonderEnum.UnitedNations) ? 1 : 0);
		...
		L03c2:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) *
					(this.oParent.CivState.DifficultyLevel + 1)) / 32,
				0, 20);

			this.oCPU.CX.Word = 0x32;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.Word);
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6), this.oCPU.AX.Word);
			this.oCPU.SI.Word = (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Coins;
			this.oCPU.CMP_UInt16(this.oCPU.AX.Word, this.oCPU.SI.Word);
		...
		L0417:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 0x80) != 0)
				goto L0452;

			this.oCPU.AX.Word = this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6));
			this.oCPU.CMP_UInt16((ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Coins, this.oCPU.AX.Word);
		...
		L0464:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, 
				(ushort)this.oParent.CivState.Players[playerID].MilitaryPower);
			this.oCPU.CMP_UInt16(this.oCPU.AX.Word, (ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].MilitaryPower);
		...
		L0492:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 0x4) != 0)
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8), 0x0);
			}
		...
		L04b1:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 0x8) != 0)
			{
		...
		L04df:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))] & 3) == 1)
			{
				this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))].MilitaryPower;
				this.oCPU.AX.Word = this.oCPU.SHL_UInt16(this.oCPU.AX.Word, 0x2);
				this.oCPU.CMP_UInt16((ushort)this.oParent.CivState.Players[playerID].MilitaryPower, this.oCPU.AX.Word);
				...
				if (this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))].MilitaryPower >
				...
				if ((this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))] & 0x2) != 0)
				{
		...
		L0544:
			...
			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Nations[this.oParent.CivState.Players[playerID].NationalityID].Mood;
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2a), 
				this.oCPU.SUB_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2a)), this.oCPU.AX.Word));

			if (this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].MilitaryPower <
				 this.oParent.CivState.Players[playerID].MilitaryPower)
			{
				this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2a), 
			...
			this.oCPU.CX.Word = (ushort)((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 2) == 0 ? 1 : 0);
		...
		L05b3:
			...
			if (this.oParent.CivState.Players[(ushort)playerID].GovernmentType < 4)
				goto L0606;
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)), 0x0);
			...
			this.oCPU.AX.Word = 0x3;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX,
				(ushort)this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].MilitaryPower);
			this.oCPU.CX.Word = (ushort)this.oParent.CivState.Players[playerID].MilitaryPower;
		...
		L0606:
			...
			if (this.oParent.CivState.Players[playerID].MilitaryPower <
		...
		L0666:
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.CivState.HumanPlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))) ? 1 : 0);
			this.oCPU.AX.Word = this.oCPU.OR_UInt16(this.oCPU.AX.Word, this.oCPU.AX.Word);
		...
		L0762:
			...
			this.oParent.Segment_2459.F0_2459_06f2(playerID, oParent.CivState.HumanPlayerID);
			...
			this.oParent.Segment_2459.F0_2459_06f2(this.oParent.CivState.HumanPlayerID, playerID);
		...
		L0822:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 2) != 2)
				goto L084e;
		...
		L084e:
			this.oCPU.TEST_UInt8((byte)(this.oParent.CivState.DebugFlags & 0xff), 0x1);
		...
		L0891:
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x30ba),
				this.oParent.CivState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x30))].Nation);
		...
		L092d:
			...
			this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x30))].Diplomacy[this.oParent.CivState.HumanPlayerID] |= 8;
		...
		L0a44:
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x30be),
				this.oParent.CivState.TechnologyDefinitions[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))].Name);
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(playerID, 
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc)), this.oParent.CivState.HumanPlayerID);
		...
		L0ba1:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 1) == 0)
				goto L0bbb;
		...
		L0c13:
			...
			this.oParent.Segment_2517.F0_2517_0aa1_ClearDiplomacyFlags(oParent.CivState.HumanPlayerID, playerID, 2);
		...
		L0cc6:
			if (this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].GovernmentType < 4) goto L0d03;
		...
		L0d03:
			...
			this.oParent.Segment_2517.F0_2517_0aa1_ClearDiplomacyFlags(this.oParent.CivState.HumanPlayerID, playerID, 2);
		...
		L0d3c:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 0xa) != 0)
				goto L0e0e;
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(this.oParent.CivState.HumanPlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)), playerID);
		...
		L0e0e:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				...
				0, this.oParent.CivState.Players[playerID].Coins / 50);
		...
		L0ef6:
			if (this.oParent.CivState.Players[playerID].CityCount <= 1) goto L0f05;
			goto L1041;
		...
		L0f05:
			...
			if ((this.oParent.CivState.Players[(ushort)playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] & 0xa) != 0)
				goto L1041;

			this.oCPU.WriteUInt8(this.oCPU.DS.Word, 0xba06, 0x0);

			// Instruction address 0x0000:0x0f3a, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oParent.MSCAPI.itoa(this.oParent.CivState.Players[playerID].Coins, 10));
		...
		L0f8a:
			...
			this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Coins +=
				this.oParent.CivState.Players[playerID].Coins;
		...
		L0fd1:
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(this.oParent.CivState.HumanPlayerID,
				(TechnologyEnum)this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20)), playerID);
		...
		L1209:
			...
			if (this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].GovernmentType < 4) goto L124d;
		...
		L124d:
			...
			this.oCPU.CMP_UInt16(this.oCPU.AX.Word, (ushort)this.oParent.CivState.ActiveCivilizations);
		...
		L13ca:
			...
			this.oParent.MSCAPI.strcat(0xba06, this.oParent.CivState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))].Nation);
		...
		L144a:
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x30be),
				this.oParent.CivState.Players[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))].Nation);
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))] & 1) != 0)
				goto L1487;
		...
		L1487:
			...
			if ((this.oParent.CivState.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))] & 2) != 0)
				goto L14c1;
		...
		L14c1:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				((this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20))].MilitaryPower / 2) *
					(this.oParent.CivState.Players[playerID].Coins / 100)) / 50,
				2, 9999);
		...
		L15e2:
			...
			this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] |= 0x100;
		...
		L15fa:
			...
			this.oParent.CivState.Players[playerID].Diplomacy[this.oParent.CivState.HumanPlayerID] &= 0xffdf;
			...
			this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Diplomacy[playerID] &= 0xffdf;

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x3934), 0xffff);
			if (this.oCPU.Flags.E) goto L165d;
			
			if (this.oParent.CivState.Players[playerID].CityCount <= 4)
				goto L165d;

			if ((this.oParent.CivState.Players[oParent.CivState.HumanPlayerID].Ranking + 1) >=
				this.oParent.CivState.Players[playerID].Ranking)
				goto L165d;
		...
		L1771:
			...
			this.oParent.Segment_1000.F0_1000_0a32_PlayTune(this.oParent.CivState.Nations[this.oParent.CivState.Players[playerID].NationalityID].ShortTune, 3);
		...
		L17d1:
			...
			this.oParent.Segment_1000.F0_1000_0a32_PlayTune(this.oParent.CivState.Nations[this.oParent.CivState.Players[playerID].NationalityID].LongTune, 3);

			// Instruction address 0x0000:0x180a, size: 5
			this.oParent.Segment_11a8.F0_11a8_0250();

			this.oCPU.BX.Word = (ushort)this.oParent.CivState.Players[playerID].NationalityID;
		...
		public void F6_0000_1a3f(short playerID)
		{
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x30be), this.oParent.CivState.Players[playerID].Nationality);

			// Instruction address 0x0000:0x1a65, size: 5
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x30b8), this.oParent.CivState.Players[this.oParent.CivState.HumanPlayerID].Nationality);
		...
		public void F6_0000_1a99(short playerID)
		{
			...
			this.oParent.Segment_2517.F0_2517_0a30_SetDiplomacyFlags(this.oParent.CivState.HumanPlayerID, playerID, 2);

			this.oParent.CivState.Players[playerID].ContactPlayerCountdown = (short)(this.oParent.CivState.TurnCount + 16);

			if (this.oParent.CivState.DifficultyLevel != 0) goto L1b2e;
		...
		L1d60:
			...
			this.oParent.MSCAPI.strcpy(0xba06, this.oParent.CivState.Players[playerID].Name);
		...
		L1e3e:
			...
			this.oCPU.AX.Word = (ushort)this.oParent.CivState.Players[playerID].GovernmentType;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.AX.Word = this.oCPU.SUB_UInt16(this.oCPU.AX.Word, this.oCPU.DX.Word);
			this.oCPU.AX.Word = this.oCPU.SAR_UInt16(this.oCPU.AX.Word, 0x1);
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, TechnologyEnum.Invention) ? 1 : 0);
			this.oCPU.WriteUInt16(this.oCPU.DS.Word, 0x67ee, this.oCPU.AX.Word);
			
			if (this.oParent.CivState.Players[playerID].GovernmentType != 3) goto L1e85;
		...
		L2244:
			this.oCPU.AX.Word = (ushort)((this.oParent.CivState.Players[playerID].Ranking + 1) >> 1);
		...
		L2374:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe), this.oCPU.AX.Word);
			this.oCPU.SI.Word = (ushort)this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x67f2)].GovernmentType;
			this.oCPU.AX.Word = this.oCPU.SI.Word;
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.AX.Word = this.oCPU.SUB_UInt16(this.oCPU.AX.Word, this.oCPU.DX.Word);
			this.oCPU.AX.Word = this.oCPU.SAR_UInt16(this.oCPU.AX.Word, 0x1);
		...
		L246d:
			this.oCPU.AX.Word = (ushort)((this.oParent.CivState.Players[this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0x67f2)].Ranking + 1) >> 1);
