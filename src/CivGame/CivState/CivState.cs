...
namespace OpenCiv1
{
	public class CivState
	{
		...
		private TerrainDefinition[] aTerrains = new TerrainDefinition[]{
			new TerrainDefinition(TerrainEnum.Desert, "Desert", 1, 2, 0, 1, 0, 1, 14),
			new TerrainDefinition(TerrainEnum.Plains, "Plains", 1, 2, 1, 1, 0, 1, 6),
			new TerrainDefinition(TerrainEnum.Grassland, "Grassland", 1, 2, 2, 1, 0, 1, 10),
			new TerrainDefinition(TerrainEnum.Forest, "Forest", 2, 3, 1, 2, 0, 2, 2),
			new TerrainDefinition(TerrainEnum.Hills, "Hills", 2, 4, 1, 0, 0, 2, 12),
			new TerrainDefinition(TerrainEnum.Mountains, "Mountains", 3, 6, 0, 1, 0, 3, 13),
			new TerrainDefinition(TerrainEnum.Tundra, "Tundra", 1, 2, 1, 0, 0, 0, 7),
			new TerrainDefinition(TerrainEnum.Arctic, "Arctic", 2, 2, 0, 0, 0, 0, 15),
			new TerrainDefinition(TerrainEnum.Swamp, "Swamp", 2, 3, 1, 0, 0, 0, 3),
			new TerrainDefinition(TerrainEnum.Jungle, "Jungle", 2, 3, 1, 0, 0, 0, 11),
			new TerrainDefinition(TerrainEnum.Ocean, "Ocean", 1, 2, 1, 0, 2, 0, 1),
			new TerrainDefinition(TerrainEnum.River, "River", 1, 3, 2, 1, 1, 2, 9),
			// Terrain addons
			new TerrainDefinition(TerrainEnum.Oasis, "Oasis", 1, 2, 3, 1, 0, 1, 14),
			new TerrainDefinition(TerrainEnum.Horses, "Horses", 1, 2, 1, 3, 0, 1, 6),
			new TerrainDefinition(TerrainEnum.GrasslandAddon, "Grassland", 1, 2, 2, 1, 0, 1, 10),
			new TerrainDefinition(TerrainEnum.Game, "Game", 2, 3, 3, 2, 0, 2, 2),
			new TerrainDefinition(TerrainEnum.Coal, "Coal", 2, 4, 1, 2, 0, 2, 12),
			new TerrainDefinition(TerrainEnum.Gold, "Gold", 3, 6, 0, 1, 6, 3, 13),
			new TerrainDefinition(TerrainEnum.Game2, "Game", 1, 2, 3, 0, 0, 0, 7),
			new TerrainDefinition(TerrainEnum.Seals, "Seals", 2, 2, 2, 0, 0, 0, 15),
			new TerrainDefinition(TerrainEnum.Oil, "Oil", 2, 3, 1, 4, 0, 0, 3),
			new TerrainDefinition(TerrainEnum.Gems, "Gems", 2, 3, 1, 0, 4, 0, 11),
			new TerrainDefinition(TerrainEnum.Fish, "Fish", 1, 2, 3, 0, 2, 0, 1),
			new TerrainDefinition(TerrainEnum.RiverAddon, "River", 1, 3, 2, 1, 1, 2, 9)};
