...
<p>This is a re-write of Civilization 1 Game (Based on original DOS assembly) designed by Sid Meier and Bruce Shelley in year 1991.</p>
...
## Current status
<p>The game is playable in current state, but requires Original game files to be present.</p>
