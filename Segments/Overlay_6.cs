...
namespace Civilization1
{
	public class Overlay_6
	{
		...
		public void F6_0000_0000()
		{
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19b4), 0x3768);

			// Instruction address 0x0000:0x004f, size: 5
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19b6), 0x3770);
		...
		L0267:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				...
				(ushort)(0xa * this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, 
					(ushort)(this.oCPU.BP.Word + 0x6)) << 1) - 0x7fc4))),
				0x270f);
		...
		L02c1:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)), 0x64, 0x270f);
		...
		L03c2:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) *
					(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6b86) + 1)) >> 5),
				0, 0x14);
		...
		L098c:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)), 10));
		...
		L0cc6:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x37d4);
		...
		L0e25:
			this.oCPU.SI.Word = (ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)) << 1) + 0xb1d6);
			
			// Instruction address 0x0000:0x0e43, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2e)) << 1) - 4),
				0, (ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, this.oCPU.SI.Word) / 0x32));
		...
		L0f1c:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4e2a)), 10));
		...
		L1097:
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19b4), this.oCPU.ReadWord(this.oCPU.DS.Word, 0x33aa));

			// Instruction address 0x0000:0x10bb, size: 5
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19b6), this.oCPU.ReadWord(this.oCPU.DS.Word, 0x33a8));
		...
		L112f:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x3834);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3856);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x388a);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x388c);
		...
		L1289:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2e)),
				0,
				(ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4e2a)) / 0x32));
		...
		L1376:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x38aa);
		...
		L13ae:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x38ca);
		...
		L13ca:
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x38e6);
		...
		L14c1:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(((this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0x6e82)) >> 1) *
					(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4e2a)) / 0x64)) / 0x32),
				2, 0x270f);
		...
		L1562:
			...
			this.oCPU.WriteWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4e2a), 
				this.oCPU.ADDWord(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4e2a)), this.oCPU.AX.Word));
			this.oCPU.WriteWord(this.oCPU.DS.Word, this.oCPU.BX.Word, 
				this.oCPU.SUBWord(this.oCPU.ReadWord(this.oCPU.DS.Word, this.oCPU.BX.Word), this.oCPU.AX.Word));
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3906);

			// Instruction address 0x0000:0x15a4, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0x1992)));

			// Instruction address 0x0000:0x15b4, size: 5
			this.oParent.MSCAPI.strcat(0xba06, 0x391b);
			goto L15cf;
		...
		L170d:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x3948);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x395e);

			// Instruction address 0x0000:0x174a, size: 5
			this.oParent.MSCAPI.strcat(0xba06, 0x397a);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x399c);
		...
		L182c:
			...
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x3936, this.oCPU.AX.Word);
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x67e8, 0xffff);
		...
		L18cc:
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x39f8);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a0a);
		...
		L192a:
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a0f);
		...
		L196a:
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a1e);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a2d);
		...
		L19bb:
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a32);
		...
		L19e6:
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a53);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a5b);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3a60);
		...
		public void F6_0000_1a3f()
		{
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x30be),
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x1982)));
		...
		L1c90:
			...
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x67f4, 0xa);
		...
		L1d60:
			...
			this.oParent.MSCAPI.strcpy(0xba06, this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x19a2)));

			// Instruction address 0x0000:0x1dbe, size: 5
			this.oParent.MSCAPI.strcat(0xba06, 0x3aca);
			...
			this.oParent.MSCAPI.strcat(0xba06, 0x3acd);

			// Instruction address 0x0000:0x1df4, size: 5
			this.oParent.MSCAPI.strcat(0xba06, this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x1992)));

			// Instruction address 0x0000:0x1e04, size: 5
			this.oParent.MSCAPI.strcat(0xba06, 0x3ad6);
		...
		L1e3e:
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0x10), 0x3ad8);
		...
		L1ea5:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)((0x50 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12))) + 1),
				0x65, 0x4e, 0x63);
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0x10), 0x3ae3);
		...
		L2076:
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0x10), 0x3af3);
		...
		L20cb:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)((0x1d * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14))) + 0xa1),
				(ushort)((0x19 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12))) + 1),
				0x1c, 0x18);
		...
		L21bd:
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0xe), 0x3b06);
		...
		L2214:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				(short)this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1e)) << 1) + 0x3afe)),
				0x22,
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)((((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1e)) +
					this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6))) & 3) * 6) - 0x7fb2)));
		...
		L2244:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				0x5a, 0,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xb1e6));

			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x67f4, 0x0);

			// Instruction address 0x0000:0x227d, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0x7), 0x3b11);

			// Instruction address 0x0000:0x228d, size: 5
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0x1c), 0x3b15);
		...
		L23d5:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) + 0x22),
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe)) << 1) +
					(0x6 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc))) - 0x7fb2)));
		...
		L2485:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) - 2),
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)) << 2) + 0x7efe)));
		...
		L24eb:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) + 0x12),
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) << 2) + 0x7f00)));
