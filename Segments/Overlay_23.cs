...
namespace Civilization1
{
	public class Overlay_23
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F23_0000_0000'(Cdecl) at 0x0000:0x0000, stack: 0x0");
		...
		L00c5:
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x00ca); // stack management - push return offset
			// Instruction address 0x0000:0x00c5, size: 5
			...
			this.oParent.LogWriteLine("Exiting function 'F23_0000_0000'");
		}

		public void F23_0000_00d6()
		{
			this.oParent.LogWriteLine("Entering function 'F23_0000_00d6'(Cdecl) at 0x0000:0x00d6, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
			...
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oParent.LogWriteLine("Exiting function 'F23_0000_00d6'");
		}

		public void F23_0000_0173()
		{
			this.oParent.LogWriteLine("Entering function 'F23_0000_0173'(Cdecl) at 0x0000:0x0173, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L022e:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F23_0000_0173'");
		}

		public void F23_0000_025b()
		{
			this.oParent.LogWriteLine("Entering function 'F23_0000_025b'(Cdecl) at 0x0000:0x025b, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
			...
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x026d); // stack management - push return offset
			// Instruction address 0x0000:0x0268, size: 5
			this.oParent.Segment_1866.F0_1866_25b6();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
		...
		L02cd:
			...
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x030e); // stack management - push return offset
			// Instruction address 0x0000:0x0309, size: 5
			this.oParent.Segment_1866.F0_1866_25d7();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
		...
		L030e:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F23_0000_025b'");
		}

		public void F23_0000_0319()
		{
			this.oParent.LogWriteLine("Entering function 'F23_0000_0319'(Cdecl) at 0x0000:0x0319, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L03bc:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x03ed); // stack management - push return offset
		...
		L040f:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F23_0000_0319'");
		}

		public void F23_0000_0414()
		{
			this.oParent.LogWriteLine("Entering function 'F23_0000_0414'(Cdecl) at 0x0000:0x0414, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L04b2:
			...
			this.oCPU.AX.Word = 0xa;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x68ce));
			this.oCPU.PushWord(this.oCPU.SI.Word);
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x68d0));
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x04db); // stack management - push return offset
		...
		L0599:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord((ushort)(this.oCPU.BP.Word - 0x40));
			this.oCPU.PushWord(0x0000); // stack management - push return segment
		...
		L060a:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x68cc);
			this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, 0xba05);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x062a); // stack management - push return offset
		...
		L06b4:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F23_0000_0414'");
		}

		public void F23_0000_06c1()
		{
			this.oParent.LogWriteLine("Entering function 'F23_0000_06c1'(Cdecl) at 0x0000:0x06c1, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L06d7:
			...
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0753); // stack management - push return offset
		...
		L0782:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F23_0000_06c1'");
		}
	}
}
