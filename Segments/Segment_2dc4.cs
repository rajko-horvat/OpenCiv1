...
namespace OpenCiv1
{
	public class Segment_2dc4
	{
		...
		public ushort F0_2dc4_007c_CheckValueRange(ushort value, ushort minValue, ushort maxValue)
		{
			// function body
			this.oCPU.AX.Word = Math.Min(Math.Max(value, minValue), maxValue);
		...
		public void F0_2dc4_0208()
		{
			...
			this.oParent.MSCAPI.abs((short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
		...
		L03e7:
			...
			F0_2dc4_007c_CheckValueRange(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xc)), 0, 0x10);
		...
		L0407:
			...
			F0_2dc4_007c_CheckValueRange(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa)), 0, 0x20);
