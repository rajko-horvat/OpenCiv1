	...
	public class Segment_1238
	{
		...
		L0457:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x804c) - (this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81d2) / 9)),
				0, 6);
		...
		L069f:
			...
			this.oParent.MSCAPI.strcpy(0xba06, this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x19b2)));
		...
		L073b:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x1c53);

			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xb884), 0x0);
			if (this.oCPU.Flags.E) goto L077e;

			// Instruction address 0x1238:0x075f, size: 5
			this.oParent.MSCAPI.strcpy(0xba06, 0x1c66);
		...
		L09b8:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)((this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81d2) / 0x96) + 1),
				1, 3);
		...
		L0c33:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x1d12);
		...
		L0e3e:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + (ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, 
					(ushort)(this.oCPU.BP.Word - 0x2)) << 1) - 0x16)) >> 3),
				0, 255);
		...
		L108f:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd808) << 1), 0, 0x3c);
		...
		L11d3:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)), 0, 3);
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xb1ea) >> 2),
				0, 3);
		...
		L1288:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)((((short)this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7ee) << 1) + 0xb1d6) & 0xffff)), 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)(-((short)this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x20f2)) + 
					(short)this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4df0)) - 10)), 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadWord(this.oCPU.DS.Word, 
					(ushort)(((short)(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7ee) << 1) + 0xdf0e) & 0xffff)), 10));
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadWord(this.oCPU.DS.Word, 
					(ushort)(((short)(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7ee) << 1) + 0xb210) & 0xffff)), 10));
		...
		L1394:
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x1da5);
		...
		L14dc:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) + 3), 3, 0x24);
		...
		L1687:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x32)) - 1), 0, 3);
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(short)((0x7 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8))) +
					this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa))),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xc)) - 1),
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + this.oCPU.DI.Word - 0x2de4)));
		...
		public void F0_1238_1720()
		{
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa(Math.Abs((short)this.oCPU.ReadWord(this.oCPU.DS.Word, 0xb220)), 10));
		...
		public void F0_1238_1767()
		{
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oCPU.PopWord(), this.oCPU.PopWord(), this.oCPU.PopWord());
			...
			this.oParent.MSCAPI.strcpy(0xba06, 0x1df8);
		...
		L1a53:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4e2a)) / 3), 
				0,
				(ushort)((0xa * this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0xe82))) -
					this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, 
					(ushort)(this.oCPU.BP.Word - 0xe)) + 0x70fa))));
		...
		L1bfc:
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0x10), 0x1e4b);
