...
namespace OpenCiv1
{
	public class CivQuiz
	{
		...
		L050a:
			...
			if (this.oParent.GameState.Players[this.oParent.GameState.HumanPlayerID].Units[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4a))].TypeID == -1)
				goto L0531;
