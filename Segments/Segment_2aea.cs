...
namespace Civilization1
{
	public class Segment_2aea
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_0008'(Cdecl) at 0x2aea:0x0008, stack: 0x0");
			...
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
		...
		L035b:
			...
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_0008'");
		}

		public void F0_2aea_03ba()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_03ba'(Cdecl) at 0x2aea:0x03ba, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L09c6:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x09e1); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x0a3d); // stack management - push return offset
		...
		L0c38:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x0cea); // stack management - push return offset
		...
		L0e23:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_03ba'");
		}

		public void F0_2aea_0e29()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_0e29'(Cdecl) at 0x2aea:0x0e29, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L0fae:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_0e29'");
		}

		public void F0_2aea_0fb3()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_0fb3'(Cdecl) at 0x2aea:0x0fb3, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L117a:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x11ad); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x11cc); // stack management - push return offset
		...
		L11cf:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_0fb3'");
		}

		public void F0_2aea_11d4()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_11d4'(Cdecl) at 0x2aea:0x11d4, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L1256:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_11d4'");
		}

		public void F0_2aea_125b()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_125b'(Cdecl) at 0x2aea:0x125b, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L1321:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_125b'");
		}

		public void F0_2aea_1326()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1326'(Cdecl) at 0x2aea:0x1326, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L1348:
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1326'");
		}

		public void F0_2aea_134a()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_134a'(Cdecl) at 0x2aea:0x134a, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x135c); // stack management - push return offset
			...
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_134a'");
		}

		public void F0_2aea_1369()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1369'(Cdecl) at 0x2aea:0x1369, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1369'");
		}

		public void F0_2aea_138c()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_138c'(Cdecl) at 0x2aea:0x138c, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_138c'");
		}

		public void F0_2aea_13cb()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_13cb'(Cdecl) at 0x2aea:0x13cb, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L13f5:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_13cb'");
		}

		public void F0_2aea_1412()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1412'(Cdecl) at 0x2aea:0x1412, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L1455:
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1412'");
		}

		public void F0_2aea_1458()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1458'(Cdecl) at 0x2aea:0x1458, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L14db:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1458'");
		}

		public void F0_2aea_14e0()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_14e0'(Cdecl) at 0x2aea:0x14e0, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x14f9); // stack management - push return offset
		...
		L150d:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_14e0'");
		}

		public void F0_2aea_1511()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1511'(Cdecl) at 0x2aea:0x1511, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x152a); // stack management - push return offset
			...
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1511'");
		}

		public void F0_2aea_1570()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1570'(Cdecl) at 0x2aea:0x1570, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.AX.Word = this.oCPU.ANDWord(this.oCPU.AX.Word, 0x8);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1570'");
		}

		public void F0_2aea_1585()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1585'(Cdecl) at 0x2aea:0x1585, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x159c); // stack management - push return offset
			...
			this.oCPU.CX.Word = this.oCPU.ADDWord(this.oCPU.CX.Word, 0x96);
			...
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x15b5); // stack management - push return offset
			...
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1585'");
		}

		public void F0_2aea_15c1()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_15c1'(Cdecl) at 0x2aea:0x15c1, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x15dd); // stack management - push return offset
			...
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x15f4); // stack management - push return offset
			...
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_15c1'");
		}

		public void F0_2aea_1601()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1601'(Cdecl) at 0x2aea:0x1601, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1601'");
		}

		public void F0_2aea_1653()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1653'(Cdecl) at 0x2aea:0x1653, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x1677); // stack management - push return offset
		...
		L1681:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2aea); // stack management - push return segment
			this.oCPU.PushWord(0x1696); // stack management - push return offset
		...
		L16eb:
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1653'");
		}

		public void F0_2aea_16ee()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_16ee'(Cdecl) at 0x2aea:0x16ee, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L1757:
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_16ee'");
		}

		public void F0_2aea_175a()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_175a'(Cdecl) at 0x2aea:0x175a, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L17ca:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_175a'");
		}

		public void F0_2aea_17cf()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_17cf'(Cdecl) at 0x2aea:0x17cf, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_17cf'");
		}

		public void F0_2aea_17ff()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_17ff'(Cdecl) at 0x2aea:0x17ff, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_17ff'");
		}

		public void F0_2aea_1819()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1819'(Cdecl) at 0x2aea:0x1819, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L1834:
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1819'");
		}

		public void F0_2aea_1836()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1836'(Cdecl) at 0x2aea:0x1836, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L1890:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1836'");
		}

		public void F0_2aea_1894()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1894'(Cdecl) at 0x2aea:0x1894, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L191f:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1894'");
		}

		public void F0_2aea_1942()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_1942'(Cdecl) at 0x2aea:0x1942, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x6);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_1942'");
		}

		public void F0_2aea_195d()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2aea_195d'(Cdecl) at 0x2aea:0x195d, stack: 0x0");
			this.oCPU.CS.Word = 0x2aea; // set this function segment
		...
		L199e:
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2aea_195d'");
		}
	}
}
