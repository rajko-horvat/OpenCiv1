	...
	public class Segment_2aea
	{
		...
		L0074:
			...
			this.oParent.Segment_1000.F0_1000_0bfa_FillRectangle(
				...
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x18)) << 4) + 0x50),
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1c)) << 4) + 8),
				16, 16, 0);
		...
		L0132:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x6dac)) - 8),
				0x50, 0x3e7);
		...
		L0211:
			...
			else
			{
				...
				this.oParent.VGADriver.F0_VGA_07d8_DrawImage(
					this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8),
					(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x16)) + 0xf0),
					this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1a)),
					...
					this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
					0, (ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14)) + 8));
				...
				if (this.oCPU.Flags.B)
				{
					...
					this.oParent.VGADriver.F0_VGA_07d8_DrawImage(
						...
						0xf0,
						this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1a)),
						(ushort)(0x50 - this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6))),
						this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8)),
						this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
						this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)),
						(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14)) + 8));
				}
			}
		...
		public void F0_2aea_03ba()
		{
			...
			this.oParent.Segment_1000.F0_1000_0bfa_FillRectangle(
				...
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) << 2),
				4, 4,
		...
		L0515:
			...
			this.oParent.VGADriver.F0_VGA_07d8_DrawImage(
				...
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12)) << 4),
				0x40, 16, 16,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)),
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)));
		...
		L0733:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word - 0x2d2c)));
		...
		L0789:
			if (this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x18)) != 0xa)
			{
				if (this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd762) == 0x0)
				{
		...
		L0872:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)),
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12)) << 1) + 0x6dfe)));
		...
		L08fa:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					...
					(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x18)) << 5) - 0x477a)));
		...
		L09a7:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)),
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd4da));
			goto L0a40;
		...
		L0ac0:
			...
			this.oParent.Segment_1000.F0_1000_0bfa_FillRectangle(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) + 7),
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) + 7),
				2, 2,
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20)));
		...
		L0b07:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)),
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x18)) + 0x10) << 1) - 0x2b32)));
		...
		L0b7a:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)),
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x7eec)));
		...
		L0d21:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) + 5),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26)),
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6e9e));
			goto L0d92;
		...
		L0dca:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) + 1),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) + 1),
				this.oCPU.ReadWord(this.oCPU.DS.Word,
		...
		public void F0_2aea_0e29()
		{
			...
			this.oParent.Segment_1000.F0_1000_0bfa_FillRectangle(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(ushort)((this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2b)) << 2) + 1),
				(ushort)((this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2a)) << 2) + 1),
				3, 3, 6);
			goto L0e55;
		...
		L0e55:
			...
			this.oParent.Segment_1000.F0_1000_0bfa_FillRectangle(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(ushort)(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2b)) << 2),
				(ushort)(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2a)) << 2),
				3, 3,
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x1946)));
			goto L0fae;
		...
		L0f57:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) + 1),
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) + 1),
				this.oCPU.ReadWord(this.oCPU.DS.Word,
		...
		public void F0_2aea_0fb3()
		{
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				this.oCPU.ReadWord(this.oCPU.DS.Word,
					(ushort)(((this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e29)) +
