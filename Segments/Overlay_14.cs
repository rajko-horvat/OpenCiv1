...
namespace Civilization1
{
	public class Overlay_14
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_0000'(Cdecl) at 0x0000:0x0000, stack: 0x0");
			...
			this.oParent.LogWriteLine("Exiting function 'F14_0000_0000'");
		}

		public void F14_0000_001c()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_001c'(Cdecl) at 0x0000:0x001c, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L008c:
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_001c'");
		}

		public void F14_0000_013b()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_013b'(Cdecl) at 0x0000:0x013b, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
			...
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oParent.LogWriteLine("Exiting function 'F14_0000_013b'");
		}

		public void F14_0000_014b()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_014b'(Cdecl) at 0x0000:0x014b, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L03a4:
			...
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_014b'");
		}

		public void F14_0000_03ad()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_03ad'(Cdecl) at 0x0000:0x03ad, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L05e3:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_03ad'");
		}

		public void F14_0000_061f()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_061f'(Cdecl) at 0x0000:0x061f, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L07c3:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_061f'");
		}

		public void F14_0000_07f1()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_07f1'(Cdecl) at 0x0000:0x07f1, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0980:
			...
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x098c); // stack management - push return offset
		...
		L0cda:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_07f1'");
		}

		public void F14_0000_0d43()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_0d43'(Cdecl) at 0x0000:0x0d43, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L1159:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_0d43'");
		}

		public void F14_0000_1164()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_1164'(Cdecl) at 0x0000:0x1164, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L15eb:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_1164'");
		}

		public void F14_0000_15f4()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_15f4'(Cdecl) at 0x0000:0x15f4, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L1770:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_15f4'");
		}

		public void F14_0000_181d()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_181d'(Cdecl) at 0x0000:0x181d, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L1855:
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_181d'");
		}

		public void F14_0000_186f()
		{
			this.oParent.LogWriteLine("Entering function 'F14_0000_186f'(Cdecl) at 0x0000:0x186f, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L1b69:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F14_0000_186f'");
		}
	}
}
