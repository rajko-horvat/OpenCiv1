...
namespace Civilization1
{
	public class Overlay_2
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F2_0000_0000'(Cdecl) at 0x0000:0x0000, stack: 0x0");
		...
		L020a:
			...
			this.oParent.Segment_2fa1.F0_2fa1_0220();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
		...
		L031c:
			...
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.fopen(CPUMemory.ToLinearAddress(this.oCPU.DS.Word, 0x32b5),
				CPUMemory.ToLinearAddress(this.oCPU.DS.Word, 0x32b2));
		...
		L0b52:
			...
			this.oParent.LogWriteLine("Exiting function 'F2_0000_0000'");
		}

		public void F2_0000_0bd7()
		{
			this.oParent.LogWriteLine("Entering function 'F2_0000_0bd7'(Cdecl) at 0x0000:0x0bd7, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L149d:
			...
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x2);
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.fclose((short)this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd768));
			this.oCPU.BX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa);
			this.oCPU.WriteWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x10), 0x1);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd762), 0x0);
		...
		L1500:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F2_0000_0bd7'");
		}

		public void F2_0000_152a()
		{
			this.oParent.LogWriteLine("Entering function 'F2_0000_152a'(Cdecl) at 0x0000:0x152a, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L176d:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F2_0000_152a'");
		}

		public void F2_0000_17d9()
		{
			this.oParent.LogWriteLine("Entering function 'F2_0000_17d9'(Cdecl) at 0x0000:0x17d9, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L18d6:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F2_0000_17d9'");
		}

		public void F2_0000_195a()
		{
			this.oParent.LogWriteLine("Entering function 'F2_0000_195a'(Cdecl) at 0x0000:0x195a, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x6);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F2_0000_195a'");
		}

		public void F2_0000_19a3()
		{
			this.oParent.LogWriteLine("Entering function 'F2_0000_19a3'(Cdecl) at 0x0000:0x19a3, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment

			// function body
			this.oCPU.PushWord(this.oCPU.BP.Word);
			this.oCPU.BP.Word = this.oCPU.SP.Word;
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.fscanf((short)this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd768),
				CPUMemory.ToLinearAddress(this.oCPU.DS.Word, 0x337b), 
				CPUMemory.ToLinearAddress(this.oCPU.DS.Word, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6))));
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F2_0000_19a3'");
		}
	}
}
