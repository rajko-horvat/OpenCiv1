...
namespace Civilization1
{
	public class Overlay_10
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F10_0000_0000'(Cdecl) at 0x0000:0x0000, stack: 0x0");
		...
		L001b:
			...
			this.oParent.LogWriteLine("Exiting function 'F10_0000_0000'");
		}

		public void F10_0000_0079()
		{
			this.oParent.LogWriteLine("Entering function 'F10_0000_0079'(Cdecl) at 0x0000:0x0079, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L045f:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F10_0000_0079'");
		}

		public void F10_0000_0477()
		{
			this.oParent.LogWriteLine("Entering function 'F10_0000_0477'(Cdecl) at 0x0000:0x0477, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0690:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F10_0000_0477'");
		}
	}
}
