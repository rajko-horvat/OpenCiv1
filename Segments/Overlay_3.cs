...
namespace Civilization1
{
	public class Overlay_3
	{
		...
		public Overlay_3(Civilization parent)
		{
			this.oParent = parent;
		...
		{
			this.oParent.LogWriteLine("Entering function 'F3_0000_0000'(Cdecl) at 0x0000:0x0000, stack: 0x0");
		...
		L000b:
			...
			this.oParent.LogWriteLine("Exiting function 'F3_0000_0000'");
		}

		public void F3_0000_002b()
		{
			this.oParent.LogWriteLine("Entering function 'F3_0000_002b'(Cdecl) at 0x0000:0x002b, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
			...
			// Call to overlay
			F3_0000_0000();
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.open(CPUMemory.ToLinearAddress(this.oCPU.DS.Word, 0x33ac),
				0x8102);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), this.oCPU.AX.Word);
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.read((short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)),
				CPUMemory.ToLinearAddress(this.oCPU.DS.Word, 0xba06),
				0x114);
			this.oCPU.AX.Word = 0x114;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x37d2;
			...
			this.oParent.Segment_2dc4.F0_2dc4_04dd();
			...
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.close((short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)));
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F3_0000_002b'");
		}

		public void F3_0000_0083()
		{
			this.oParent.LogWriteLine("Entering function 'F3_0000_0083'(Cdecl) at 0x0000:0x0083, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
			...
			this.oCPU.BP.Word = this.oCPU.SP.Word;
			this.oCPU.SP.Word = this.oCPU.SUBWord(this.oCPU.SP.Word, 0x2);
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.open(CPUMemory.ToLinearAddress(this.oCPU.DS.Word,0x33b5),
				0x8302);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x114;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			...
			// Instruction address 0x0000:0x00b0, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_0500();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.write((short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)),
				CPUMemory.ToLinearAddress(this.oCPU.DS.Word, 0xba06),
				0x114);
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.close((short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)));
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F3_0000_0083'");
		}

		public void F3_0000_00d7()
		{
			this.oParent.LogWriteLine("Entering function 'F3_0000_00d7'(Cdecl) at 0x0000:0x00d7, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0142); // stack management - push return offset
		...
		L0220:
			...
			// Instruction address 0x0000:0x0232, size: 5
			...
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x33dd;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0254); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x026c); // stack management - push return offset
			// Instruction address 0x0000:0x0267, size: 5
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			// LEA
			this.oCPU.AX.Word = (ushort)(this.oCPU.SI.Word + 0x37e0);
			this.oCPU.DX.Word = 0x3772;
			this.oCPU.PushWord(this.oCPU.DX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			...
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x33e3;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x02bc); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			// LEA
			this.oCPU.AX.Word = (ushort)(this.oCPU.SI.Word + 0x37f0);
			this.oCPU.DX.Word = 0x3772;
			this.oCPU.PushWord(this.oCPU.DX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.ES.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x63fc);
			this.oCPU.AX.Word = (ushort)this.oParent.MSCAPI.abs((short)this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.SI.Word + 0x37d8)));
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
		...
		L036f:
			...
			this.oCPU.AX.Word = 0x33fb; // Segment
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0395); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.ES.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x63fc);
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.SI.Word + 0x37d2)));
			this.oCPU.PushWord(0x0000); // stack management - push return segment
		...
		L0419:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0423); // stack management - push return offset
		...
		L0426:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.ES.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x63fc);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.DI.Word + 0x37d4));
			this.oCPU.AX.Word = this.oCPU.INCWord(this.oCPU.AX.Word);
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.DI.Word + 0x37d2)));
			...
			// Instruction address 0x0000:0x047a, size: 5
			this.oParent.MSCAPI.itoa();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x6);
		...
		L050d:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F3_0000_00d7'");
		}

		public void F3_0000_0513()
		{
			this.oParent.LogWriteLine("Entering function 'F3_0000_0513'(Cdecl) at 0x0000:0x0513, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0562:
			...
			// Instruction address 0x0000:0x0595, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_04dd();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
		...
		L0658:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F3_0000_0513'");
		}

		public void F3_0000_065d()
		{
			this.oParent.LogWriteLine("Entering function 'F3_0000_065d'(Cdecl) at 0x0000:0x065d, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L06ba:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x06e9); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x073b); // stack management - push return offset
		...
		L0788:
			...
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x1f4;
			this.oCPU.DX.Word = 0x36d4;
			this.oCPU.PushWord(this.oCPU.DX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x079d); // stack management - push return offset
			// Instruction address 0x0000:0x0798, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_0500();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
		...
		L0814:
			...
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x23f;
			this.oCPU.DX.Word = 0x36d4;
			this.oCPU.PushWord(this.oCPU.DX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0859); // stack management - push return offset
			// Instruction address 0x0000:0x0854, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_0500();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
			...
			// Instruction address 0x0000:0x0867, size: 5
			this.oParent.MSCAPI.itoa();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x6);
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0879); // stack management - push return offset
			// Instruction address 0x0000:0x0874, size: 5
			this.oParent.MSCAPI.strcat();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x3473;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x08c7); // stack management - push return offset
			// Instruction address 0x0000:0x08c2, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_0500();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
		...
		L08fc:
			...
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, 0xb8);
		...
		L091d:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0948); // stack management - push return offset
			// Instruction address 0x0000:0x0943, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_0500();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
		...
		L0957:
			...
			this.oCPU.CX.Low = 0x3;
			this.oCPU.AX.Word = this.oCPU.SHLWord(this.oCPU.AX.Word, this.oCPU.CX.Low);
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, 0xb7);
			this.oCPU.AX.Word = this.oCPU.NEGWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x50;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0981); // stack management - push return offset
			...
			// Instruction address 0x0000:0x099e, size: 5
		...
		L09a8:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F3_0000_065d'");
		}

		public void F3_0000_09ac()
		{
			this.oParent.LogWriteLine("Entering function 'F3_0000_09ac'(Cdecl) at 0x0000:0x09ac, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0a8e:
			...
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0a98); // stack management - push return offset
			// Instruction address 0x0000:0x0a93, size: 5
			this.oParent.Segment_1866.F0_1866_25b6();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
		...
		L0ae4:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0b13); // stack management - push return offset
			// Instruction address 0x0000:0x0b0e, size: 5
			this.oParent.MSCAPI.strcat();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x34a7;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			...
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x2);
			this.oCPU.AX.Word = 0x34aa;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0b3e); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x0b5f); // stack management - push return offset
			// Instruction address 0x0000:0x0b5a, size: 5
			this.oParent.MSCAPI.strcat();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x34ad;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
		...
		L0c63:
			...
			// Instruction address 0x0000:0x0c68, size: 5
			this.oParent.Segment_1866.F0_1866_25d7();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x0000; // restore this function segment
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F3_0000_09ac'");
		}
	}
}
