...
namespace Civilization1
{
	public class Segment_1866
	{
		...
		public void F0_1866_0006()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_0006'(Cdecl) at 0x1866:0x0006, stack: 0x0");
		...
		L0024:
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x20f4, 0x1);
		...
		L002f:
			...
			this.oCPU.TESTByte(this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.DI.Word), 0x40);
			if (this.oCPU.Flags.E) goto L0094;
			this.oCPU.WriteByte(this.oCPU.DS.Word, this.oCPU.BX.Word, this.oCPU.ORByte(this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.BX.Word), 0x20));
		...
		L0094:
			...
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + this.oCPU.SI.Word + 0x7106), 0xff);
		...
		L00a4:
			...
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x20f4, 0x0);
			this.oCPU.AX.Word = 0x1c;
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x70f2), this.oCPU.ORByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x70f2)), 0x4));
		...
		L00c0:
			...
			this.oParent.LogWriteLine("Exiting function 'F0_1866_0006'");
		}

		public void F0_1866_00c6()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_00c6'(Cdecl) at 0x1866:0x00c6, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L00e9:
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x70d8);
			...
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x70d8, this.oCPU.AX.Word);
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x20f4, 0x1);
		...
		L0102:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.SI.Word = this.oCPU.ADDWord(this.oCPU.SI.Word, 0x7107);
		...
		L0116:
			...
			this.oCPU.AX.Low = this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word - 0x7e29));
			this.oCPU.WriteByte(this.oCPU.DS.Word, this.oCPU.SI.Word, this.oCPU.AX.Low);
			this.oCPU.TESTByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word - 0x7e2c)), 0x20);
			if (this.oCPU.Flags.E) goto L0136;
			this.oCPU.WriteByte(this.oCPU.DS.Word, this.oCPU.SI.Word, this.oCPU.ORByte(this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.SI.Word), 0x40));
		...
		L014b:
			...
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2b)), this.oCPU.AX.Low);
			if (this.oCPU.Flags.NE) goto L0148;
			this.oCPU.AX.Low = this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0x70f1));
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2a)), this.oCPU.AX.Low);
			if (this.oCPU.Flags.NE) goto L0148;
			...
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0x7106)), 0xff);
			if (this.oCPU.Flags.E) goto L01a6;
			goto L0102;

		L01a6:
			this.oCPU.AX.Low = this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e29));
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0x7106), this.oCPU.AX.Low);
			this.oCPU.TESTByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2c)), 0x20);
			if (this.oCPU.Flags.E) goto L0136;
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0x7106), this.oCPU.ORByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word + 0x7106)), 0x40));
			goto L0136;
		...
		L01bd:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x70f2), this.oCPU.ANDByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x70f2)), 0xfb));
		...
		L01d6:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_00c6'");
		}

		public void F0_1866_01dc()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_01dc'(Cdecl) at 0x1866:0x01dc, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
		...
		L0205:
			...
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)), 0x9);
			...
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.TESTByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x1144)), 0x2);
		...
		L0266:
			...
			this.oCPU.ES.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x63e6);
		...
		L02a3:
			...
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)), 0x19);
		...
		L02e2:
			...
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7f0), 0x0);
			if (this.oCPU.Flags.E) goto L0329;
			this.oCPU.SI.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa));
			this.oCPU.CX.Low = 0x4;
			this.oCPU.SI.Word = this.oCPU.SHLWord(this.oCPU.SI.Word, this.oCPU.CX.Low);
			this.oCPU.BX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7f0);
		...
		L033e:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.CS.Word);
			this.oCPU.PushWord(0x035b); // stack management - push return offset
		...
		L03df:
			...
			this.oCPU.TESTByte(this.oCPU.ReadByte(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x16)), 0x1);
		...
		L0451:
			...
			this.oCPU.AX.Low = 0x1;
			this.oCPU.CX.Low = this.oCPU.ReadByte(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14));
			this.oCPU.AX.Low = this.oCPU.SHLByte(this.oCPU.AX.Low, this.oCPU.CX.Low);
		...
		L04e1:
			...
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.AX.Low = 0x1;
			this.oCPU.CX.Low = this.oCPU.ReadByte(this.oCPU.DS.Word, 0xd7f0);
			this.oCPU.AX.Low = this.oCPU.SHLByte(this.oCPU.AX.Low, this.oCPU.CX.Low);
		...
		L0503:
			...
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc)), 0xa);
		...
		L05b7:
			...
			this.oCPU.AX.Low = 0x22;
			this.oCPU.IMULByte(this.oCPU.AX, this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word - 0x7e29)));
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x1138)), 0x0);
		...
		L0628:
			...
			if (this.oCPU.Flags.E) goto L068b;
			this.oCPU.TESTByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word - 0x7e2c)), 0x8);
		...
		L06cc:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa), 0x9);
			goto L08bc;
		...
		L06fe:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa)));
			this.oCPU.DI.Word = this.oCPU.AX.Word;
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + this.oCPU.DI.Word - 0x7e29)), 0x16);
		...
		L0718:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)));
			this.oCPU.DI.Word = this.oCPU.AX.Word;
			this.oCPU.AX.Low = this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + this.oCPU.DI.Word - 0x7e29));
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4), this.oCPU.AX.Word);
		...
		L0760:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7f0));
			this.oCPU.SI.Word = this.oCPU.ADDWord(this.oCPU.SI.Word, this.oCPU.AX.Word);
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2c), this.oCPU.ANDByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2c)), 0xfe));
		...
		L07f0:
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7ee);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7f0), this.oCPU.AX.Word);
		...
		L097b:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7f0));
			this.oCPU.SI.Word = this.oCPU.ADDWord(this.oCPU.SI.Word, this.oCPU.AX.Word);
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e29)), 0x16);
			if (this.oCPU.Flags.E) goto L09f9;
			this.oCPU.TESTByte(this.oCPU.ReadByte(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x16)), 0x1);
		...
		L0a14:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.CS.Word);
			this.oCPU.PushWord(0x0a31); // stack management - push return offset
		...
		L0ac7:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa), this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))));
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)), 0x31);
		...
		L0ad0:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_01dc'");
		}

		public void F0_1866_0ad6()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_0ad6'(Cdecl) at 0x1866:0x0ad6, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L0b2d:
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x70ea);
			this.oCPU.AX.Word = this.oCPU.ORWord(this.oCPU.AX.Word, this.oCPU.AX.Word);
		...
		L0b36:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xe), this.oCPU.AX.Word);
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.DS.Word, 0x70ea));
			...
			this.oCPU.AX.High = this.oCPU.SUBByte(this.oCPU.AX.High, this.oCPU.AX.High);
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6ed6));
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
		...
		L0cf0:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_0ad6'");
		}

		public void F0_1866_0cf5()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_0cf5'(Cdecl) at 0x1866:0x0cf5, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L0d06:
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)), 0x7f);
		...
		L0d0f:
			...
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e2b), 0xff);
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e22), 0xff);
			...
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e23), this.oCPU.AX.Low);
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e26), 0xff);
			...
			this.oCPU.WriteByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e21), 0xff);
		...
		L0dd9:
			...
			this.oCPU.WriteByte(this.oCPU.DS.Word, this.oCPU.SI.Word, this.oCPU.DECByte(this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.SI.Word)));
		...
		L0df4:
			...
			this.oCPU.BX.Word = this.oCPU.SHLWord(this.oCPU.BX.Word, 0x1);
			this.oCPU.WriteWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + this.oCPU.SI.Word - 0x4c42), this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + this.oCPU.SI.Word - 0x4c42))));
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x20f4), 0x0);
		...
		L0e7d:
			...
			if (this.oCPU.Flags.E) goto L0ec3;
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x20f4), 0x0);
			if (this.oCPU.Flags.NE) goto L0ec3;
			this.oCPU.BX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6));
			this.oCPU.BX.Word = this.oCPU.SHLWord(this.oCPU.BX.Word, 0x1);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x6b76)), 0x0);
		...
		L0eab:
			this.oCPU.BX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6));
			this.oCPU.BX.Word = this.oCPU.SHLWord(this.oCPU.BX.Word, 0x1);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x6b76)), 0x1);
			if (this.oCPU.Flags.NE) goto L0ec3;
		...
		L0ec8:
			...
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd760), 0x0);
			if (this.oCPU.Flags.NE) goto L0f08;
			...
			this.oCPU.CS.Word = 0x1866; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x6);
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0xd760, 0x1);
		...
		L0f0b:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_0cf5'");
		}

		public void F0_1866_0f10()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_0f10'(Cdecl) at 0x1866:0x0f10, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.DI.Word);
			this.oCPU.PushWord(this.oCPU.SI.Word);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x70d8), 0x0);
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.BX.Word = this.oCPU.ADDWord(this.oCPU.BX.Word, this.oCPU.AX.Word);
			this.oCPU.ES.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x63e8);
			this.oCPU.WriteWord(this.oCPU.ES.Word, (ushort)(this.oCPU.BX.Word + 0x253c), this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.BX.Word + 0x253c))));
		...
		L0f9a:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)));
			this.oCPU.SI.Word = this.oCPU.ADDWord(this.oCPU.SI.Word, this.oCPU.AX.Word);
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x7e29)), 0x17);
		...
		L0fe6:
			...
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7ee);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)), this.oCPU.AX.Word);
			if (this.oCPU.Flags.E) goto L105e;
		...
		L1085:
			...
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_0f10'");
		}

		public void F0_1866_1089()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1089'(Cdecl) at 0x1866:0x1089, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L10ad:
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8));
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x6530, this.oCPU.AX.Word);
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x6534, 0x0);
		...
		L10c3:
			...
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word - 0x7e2b)), this.oCPU.AX.Low);
			if (this.oCPU.Flags.NE) goto L10c0;
			this.oCPU.AX.Low = this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.DI.Word - 0x7e2a));
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word - 0x7e2a)), this.oCPU.AX.Low);
			if (this.oCPU.Flags.NE) goto L10c0;
		...
		L1119:
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6530);
		...
		L111c:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1089'");
		}

		public void F0_1866_1122()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1122'(Cdecl) at 0x1866:0x1122, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L1142:
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8));
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x6530, this.oCPU.AX.Word);
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x6534, 0xffff);
			this.oCPU.AX.Word = 0x1169;
			this.oCPU.DX.Word = 0x1866;
			this.oCPU.PushWord(this.oCPU.DX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
		...
		L1166:
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1122'");
		}

		public void F0_1866_1251()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1251'(Cdecl) at 0x1866:0x1251, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment

			// function body
			this.oCPU.PushWord(this.oCPU.BP.Word);
			this.oCPU.BP.Word = this.oCPU.SP.Word;
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x6532, 0x0);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa));
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x6536, this.oCPU.AX.Word);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8));
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x6538, this.oCPU.AX.Word);
			...
			this.oCPU.PopWord(); // stack management - pop return offset
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6532);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1251'");
		}

		public void F0_1866_1331()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1331'(Cdecl) at 0x1866:0x1331, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.BP.Word = this.oCPU.SP.Word;
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa));
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x653a, this.oCPU.AX.Word);
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x653c, 0x0);
			...
			this.oCPU.PopWord(); // stack management - pop return offset
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x653c);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1331'");
		}

		public void F0_1866_1380()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1380'(Cdecl) at 0x1866:0x1380, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.DX.Word = 0x1866; // Segment
			this.oCPU.PushWord(this.oCPU.DX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)));
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			...
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x653c);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1380'");
		}

		public void F0_1866_13d5()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_13d5'(Cdecl) at 0x1866:0x13d5, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x653c);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_13d5'");
		}

		public void F0_1866_144b()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_144b'(Cdecl) at 0x1866:0x144b, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L145d:
			...
			this.oCPU.CallF(this.oCPU.ReadDWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa)));
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x1866; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8));
		...
		L149d:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_144b'");
		}

		public void F0_1866_16a9()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_16a9'(Cdecl) at 0x1866:0x16a9, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x0);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)), 0x10);
			if (this.oCPU.Flags.GE) goto L16c5;
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd4cc), 0x40);
			if (this.oCPU.Flags.LE) goto L16c5;
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8), this.oCPU.ADDWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)), 0x50));
		...
		L1721:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_16a9'");
		}

		public void F0_1866_1725()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1725'(Cdecl) at 0x1866:0x1725, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L174e:
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1725'");
		}

		public void F0_1866_1750()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1750'(Cdecl) at 0x1866:0x1750, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L17f4:
			...
			this.oCPU.AX.Low = 0x1;
			this.oCPU.AX.Low = this.oCPU.SHLByte(this.oCPU.AX.Low, this.oCPU.CX.Low);
			this.oCPU.WriteByte(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x10), this.oCPU.AX.Low);
			this.oCPU.WriteByte(this.oCPU.DS.Word, this.oCPU.SI.Word, this.oCPU.ORByte(this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.SI.Word), this.oCPU.AX.Low));
			this.oCPU.CX.Word = this.oCPU.AX.Word;
			this.oCPU.AX.Word = 0x32;
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)));
			this.oCPU.BX.Word = this.oCPU.AX.Word;
		...
		L18ca:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1750'");
		}

		public void F0_1866_18d0()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_18d0'(Cdecl) at 0x1866:0x18d0, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L192c:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_18d0'");
		}

		public void F0_1866_1931()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1931'(Cdecl) at 0x1866:0x1931, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L1964:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x19bd); // stack management - push return offset
		...
		L1a7f:
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81d2), 0x0);
			if (this.oCPU.Flags.E) goto L1a8e;
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xb220), 0x3e8);
			if (this.oCPU.Flags.LE) goto L1ac7;

		L1a8e:
			this.oCPU.AX.Word = 0x2184;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1a9b); // stack management - push return offset
		...
		L1aba:
			this.oCPU.BX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6));
			this.oCPU.BX.Word = this.oCPU.SHLWord(this.oCPU.BX.Word, 0x1);
			this.oCPU.WriteWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word - 0x4e2a), this.oCPU.ADDWord(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word - 0x4e2a)), 0x32));
			goto L1d4f;

		L1ac7:
			this.oCPU.AX.Word = 0x2154;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1ad4); // stack management - push return offset
		...
		L1af3:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1b01); // stack management - push return offset
		...
		L1b07:
			...
			this.oCPU.CS.Word = 0x1866; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x6);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12), 0xffff);
			goto L1b72;
		...
		L1b63:
			...
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12), this.oCPU.DX.Word);
		...
		L1b7f:
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12)), 0xffff);
		...
		L1b9a:
			this.oCPU.AX.Word = 0x21e6;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1ba7); // stack management - push return offset
		...
		L1bc6:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1bef); // stack management - push return offset
		...
		L1bff:
			this.oCPU.AX.Word = 0x21bb;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1c0c); // stack management - push return offset
		...
		L1c71:
			...
			this.oCPU.BX.Word = this.oCPU.SHLWord(this.oCPU.BX.Word, 0x1);
			this.oCPU.AX.Word = 0x4;
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x6b66)));
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
		...
		L1c9a:
			this.oCPU.SI.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x10));
			this.oCPU.SI.Word = this.oCPU.SHLWord(this.oCPU.SI.Word, 0x1);
			this.oCPU.AX.Word = 0x600;
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.DI.Word = this.oCPU.AX.Word;
		...
		L1d00:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.Word);
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x28e)), 0x2);
		...
		L1d4f:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1931'");
		}

		public void F0_1866_1d55()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1d55'(Cdecl) at 0x1866:0x1d55, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L1dd8:
			...
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc), this.oCPU.AX.Word);
			this.oCPU.BX.Word = this.oCPU.AX.Word;
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x18e4));
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x1882));
		...
		L1e61:
			...
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1e84); // stack management - push return offset
		...
		L1ecb:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)));
			this.oCPU.BX.Word = this.oCPU.ADDWord(this.oCPU.BX.Word, this.oCPU.AX.Word);
			this.oCPU.AX.Low = this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word - 0x7e29));
			this.oCPU.CBW(this.oCPU.AX);
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1f0f); // stack management - push return offset
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8)));
			this.oCPU.DI.Word = this.oCPU.AX.Word;
			this.oCPU.DI.Word = this.oCPU.ADDWord(this.oCPU.DI.Word, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)));
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x18e4));
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8)));
			this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)));
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc), this.oCPU.AX.Word);
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x1f4f); // stack management - push return offset
		...
		L1f63:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1d55'");
		}

		public void F0_1866_1f69()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_1f69'(Cdecl) at 0x1866:0x1f69, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			// Instruction address 0x1866:0x1f77, size: 3
			F0_1866_25b6();
			this.oCPU.PopWord(); // stack management - pop return offset
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)));
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
		...
		L1f9a:
			this.oCPU.SI.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x28));
			this.oCPU.SI.Word = this.oCPU.SHLWord(this.oCPU.SI.Word, 0x1);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1e));
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + this.oCPU.SI.Word - 0x1a), this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xc;
			...
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x28)), 0xc);
		...
		L2018:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x2050); // stack management - push return offset
			...
			this.oCPU.AX.Word = 0x2224;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x2067); // stack management - push return offset
		...
		L206a:
			...
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1e), this.oCPU.AX.Word);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20), this.oCPU.ADDWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x20)), 0x10));
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x28), this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x28))));
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x28)), 0xc);
		...
		L2161:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x218c); // stack management - push return offset
			// Instruction address 0x1866:0x2187, size: 5
			this.oParent.Segment_1000.F0_1000_0784();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x1866; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0xe);
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)), 0xd);
			if (this.oCPU.Flags.E) goto L219b;
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)), 0x20);
		...
		L21ae:
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)), 0x1b);
		...
		L21d0:
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xdb3c), 0xdc);
			if (this.oCPU.Flags.GE) goto L2256;
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0xdb3e);
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x22)));
		...
		L21ef:
			...
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1e)), this.oCPU.AX.Word);
			if (this.oCPU.Flags.GE) goto L2256;
			this.oCPU.DI.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x1e));
			this.oCPU.DI.Word = this.oCPU.SHLWord(this.oCPU.DI.Word, 0x1);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + this.oCPU.DI.Word - 0x1a));
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26), this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x600;
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.SI.Word = this.oCPU.AX.Word;
		...
		L2256:
			this.oCPU.PushWord(this.oCPU.CS.Word);
			this.oCPU.PushWord(0x225a); // stack management - push return offset
			// Instruction address 0x1866:0x2257, size: 3
			F0_1866_25d7();
			this.oCPU.PopWord(); // stack management - pop return offset
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_1f69'");
		}

		public void F0_1866_226d()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_226d'(Cdecl) at 0x1866:0x226d, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
		...
		L235a:
			...
			this.oCPU.IMULWord(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.SI.Word = this.oCPU.AX.Word;
			this.oCPU.CMPByte(this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + this.oCPU.SI.Word - 0x7e29)), 0x17);
		...
		L2505:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_226d'");
		}

		public void F0_1866_250e()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_250e'(Cdecl) at 0x1866:0x250e, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.BP.Word = this.oCPU.SP.Word;
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8));
			this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.DS.Word, 0x40dc));
			this.oCPU.AX.Word = this.oCPU.INCWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = this.oCPU.INCWord(this.oCPU.AX.Word);
		...
		L2522:
			...
			this.oCPU.CX.Low = 0x4;
			this.oCPU.AX.Low = this.oCPU.SHLByte(this.oCPU.AX.Low, this.oCPU.CX.Low);
			this.oCPU.DX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81d2);
			...
			this.oCPU.BX.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x40dc);
			this.oCPU.WriteWord(this.oCPU.DS.Word, 0x40dc, this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x40dc)));
			this.oCPU.ES.Word = this.oCPU.ReadWord(this.oCPU.DS.Word, 0x63ea);
			this.oCPU.WriteByte(this.oCPU.ES.Word, (ushort)(this.oCPU.BX.Word + 0x26fc), this.oCPU.AX.Low);
		...
		L25b4:
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_250e'");
		}

		public void F0_1866_25b6()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_25b6'(Cdecl) at 0x1866:0x25b6, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x25d3); // stack management - push return offset
			// Instruction address 0x1866:0x25ce, size: 5
			this.oParent.Segment_1000.F0_1000_07fb();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x1866; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x10);
			this.oParent.LogWriteLine("Exiting function 'F0_1866_25b6'");
		}

		public void F0_1866_25d7()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_25d7'(Cdecl) at 0x1866:0x25d7, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x25f4); // stack management - push return offset
			// Instruction address 0x1866:0x25ef, size: 5
			this.oParent.Segment_1000.F0_1000_07fb();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x1866; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x10);
			this.oParent.LogWriteLine("Exiting function 'F0_1866_25d7'");
		}

		public void F0_1866_25f8()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_25f8'(Cdecl) at 0x1866:0x25f8, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x2609); // stack management - push return offset
			// Instruction address 0x1866:0x2604, size: 5
			this.oParent.Segment_1000.F0_1000_07d1();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x1866; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x6);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_25f8'");
		}

		public void F0_1866_260e()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1866_260e'(Cdecl) at 0x1866:0x260e, stack: 0x0");
			this.oCPU.CS.Word = 0x1866; // set this function segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x261f); // stack management - push return offset
			...
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4), this.oCPU.AX.Word);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6), 0x78);
			this.oCPU.AX.Word = this.oCPU.SUBWord(this.oCPU.AX.Word, this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa));
			...
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x264e); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x2675); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x269d); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x26c4); // stack management - push return offset
		...
		L26cc:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x26f7); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x2719); // stack management - push return offset
		...
		L272a:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x2751); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8));
			this.oCPU.PushWord(0x1866); // stack management - push return segment
			this.oCPU.PushWord(0x2773); // stack management - push return offset
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x10);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))));
			this.oCPU.CMPWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)), 0x27);
			if (this.oCPU.Flags.L) goto L272a;
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1866_260e'");
		}
	}
}
