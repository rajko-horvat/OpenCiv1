...
namespace OpenCiv1
{
	public class Segment_1866
	{
		...
		L02e2:
			...
			if ((this.oParent.GameState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa))].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.DS.Word, 0xd7f0)] & 2) != 0)
				goto L0329;
		...
		L0451:
			...
			if ((this.oParent.GameState.Players[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa))].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x14))] & 2) != 0)
				goto L04bd;
		...
		L0b36:
			...
			if (this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) < 127)
			{
		...
		L145d:
			...
			switch(this.oCPU.ReadUInt32(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa)))
			{
				case 0x18660f10:
					...
					F0_1866_0f10(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)),
		...
		L19e7:
			...
			this.oParent.VGADriver.F0_VGA_038c_GetPixel(2,
				this.oCPU.ReadInt8(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x81d5)) + 0x50,
		...
		L1a51:
			...
			this.oParent.Overlay_20.F20_0000_0000(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)),
				0,
