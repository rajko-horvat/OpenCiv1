	...
	public class Overlay_5
	{
		...
		public void F5_0000_0000()
		{
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)((this.oParent.Var_db3e - 0xc) / 0x23), 0, 4);
		...
		L00a8:
			...
			if (this.oCPU.Flags.NE)
			{
				...
				this.oParent.VGADriver.F0_VGA_07d8_DrawImage(
					this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
					0x50, (ushort)((0x23 * this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6b86)) + 6), 0x35, 0x2f,
					this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
					0x14, 0x64);
			}
			else
			{
				...
				this.oParent.VGADriver.F0_VGA_07d8_DrawImage(
					this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
					0x15, (ushort)((0x23 * this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6b86)) + 6), 0x35, 0x2f,
					this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
					0x14, 0x64);
			}
		...
		L0143:
			...
			this.oParent.MSCAPI.strcat(0xba06,
				this.oParent.MSCAPI.itoa((short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)), 10));
		...
		L017c:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(0x6 - this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd2f4)), 2, 6);
		...
		L01e1:
			...
			if (this.oCPU.Flags.NE)
			{
				...
				this.oParent.VGADriver.F0_VGA_07d8_DrawImage(
					...
					0x50, (ushort)((0x23 * this.oCPU.ReadWord(this.oCPU.DS.Word, 0x6b86)) + 6), 0x35, 0x2f,
					this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa)) << 1) + 0x14),
					(ushort)((0x3 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))) + 0x64));
			}
			else
			{
				// Instruction address 0x0000:0x01d6, size: 5
		...
		L0421:
			...
			this.oCPU.WriteWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word - 0x4dde), 0x0);
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa), this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xa))));
		...
		L0476:
			...
			this.oCPU.AX.Word = (ushort)(this.oParent.MSCAPI.RNG.Next(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd2f4)));
		...
		L048b:
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x19a2)), this.oCPU.AX.Word);
			goto L0569;
		...
		L0569:
			...
			this.oParent.Segment_1182.F0_1182_00b3_DrawCenteredText(
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)((ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, 0xd7ee) << 1) + 0x1992)),
				0x2e, 0x5c, 0xf);
			this.oCPU.PopDWord(); // stack management - pop return offset and segment
			this.oCPU.CS.Word = this.usSegment; // restore this function segment
		...
		L0621:
			...
			this.oParent.MSCAPI.strcpy(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x30be),
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x19a2)));
		...
		L0b16:
			...
			this.oParent.VGADriver.F0_VGA_038c_GetPixel(2,
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8)) + 0x50),
		...
		L14b1:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)((0x2a * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))) + 0xa0),
				0x8e, 0x29, 0x3a);
		...
		L1538:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) << 4),
		...
		L1580:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) << 4) - ((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) & 1) << 3)) + 8),
				0xb8, 8, 8);
		...
		L15bf:
			...
			// Instruction address 0x0000:0x15a4, size: 5
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) & 1) << 3) + (this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) << 4)),
				0xb0, 8, 8);
			goto L159f;
		...
		L160c:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) << 4) + 0x80),
				0xb0, 0x10, 0x10);
		...
		L182b:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) << 4) + 0x50),
				0x80, 0x10, 0x10);
		...
		L189c:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) & 3) << 3) + 0x81),
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) & 4) << 1) + 0x21),
				7, 7);
		...
		L1915:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) << 4) + 1),
				0x71, 15, 15);
		...
		L19bf:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) % 0x14) << 4) + 1),
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6)) / 0x14) << 4) + 0x81),
				15, 15);
		...
		L1a14:
			...
			this.oParent.VGADriver.F0_VGA_009a_ReplaceColor(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4), 0, 128, 320, 32, 15, 11);
		...
		L1a69:
			...
			this.oParent.VGADriver.F0_VGA_009a_ReplaceColor(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4), 0, 128, 320, 32, 7, 3);
		...
		L1a98:
			...
			this.oParent.VGADriver.F0_VGA_009a_ReplaceColor(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4), 0, 128, 320, 32, 10,
				(byte)this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x1946)));

			// Instruction address 0x0000:0x1adb, size: 5
			this.oParent.VGADriver.F0_VGA_009a_ReplaceColor(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4), 0, 128, 320, 32, 2,
				(byte)this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.SI.Word + 0x1956)));
		...
		public void F5_0000_1af6()
		{
			...
			this.oParent.MSCAPI.strcpy((ushort)(this.oCPU.BP.Word - 0x10), 0x3734);
		...
		L1c73:
			...
			this.oParent.Segment_1182.F0_1182_00b3_DrawCenteredText(0xba06, 
				(ushort)((0x50 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))) + 0x28), 
		...
		L1c87:
			...
			this.oParent.VGADriver.F0_VGA_07d8_DrawImage(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19e8),
				(ushort)((0x28 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))) + 0xa0),
				0x8c, 0x28, 0x3c,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xaa),
				(ushort)((0x50 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))) + 0x14), 0x76);

			this.oCPU.BX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2));
			this.oCPU.BX.Word = this.oCPU.SHLWord(this.oCPU.BX.Word, 0x1);
			// Instruction address 0x0000:0x1cd0, size: 5
			this.oParent.MSCAPI.strcpy(0xba06, this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)(this.oCPU.BX.Word + 0x2fac)));
