...
namespace Civilization1
{
	public class Segment_2517
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0004'(Cdecl) at 0x2517:0x0004, stack: 0x0");
		...
		L004c:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)));
			this.oCPU.PushWord(0x2517); // stack management - push return segment
		...
		L0141:
			...
			if (this.oCPU.Flags.E) goto L01c2;
			this.oCPU.AX.Word = 0x295c;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x015b); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x0195); // stack management - push return offset
			// Instruction address 0x2517:0x0190, size: 5
			this.oParent.MSCAPI.strcat();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x2517; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x297b;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
		...
		L0243:
			...
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x024d); // stack management - push return offset
		...
		L0342:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x035a); // stack management - push return offset
			...
			// Instruction address 0x2517:0x0385, size: 5
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x0397); // stack management - push return offset
		...
		L0468:
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x30ba));
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x047a); // stack management - push return offset
		...
		L049b:
			...
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0004'");
		}

		public void F0_2517_04a1()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_04a1'(Cdecl) at 0x2517:0x04a1, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
		...
		L04c6:
			this.oCPU.AX.Word = 0x29af;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x04d3); // stack management - push return offset
		...
		L061f:
			...
			this.oCPU.CS.Word = 0x2517; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x29d1;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x064f); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x0664); // stack management - push return offset
			// Instruction address 0x2517:0x065f, size: 5
			this.oParent.MSCAPI.strcat();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x2517; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x29e9;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x0674); // stack management - push return offset
		...
		L0731:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_04a1'");
		}

		public void F0_2517_0737()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0737'(Cdecl) at 0x2517:0x0737, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
		...
		L08f1:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x0903); // stack management - push return offset
			// Instruction address 0x2517:0x08fe, size: 5
			this.oParent.MSCAPI.strcpy();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x2517; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x2a13;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x0928); // stack management - push return offset
			// Instruction address 0x2517:0x0923, size: 5
			this.oParent.MSCAPI.strcat();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x2517; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x2a19;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x0938); // stack management - push return offset
		...
		L09a2:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x09b4); // stack management - push return offset
			// Instruction address 0x2517:0x09af, size: 5
			this.oParent.MSCAPI.strcpy();
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x2517; // restore this function segment
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x4);
			this.oCPU.AX.Word = 0x2a30;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0xba06;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x2517); // stack management - push return segment
			this.oCPU.PushWord(0x09c4); // stack management - push return offset
		...
		L0a2a:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0737'");
		}

		public void F0_2517_0a30()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0a30'(Cdecl) at 0x2517:0x0a30, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
		...
		L0a9d:
			...
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0a30'");
		}

		public void F0_2517_0aa1()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0aa1'(Cdecl) at 0x2517:0x0aa1, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
		...
		L0b17:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0aa1'");
		}

		public void F0_2517_0b1d()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0b1d'(Cdecl) at 0x2517:0x0b1d, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
		...
		L0ce9:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0b1d'");
		}

		public void F0_2517_0cef()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0cef'(Cdecl) at 0x2517:0x0cef, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
		...
		L0d93:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0cef'");
		}

		public void F0_2517_0d97()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0d97'(Cdecl) at 0x2517:0x0d97, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
		...
		L0df3:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0d97'");
		}

		public void F0_2517_0e05()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0e05'(Cdecl) at 0x2517:0x0e05, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
			...
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0e05'");
		}

		public void F0_2517_0e1c()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0e1c'(Cdecl) at 0x2517:0x0e1c, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
			...
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0e1c'");
		}

		public void F0_2517_0e33()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2517_0e33'(Cdecl) at 0x2517:0x0e33, stack: 0x0");
			this.oCPU.CS.Word = 0x2517; // set this function segment
			...
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2517_0e33'");
		}
	}
}
