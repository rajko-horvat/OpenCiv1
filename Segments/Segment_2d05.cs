...
namespace Civilization1
{
	public class Segment_2d05
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_0000'(Cdecl) at 0x2d05:0x0000, stack: 0x0");
			...
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_0000'");
		}

		public void F0_2d05_0018()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_0018'(Cdecl) at 0x2d05:0x0018, stack: 0x0");
			this.oCPU.CS.Word = 0x2d05; // set this function segment
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0x8);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_0018'");
		}

		public void F0_2d05_0031()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_0031'(Cdecl) at 0x2d05:0x0031, stack: 0x0");
			this.oCPU.CS.Word = 0x2d05; // set this function segment
			...
			this.oCPU.PushWord(0x2d05); // stack management - push return segment
		...
		L0243:
			...
			this.oCPU.SI.Word = this.oCPU.ADDWord(this.oCPU.SI.Word, 0x3);
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2));
			this.oCPU.AX.Word = this.oCPU.ADDWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.DS.Word, 0xb1ec));
		...
		L0470:
			...
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_0031'");
		}

		public void F0_2d05_0475()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_0475'(Cdecl) at 0x2d05:0x0475, stack: 0x0");
			this.oCPU.CS.Word = 0x2d05; // set this function segment
		...
		L0963:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_0475'");
		}

		public void F0_2d05_096c()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_096c'(Cdecl) at 0x2d05:0x096c, stack: 0x0");
			this.oCPU.CS.Word = 0x2d05; // set this function segment
		...
		L09b9:
			...
			this.oCPU.SP.Word = this.oCPU.ADDWord(this.oCPU.SP.Word, 0xa);
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_096c'");
		}

		public void F0_2d05_0a05()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_0a05'(Cdecl) at 0x2d05:0x0a05, stack: 0x0");
			this.oCPU.CS.Word = 0x2d05; // set this function segment
			...
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_0a05'");
		}

		public void F0_2d05_0a66()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_0a66'(Cdecl) at 0x2d05:0x0a66, stack: 0x0");
			this.oCPU.CS.Word = 0x2d05; // set this function segment
			...
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_0a66'");
		}

		public void F0_2d05_0ac9()
		{
			this.oParent.LogWriteLine("Entering function 'F0_2d05_0ac9'(Cdecl) at 0x2d05:0x0ac9, stack: 0x0");
			this.oCPU.CS.Word = 0x2d05; // set this function segment
		...
		L0b05:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4800);
		...
		L0b10:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4900);
			goto L0b0a;

		L0b17:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4d00);
			goto L0b0a;

		L0b1e:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x5100);
			goto L0b0a;

		L0b25:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x5000);
			goto L0b0a;

		L0b2c:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4f00);
			goto L0b0a;

		L0b33:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4b00);
			goto L0b0a;

		L0b3a:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4700);
			goto L0b0a;

		L0b41:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4838);
			goto L0b0a;

		L0b48:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4939);
			goto L0b0a;

		L0b4f:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4d36);
			goto L0b0a;

		L0b56:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x5133);
			goto L0b0a;

		L0b5d:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x5032);
			goto L0b0a;

		L0b64:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4f31);
			goto L0b0a;

		L0b6b:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4b34);
			goto L0b0a;

		L0b72:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 0x4737);
			goto L0b0a;
		...
		L0bf6:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_2d05_0ac9'");
		}
	}
}
