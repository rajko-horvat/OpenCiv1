...
namespace Civilization1
{
	public class Overlay_18
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_0000'(Cdecl) at 0x0000:0x0000, stack: 0x0");
		...
		L0095:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x009e); // stack management - push return offset
		...
		L0168:
			...
			this.oParent.LogWriteLine("Exiting function 'F18_0000_0000'");
		}

		public void F18_0000_016d()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_016d'(Cdecl) at 0x0000:0x016d, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L01f0:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_016d'");
		}

		public void F18_0000_0259()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_0259'(Cdecl) at 0x0000:0x0259, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0bfc:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_0259'");
		}

		public void F18_0000_0c11()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_0c11'(Cdecl) at 0x0000:0x0c11, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0c45:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_0c11'");
		}

		public void F18_0000_0c49()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_0c49'(Cdecl) at 0x0000:0x0c49, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0d47:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_0c49'");
		}

		public void F18_0000_0d4f()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_0d4f'(Cdecl) at 0x0000:0x0d4f, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L0f7d:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_0d4f'");
		}

		public void F18_0000_0f83()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_0f83'(Cdecl) at 0x0000:0x0f83, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L12de:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_0f83'");
		}

		public void F18_0000_1527()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_1527'(Cdecl) at 0x0000:0x1527, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L15bf:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_1527'");
		}

		public void F18_0000_15c3()
		{
			this.oParent.LogWriteLine("Entering function 'F18_0000_15c3'(Cdecl) at 0x0000:0x15c3, stack: 0x0");
			this.oCPU.CS.Word = 0x0000; // set this function segment
		...
		L16ce:
			this.oCPU.SI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F18_0000_15c3'");
		}
	}
}
