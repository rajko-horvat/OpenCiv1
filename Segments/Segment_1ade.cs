...
namespace Civilization1
{
	public class Segment_1ade
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_0006'(Cdecl) at 0x1ade:0x0006, stack: 0x0");
		...
		L004a:
			...
			this.oCPU.PushWord(0x1ade); // stack management - push return segment
		...
		L0188:
			...
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_0006'");
		}

		public void F0_1ade_018e()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_018e'(Cdecl) at 0x1ade:0x018e, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
		...
		L0385:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_018e'");
		}

		public void F0_1ade_0394()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_0394'(Cdecl) at 0x1ade:0x0394, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
			...
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x1ade; // restore this function segment
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_0394'");
		}

		public void F0_1ade_03bf()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_03bf'(Cdecl) at 0x1ade:0x03bf, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
			...
			this.oCPU.PopDWord(); // stack management - pop return offset, segment
			this.oCPU.CS.Word = 0x1ade; // restore this function segment
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_03bf'");
		}

		public void F0_1ade_03ea()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_03ea'(Cdecl) at 0x1ade:0x03ea, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
		...
		L041d:
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_03ea'");
		}

		public void F0_1ade_0421()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_0421'(Cdecl) at 0x1ade:0x0421, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
		...
		L14e7:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_0421'");
		}

		public void F0_1ade_14ed()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_14ed'(Cdecl) at 0x1ade:0x14ed, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
		...
		L1576:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_14ed'");
		}

		public void F0_1ade_1584()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_1584'(Cdecl) at 0x1ade:0x1584, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
		...
		L1d29:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_1584'");
		}

		public void F0_1ade_1d2e()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_1d2e'(Cdecl) at 0x1ade:0x1d2e, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
		...
		L1f85:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x1ade); // stack management - push return segment
			this.oCPU.PushWord(0x1f8e); // stack management - push return offset
		...
		L22af:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_1d2e'");
		}

		public void F0_1ade_22b5()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_22b5'(Cdecl) at 0x1ade:0x22b5, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
		...
		L2312:
			...
			this.oCPU.SP.Word = this.oCPU.BP.Word;
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_22b5'");
		}

		public void F0_1ade_2317()
		{
			this.oParent.LogWriteLine("Entering function 'F0_1ade_2317'(Cdecl) at 0x1ade:0x2317, stack: 0x0");
			this.oCPU.CS.Word = 0x1ade; // set this function segment
			...
			this.oCPU.DI.Word = this.oCPU.PopWord();
			this.oCPU.BP.Word = this.oCPU.PopWord();
			this.oParent.LogWriteLine("Exiting function 'F0_1ade_2317'");
		}
	}
}
