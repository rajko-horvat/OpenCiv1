...
namespace OpenCiv1
{
	public class GameReplay
	{
		...
		public GameReplay(OpenCiv1 parent)
		{
			this.oParent = parent;
		...
		/// <param name="param2"></param>
		/// <returns></returns>
		public ushort F9_0000_0a64(ushort param1, ushort param2)
		{
		...
		/// <param name="param1"></param>
		/// <param name="param2"></param>
		public void F9_0000_0ac8(ushort param1, ushort param2)
		{
		...
		L0b8f:
			this.oCPU.AX.Word = this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x6));
			this.oCPU.CMPWord(param1, this.oCPU.AX.Word);
		...
		L0c19:
			...
			this.oCPU.CMPWord(param2, this.oCPU.AX.Word);
		...
		L13a0:
			...
			this.oParent.Segment_2dc4.F0_2dc4_0523_MemoryError(this.oCPU.ReadUInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x12)), 0);
