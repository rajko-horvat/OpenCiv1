...
namespace Civilization1
{
	public class Overlay_21
	{
		...
		{
			this.oParent.LogWriteLine("Entering function 'F21_0000_0000'(Cdecl) at 0x0000:0x0000, stack: 0x0");
		...
		L022c:
			...
			this.oCPU.AX.Word = 0xb;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x10c;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.AX.Word = 0x514b;
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
		...
		L02e3:
			...
			this.oCPU.PushWord(this.oCPU.AX.Word);
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x03aa); // stack management - push return offset
			...
			this.oCPU.PushWord(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4));
			this.oCPU.PushWord(0x0000); // stack management - push return segment
			this.oCPU.PushWord(0x041c); // stack management - push return offset
		...
		L041f:
			...
			this.oParent.LogWriteLine("Exiting function 'F21_0000_0000'");
		}
	}
}
