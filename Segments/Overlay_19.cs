	...
	public class Overlay_19
	{
		...
		L0108:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange((ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, 
				(ushort)(this.oCPU.SI.Word + 0x1882)) +
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x176))), 0, 0x12);
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange((ushort)(this.oCPU.ReadWord(this.oCPU.DS.Word, 
				(ushort)(this.oCPU.SI.Word + 0x18e4)) +
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x178))), 0, 11);
		...
		L0185:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8e)) -
					this.oCPU.SUBWord(this.oCPU.AX.Word, this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8a)))) / 3) -
					this.oParent.MSCAPI.RNG.Next(2)),
				(ushort)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x8e)) / 6),
				(ushort)((this.oCPU.ReadByte(this.oCPU.DS.Word, (ushort)((0x1c * this.oCPU.ReadWord(this.oCPU.SS.Word,
					(ushort)(this.oCPU.BP.Word + 0x6))) + 0x70f3)) / 4) + 6));
		...
		L0a0a:
			...
			this.oParent.Segment_1000.F0_1000_0797_DrawBitmapToScreen(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x17c)),
				2,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81c4));
			this.oCPU.CS.Word = this.usSegment; // restore this function segment
		...
		L0cd2:
			...
			this.oParent.Segment_1000.F0_1000_0797_DrawBitmapToScreen(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x17c)),
				0x6c,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81ce));
			this.oCPU.CS.Word = this.usSegment; // restore this function segment
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				0x8e, 0x6c,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81ae));
		...
		L0d2b:
			...
			this.oParent.Segment_1000.F0_1000_0797_DrawBitmapToScreen(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x17c)),
				0x73,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81cc));
			this.oCPU.CS.Word = this.usSegment; // restore this function segment
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				0, 0x73,
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x81b8));
		...
		public void F19_0000_0ff4()
		{
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)((((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) & 1) << 3) +
					(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)) << 4)) - 5),
				(short)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) << 3) + 0x32),
		...
		public void F19_0000_102e()
		{
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) & 1) << 3) +
					(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)) << 4)),
				(short)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) << 3) + 0x1a),
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa)) << 1) + 
					(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xc)) << 3) - 0x7e86)));
		...
		public void F19_0000_106c()
		{
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange((ushort)((((this.oCPU.ReadWord(this.oCPU.SS.Word, 
				(ushort)(this.oCPU.BP.Word + 0x8)) & 1) << 3) +	
				(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)) << 4)) - 9), 0, 0x3e7);

			// Instruction address 0x0000:0x10b2, size: 5
			this.oParent.Segment_1000.F0_1000_0797_DrawBitmapToScreen(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)this.oCPU.AX.Word,
				(short)((short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) << 3) + 16),
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, 
		...
		L10b9:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)),
				0, 0x3e7);
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)this.oCPU.AX.Word,
				(short)(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) - 10),
				this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, 
		...
		L1165:
			...
			if (this.oCPU.Flags.E)
			{
				...
				this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
					(ushort)(((0x23 * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x18)))) + 1),
					0x34, 0x22, 0x32);
			}
			else
			{
		...
		L11c0:
			this.oCPU.SI.Word = (ushort)((0x1c * this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6))) + 0x70f3);

			// Instruction address 0x0000:0x11d7, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x70e2),
				0, this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.SI.Word));
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0x70e4), 0, this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.SI.Word));
			goto L1214;

		L11ef:
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), 
				this.oCPU.DECWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2))));

			// Instruction address 0x0000:0x11fc, size: 5
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2)),
				0, this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.SI.Word));
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x2), this.oCPU.AX.Word);
			
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4), 
				this.oCPU.DECWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4))));
		...
		L1214:
			...
			this.oParent.Segment_2dc4.F0_2dc4_007c_CheckValueRange((ushort)(this.oCPU.ReadByte(this.oCPU.DS.Word, this.oCPU.SI.Word) -
				this.oCPU.ReadWord(this.oCPU.DS.Word, 0xe8b8)),
				0, 0x63);
		...
		L1253:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + this.oCPU.SI.Word - 0x16)));
		...
		L1336:
			...
			this.oParent.Segment_1000.F0_1000_084d_DrawBitmapToScreen(
				...
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0xa)),
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + this.oCPU.SI.Word - 0xc)));
		...
		L1473:
			...
			if (this.oCPU.Flags.E)
			{
				...
				this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) & 0x7) * 0x18),
					(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) >> 3) << 3) + 0x41),
					0x18, 0x8);
			}
			else
			{
				...
				this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
					(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) & 0x7) * 0x18),
					(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) >> 3) << 3) + 0x51),
					0x18, 0x8);
			}
			goto L1433;
		...
		L14fb:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) >> 2) * 0x32) + 1),
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x4)) & 0x3) * 0x32) + 1),
				0x31, 0x31);
		...
		L164f:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.SI.Word + 0x0)),
				this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.SI.Word + 0x2)),
				this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.SI.Word + 0x4)),
				this.oCPU.ReadWord(this.oCPU.ES.Word, (ushort)(this.oCPU.SI.Word + 0x6)));
		...
		L16fb:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) % 4) * 0x4f),
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) >> 2) * 0x3d) + 2),
				0x4e, 0x3c);
		...
		L1758:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) % 4) * 0x4f) + 1),
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) >> 2) * 0x42) + 1),
				0x4e, 0x41);
		...
		L1816:
			...
			this.oParent.Segment_1000.F0_1000_0797_DrawBitmapToScreen(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26)),
				0x84,
				this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + this.oCPU.SI.Word - 0x20)));
			this.oCPU.CS.Word = this.usSegment; // restore this function segment
		...
		L1852:
			...
			this.oCPU.WriteWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x28), 
				this.oCPU.INCWord(this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x28))));
		...
		L190e:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) % 4) * 0x4f) + 1),
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) >> 2) << 6) + 1),
				0x4e, 0x3f);
		...
		L196a:
			...
			this.oParent.VGADriver.F0_VGA_0b85_ScreenToBitmap(1,
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) % 4) * 0x4b) + 1),
				(ushort)(((this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x24)) >> 2) * 0x42) + 1),
				0x4a, 0x41);
		...
		L1a28:
			...
			this.oParent.Segment_1000.F0_1000_0797_DrawBitmapToScreen(this.oCPU.ReadWord(this.oCPU.DS.Word, 0x19d4),
				(short)this.oCPU.ReadWord(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0x26)),
				(short)((short)this.oCPU.ReadWord(this.oCPU.DS.Word, (ushort)((this.oCPU.ReadWord(this.oCPU.SS.Word, 
