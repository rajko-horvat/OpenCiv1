...
namespace OpenCiv1
{
	public class Segment_2e31
	{
		...
		L0b2a:
			...
			this.oParent.Segment_2dc4.F0_2dc4_0208_CombinePosition(
				...
				(short)(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x8)) -
					(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word - 0xc)) << 2) - 1));
		...
		L100b:
			...
			this.oParent.Segment_1866.F0_1866_1251(this.oCPU.ReadInt16(this.oCPU.SS.Word, (ushort)(this.oCPU.BP.Word + 0x6)),
